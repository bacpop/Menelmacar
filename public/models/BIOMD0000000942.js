export class model {
  ...
  initial(t) {
    ...
    state[7] = internal.initial_Cdk1_total;
    state[8] = internal.initial_Cdc25_total;
    state[9] = internal.initial_Wee1_total;
    state[10] = internal.initial_IE_total;
    state[11] = internal.initial_APC_total;
    state[12] = internal.initial_ppase;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "APC_total_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdc25_phosphorylated_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdc25_total_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdk1_total_init", internal, 100, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "IE_total_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "ppase_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Wee1_total_init", internal, 1, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const Cdk1_total = state[7];
    const Cdc25_total = state[8];
    const Wee1_total = state[9];
    const IE_total = state[10];
    const APC_total = state[11];
    const ppase = state[12];
    dstatedt[11] = 0;
    dstatedt[8] = 0;
    dstatedt[7] = 0;
    dstatedt[10] = 0;
    ...
    dstatedt[9] = 0;
    var Cdk1 = Cdk1_total;
    dstatedt[6] = 0 - 1 * internal.nuclear * (internal.kd * ppase * APC_active / (internal.KKd + APC_active)) + 1 * internal.nuclear * (internal.kc * IE_phosphorylated * (APC_total - APC_active) / (internal.KKc + APC_total - APC_active));
    dstatedt[0] = 0 - 1 * internal.nuclear * (internal.kb * ppase * Cdc25_phosphorylated / (internal.KKb + Cdc25_phosphorylated)) + 1 * internal.nuclear * (internal.ka * Cyclin_Cdk1_MPF * (Cdc25_total - Cdc25_phosphorylated) / (internal.KKa + Cdc25_total - Cdc25_phosphorylated));
    dstatedt[5] = 0 - 1 * internal.nuclear * (internal.kh * ppase * IE_phosphorylated / (internal.KKh + IE_phosphorylated)) + 1 * internal.nuclear * (internal.kg * Cyclin_Cdk1_MPF * (IE_total - IE_phosphorylated) / (internal.KKg + IE_total - IE_phosphorylated));
    dstatedt[3] = 0 - 1 * internal.nuclear * (internal.kf * ppase * Wee1_phosphorylated / (internal.KKf + Wee1_phosphorylated)) + 1 * internal.nuclear * (internal.ke * Cyclin_Cdk1_MPF * (Wee1_total - Wee1_phosphorylated) / (internal.KKe + Wee1_total - Wee1_phosphorylated));
    ...
    dstatedt[4] = 0 - 1 * internal.nuclear * (internal.k3 * Cdk1 * Cyclin) + 1 * internal.nuclear * (internal.k1) - 1 * internal.nuclear * k2 * Cyclin;
    dstatedt[1] = 0 + 1 * internal.nuclear * k25 * Cyclin_Cdk1_preMPF - 1 * internal.nuclear * kwee * Cyclin_Cdk1_MPF + 1 * internal.nuclear * (internal.k3 * Cdk1 * Cyclin) - 1 * internal.nuclear * k2 * Cyclin_Cdk1_MPF;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Cdc25_phosphorylated", "Cyclin_Cdk1_MPF", "Cyclin_Cdk1_preMPF", "Wee1_phosphorylated", "Cyclin", "IE_phosphorylated", "APC_active", "Cdk1_total", "Cdc25_total", "Wee1_total", "IE_total", "APC_total", "ppase"];
    this.metadata.internalOrder = {APC_active_init: null, APC_total_init: null, Cdc25_phosphorylated_init: null, Cdc25_total_init: null, Cdk1_total_init: null, Cyclin_Cdk1_MPF_init: null, Cyclin_Cdk1_preMPF_init: null, Cyclin_init: null, IE_phosphorylated_init: null, IE_total_init: null, initial_APC_active: null, initial_APC_total: null, initial_Cdc25_phosphorylated: null, initial_Cdc25_total: null, initial_Cdk1_total: null, initial_Cyclin: null, initial_Cyclin_Cdk1_MPF: null, initial_Cyclin_Cdk1_preMPF: null, initial_IE_phosphorylated: null, initial_IE_total: null, initial_ppase: null, initial_Wee1_phosphorylated: null, initial_Wee1_total: null, k1: null, k3: null, ka: null, kb: null, kc: null, kd: null, ke: null, kf: null, kg: null, kh: null, KKa: null, KKb: null, KKc: null, KKd: null, KKe: null, KKf: null, KKg: null, KKh: null, nuclear: null, ppase_init: null, v2: null, v2_: null, v25: null, v25_: null, vwee: null, vwee_: null, Wee1_phosphorylated_init: null, Wee1_total_init: null};
    this.metadata.variableOrder = {Cdc25_phosphorylated: null, Cyclin_Cdk1_MPF: null, Cyclin_Cdk1_preMPF: null, Wee1_phosphorylated: null, Cyclin: null, IE_phosphorylated: null, APC_active: null, Cdk1_total: null, Cdc25_total: null, Wee1_total: null, IE_total: null, APC_total: null, ppase: null};
