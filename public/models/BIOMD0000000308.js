export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["k0", "k1", "k2", "k2_prime", "k3", "k4", "k5", "k6", "Km3", "Km4", "Km5", "Km6", "Rp_init", "Rt", "X_init", "Yp_init", "Yt"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[1] = 0 + 1 * internal.env * (internal.k0 + internal.k1 * internal.S) - 1 * internal.env * (internal.k2 + internal.k2_prime * Rp) * X;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Rp", "X", "Yp"];
    this.metadata.internalOrder = {env: null, initial_Rp: null, initial_X: null, initial_Yp: null, k0: null, k1: null, k2: null, k2_prime: null, k3: null, k4: null, k5: null, k6: null, Km3: null, Km4: null, Km5: null, Km6: null, Rp_init: null, Rt: null, S: null, X_init: null, Yp_init: null, Yt: null};
    this.metadata.variableOrder = {Rp: null, X: null, Yp: null};
