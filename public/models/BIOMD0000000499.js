export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Metabolite_9", "parameter_1", "parameter_10", "parameter_11", "parameter_12", "parameter_13", "parameter_14", "parameter_15", "parameter_16", "parameter_17", "parameter_18", "parameter_19", "parameter_2", "parameter_20", "parameter_21", "parameter_22", "parameter_23", "parameter_24", "parameter_25", "parameter_26", "parameter_27", "parameter_28", "parameter_3", "parameter_4", "parameter_5", "parameter_6", "parameter_7", "parameter_8", "parameter_9", "species_1_init", "species_10_init", "species_11_init", "species_12_init", "species_13_init", "species_14_init", "species_15_init", "species_16_init", "species_17_init", "species_18_init", "species_19_init", "species_2_init", "species_20_init", "species_21_init", "species_22_init", "species_23_init", "species_24_init", "species_25_init", "species_26_init", "species_3_init", "species_4_init", "species_5_init", "species_6_init", "species_7_init", "species_8_init", "species_9_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "parameter_10", internal, 0.17100000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "parameter_19", internal, 9.3599999999999994, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "parameter_2", internal, 20, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "parameter_20", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "parameter_21", internal, 0.71052631578947401, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "parameter_9", internal, 350.87719298245599, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[24] = 0;
    dstatedt[8] = 0;
    dstatedt[0] = 1 / (1 + internal.parameter_13) * (internal.parameter_9 * (internal.parameter_13 * Math.pow((species_20), (2)) + Math.pow((species_15), (2))) - internal.parameter_8 * (internal.parameter_13 * species_13 + species_11));
    dstatedt[12] = internal.parameter_9 * Math.pow((species_20), (2)) - (internal.parameter_8 + internal.parameter_3 * internal.parameter_11) * species_13;
    dstatedt[16] = internal.parameter_9 * species_18 * species_20 - (internal.parameter_8 + internal.parameter_3 * internal.parameter_11) * species_17;
    dstatedt[18] = internal.parameter_19 * species_21 - internal.parameter_3 * (species_18 + internal.parameter_11 * species_17);
    dstatedt[1] = 1 / (internal.parameter_13 + 1) * (internal.parameter_9 * (internal.parameter_13 * species_18 * species_20 + species_15 * species_21) - internal.parameter_8 * (internal.parameter_13 * species_17 + species_16));
    dstatedt[23] = internal.parameter_1 * (internal.parameter_18 * species_4 * species_9 - (internal.parameter_22 + internal.parameter_12 * (1 - internal.parameter_28)) * species_24);
    dstatedt[25] = internal.parameter_1 * (internal.parameter_22 * species_24 - internal.parameter_12 * (1 - internal.parameter_28) * species_26);
    dstatedt[2] = 1 / (1 + internal.parameter_13) * (internal.parameter_13 * internal.parameter_6 * species_26 * (internal.parameter_17 / (internal.parameter_17 + species_22)) * species_6 - internal.parameter_7 * species_15);
    dstatedt[3] = internal.parameter_1 * (internal.parameter_27 + internal.parameter_26 * species_16 - (internal.parameter_18 * species_9 + internal.parameter_25) * species_4);
    dstatedt[4] = internal.parameter_1 * ((1 - internal.parameter_5) * (1 - internal.parameter_16) - (internal.parameter_4 + (1 - internal.parameter_28)) * species_5);
    dstatedt[5] = internal.parameter_2 * species_10 - (internal.parameter_3 + internal.parameter_6 * species_26 * (internal.parameter_17 / (internal.parameter_17 + species_22))) * species_6;
    dstatedt[6] = internal.parameter_1 * (internal.parameter_4 * species_5 - (1 - internal.parameter_28) * species_25 - internal.parameter_18 * species_4 * species_9);
    dstatedt[7] = internal.parameter_6 * species_26 * (internal.parameter_17 / (internal.parameter_17 + species_22)) * species_6 + internal.parameter_2 * species_15 - internal.parameter_3 * (species_20 + internal.parameter_11 * (species_17 + 2 * species_13));
  }
  names() {
