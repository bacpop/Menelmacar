export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["E2_init", "E3_init", "E4_init", "k1", "k2", "k3", "k4", "mu1", "mu2", "mu23", "mu3", "mu4", "mu5", "Z1_init", "Z2_init", "Z3_init", "Z4_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "Z1_init", internal, 0.5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Z2_init", internal, 10, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Z3_init", internal, 10, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const E3 = state[6];
    const E4 = state[7];
    dstatedt[4] = 0 + (internal.mu1 * E2 + internal.mu5 * E4) * Z1 - internal.k1 * E1;
    dstatedt[5] = 0 + internal.mu2 * E1 * Z2 - internal.k2 * E2;
    dstatedt[6] = 0 + (internal.mu23 * E2 + internal.mu3 * E4) * Z3 - internal.k3 * E3;
    dstatedt[7] = 0 + internal.mu4 * E3 * Z4 - internal.k4 * E4;
    dstatedt[0] = 0 + - (internal.mu1 * E2 + internal.mu5 * E4) * Z1 + internal.k1 * E1;
    dstatedt[1] = 0 + - internal.mu2 * E1 * Z2 + internal.k2 * E2;
    dstatedt[2] = 0 + - (internal.mu23 * E2 + internal.mu3 * E4) * Z3 + internal.k3 * E3;
    dstatedt[3] = 0 + - internal.mu4 * E3 * Z4 + internal.k4 * E4;
  }
  names() {
