export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "D_init", internal, 2.3479999999999999, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "N_init", internal, 0.077640000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "v_init", internal, 300, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.compartment * (f_D) - 1 * internal.compartment * internal.d_D * D;
    dstatedt[1] = 0 + 1 * internal.compartment * (f_N) - 1 * internal.compartment * internal.d_N * N;
    var f_v = internal.v_0 * ((1 - Math.exp(- I)) / (1 + Math.exp(- I)));
    dstatedt[2] = 0 + 1 * internal.compartment * (f_v) - 1 * internal.compartment * internal.d_v * v;
  }
  names() {
