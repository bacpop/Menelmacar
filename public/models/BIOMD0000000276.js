export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "alpha", internal, 0.044200000000000003, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Ca0", internal, 1.2549999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ca0_baseline", internal, 1.2549999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ca1", internal, 0.1817, -Infinity, Infinity, false);
