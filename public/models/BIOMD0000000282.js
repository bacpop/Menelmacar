export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["e_init", "k1", "k2", "k4", "k4_prime", "p_init", "p1_init", "p2_init", "x_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    const x = state[1];
    const p = state[2];
    dstatedt[0] = 0 - 1 * internal.cell * (internal.k1 * e * x - internal.k2 * p) + 1 * internal.cell * internal.k4_prime * p * x + 1 * internal.cell * internal.k4 * p * internal.a;
    dstatedt[2] = 0 + 1 * internal.cell * (internal.k1 * e * x - internal.k2 * p) - 1 * internal.cell * internal.k4_prime * p * x - 1 * internal.cell * internal.k4 * p * internal.a;
    dstatedt[3] = 0 + 1 * internal.cell * internal.k4_prime * p * x;
    dstatedt[4] = 0 + 1 * internal.cell * internal.k4 * p * internal.a;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "e", "x", "p", "p1", "p2"];
    this.metadata.internalOrder = {a: null, cell: null, e_init: null, initial_e: null, initial_p: null, initial_p1: null, initial_p2: null, initial_x: null, k1: null, k2: null, k4: null, k4_prime: null, p_init: null, p1_init: null, p2_init: null, x_init: null};
    this.metadata.variableOrder = {e: null, x: null, p: null, p1: null, p2: null};
