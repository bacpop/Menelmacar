export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[5] = 0 + 1 * internal.cell * internal.k4 * p * a;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "e", "x", "p", "p1", "a", "p2"];
    ...
    this.metadata.variableOrder = {e: null, x: null, p: null, p1: null, a: null, p2: null};
