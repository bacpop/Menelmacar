export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Cancer_Stem_Cells_S_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cytokine_IL10_init", internal, 0.0085000000000000006, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cytokine_IL2_init", internal, 0.0094000000000000004, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cytotoxic_T_Cells_T_C_init", internal, 56000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Interferon_gamma_init", internal, 0.12, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "M1_Tumor_Associated_Macrophages_init", internal, 85000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "M2_Tumor_Associated_Macrophages_init", internal, 15000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Regulatory_T_Cells_T_reg_init", internal, 8000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Type_I_T_helper_Cell_T_H1_init", internal, 71000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Type_II_T_helper_cells_T_H2_init", internal, 12000, -Infinity, Infinity, false);
