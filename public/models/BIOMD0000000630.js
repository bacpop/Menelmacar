export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["k1", "k2", "parameter_1", "parameter_13", "parameter_2", "parameter_8", "species_1_init", "species_2_init", "species_3_init", "species_4_init", "species_5_init", "species_6_init", "v"], unusedUserAction);
    var internal = this.internal;
