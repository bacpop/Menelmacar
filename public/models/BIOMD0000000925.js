export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var Va_Xa_L_init = 0.5 * (internal.kb + internal.Ib + internal.initial_Prothrombinase__Va_Xa - Math.pow((Math.pow((internal.kb + internal.Ib + internal.initial_Prothrombinase__Va_Xa), (2)) - 4 * internal.Ib * internal.initial_Prothrombinase__Va_Xa), (1 / 2)));
    var Xa_L_init = 0.5 * (internal.kx + internal.Ix + internal.initial_Factor_Xa - Math.pow((Math.pow((internal.kx + internal.Ix + internal.initial_Factor_Xa), (2)) - 4 * internal.Ix * internal.initial_Factor_Xa), (1 / 2)));
    internal.initial_Va_Xa_L = Va_Xa_L_init;
    internal.initial_Xa_L = Xa_L_init;
    ...
    state[8] = internal.initial_Xa_L;
    state[9] = internal.initial_Va_Xa_L;
    state[10] = internal.initial_Protein_C;
    state[11] = internal.initial_Inactive_protein_C;
    state[12] = internal.initial_Fibrin;
    state[13] = internal.initial_Fibrinogen;
    state[14] = internal.initial_Inactive_Thrombin;
    state[15] = internal.initial_Factor_Xi;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Factor_V_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Protein_C_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Prothrombin__II_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const Xa_L = state[8];
    const Va_Xa_L = state[9];
    const Protein_C = state[10];
    const Fibrinogen = state[13];
    dstatedt[9] = 0 + 0;
    dstatedt[8] = 0 + 0;
    ...
    dstatedt[15] = 0 + 1 * internal.compartment * (internal.k1b * Factor_Xa + internal.k2a * internal.k3b / internal.q3a * Prothrombinase__Va_Xa);
    dstatedt[12] = 0 + 1 * internal.compartment * internal.k6 * Fibrinogen;
    dstatedt[13] = 0 - 1 * internal.compartment * internal.k6 * Fibrinogen;
    dstatedt[11] = 0 + 1 * internal.compartment * internal.k5b * APC;
    dstatedt[14] = 0 + 1 * internal.compartment * (Thrombin__IIa);
    dstatedt[10] = 0 - 1 * internal.compartment * internal.k5a * Protein_C;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Factor_Xa", "Thrombin__IIa", "Factor_V", "Factor_Va", "APC", "VInactive", "Prothrombinase__Va_Xa", "Prothrombin__II", "Xa_L", "Va_Xa_L", "Protein_C", "Inactive_protein_C", "Fibrin", "Fibrinogen", "Inactive_Thrombin", "Factor_Xi"];
    this.metadata.internalOrder = {APC_init: null, compartment: null, Factor_V_init: null, Factor_Va_init: null, Factor_Xa_init: null, Factor_Xi_init: null, Fibrin_init: null, Fibrinogen_init: null, gamma1a: null, Ib: null, Inactive_protein_C_init: null, Inactive_Thrombin_init: null, initial_APC: null, initial_Factor_V: null, initial_Factor_Va: null, initial_Factor_Xa: null, initial_Factor_Xi: null, initial_Fibrin: null, initial_Fibrinogen: null, initial_Inactive_protein_C: null, initial_Inactive_Thrombin: null, initial_Protein_C: null, initial_Prothrombin__II: null, initial_Prothrombinase__Va_Xa: null, initial_Thrombin__IIa: null, initial_Va_Xa_L: null, initial_VInactive: null, initial_Xa_L: null, Ix: null, k1a: null, k1b: null, k2a: null, k2am: null, k2b: null, k3a: null, k3b: null, k3c: null, k4a: null, k4b: null, k4bm: null, k5a: null, k5b: null, k6: null, kb: null, kx: null, Protein_C_init: null, Prothrombin__II_init: null, Prothrombinase__Va_Xa_init: null, q3a: null, q4a: null, Thrombin__IIa_init: null, VInactive_init: null};
    this.metadata.variableOrder = {Factor_Xa: null, Thrombin__IIa: null, Factor_V: null, Factor_Va: null, APC: null, VInactive: null, Prothrombinase__Va_Xa: null, Prothrombin__II: null, Xa_L: null, Va_Xa_L: null, Protein_C: null, Inactive_protein_C: null, Fibrin: null, Fibrinogen: null, Inactive_Thrombin: null, Factor_Xi: null};
