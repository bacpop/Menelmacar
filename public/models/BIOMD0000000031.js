export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    const Mp = state[1];
    const Mpp = state[2];
    dstatedt[0] = 0 - 1 * internal.uVol * (internal.k1cat * internal.MAPKK1 * M / internal.Km1 / (1 + M / internal.Km1)) + 1 * internal.uVol * (internal.k4cat * internal.MKP3 * Mp / internal.Km4 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5));
    dstatedt[1] = 0 + 1 * internal.uVol * (internal.k1cat * internal.MAPKK1 * M / internal.Km1 / (1 + M / internal.Km1)) - 1 * internal.uVol * (internal.k2cat * internal.MAPKK2 * Mp / internal.Km2 / (1 + Mp / internal.Km2)) + 1 * internal.uVol * (internal.k3cat * internal.MKP3 * Mpp / internal.Km3 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5)) - 1 * internal.uVol * (internal.k4cat * internal.MKP3 * Mp / internal.Km4 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5));
    dstatedt[2] = 0 + 1 * internal.uVol * (internal.k2cat * internal.MAPKK2 * Mp / internal.Km2 / (1 + Mp / internal.Km2)) - 1 * internal.uVol * (internal.k3cat * internal.MKP3 * Mpp / internal.Km3 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5));
  }
  names() {
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {initial_M: null, initial_Mp: null, initial_Mpp: null, k1cat: null, k2cat: null, k3cat: null, k4cat: null, Km1: null, Km2: null, Km3: null, Km4: null, Km5: null, M_init: null, MAPKK1: null, MAPKK2: null, MKP3: null, Mp_init: null, Mpp_init: null, uVol: null};
