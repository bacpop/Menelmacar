export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ADP_init", "AMP_init", "ATP_init", "K", "k4", "Km2AMP", "Km2ATP", "Kmapp1", "Kmapp3", "NADH_init", "Pyr_init", "Vm2", "Vmapp1", "Vmapp3"], unusedUserAction);
    var internal = this.internal;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "ATP", "AMP", "ADP", "Pyr", "NADH"];
    this.metadata.internalOrder = {ADP_init: null, AMP_init: null, ATP_init: null, compartment: null, initial_ADP: null, initial_AMP: null, initial_ATP: null, initial_NADH: null, initial_Pyr: null, K: null, k4: null, Km2AMP: null, Km2ATP: null, Kmapp1: null, Kmapp3: null, Lac: null, NADH_init: null, Pyr_init: null, Vm2: null, Vmapp1: null, Vmapp3: null};
    this.metadata.variableOrder = {ATP: null, AMP: null, ADP: null, Pyr: null, NADH: null};
