export class model {
  ...
  initial(t) {
    ...
    state[6] = internal.initial_EmptySet;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["C2_init", "CP_init", "EmptySet_init", "k1aa", "k2", "k3", "k4", "k4prime", "k5notP", "k6", "k7", "k8notP", "k9", "M_init", "pM_init", "Y_init", "YP_init"], unusedUserAction);
    var internal = this.internal;
