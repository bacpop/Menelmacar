export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var norm_Akt_star_init = internal.initial_Aktstar / 18.800000000000001;
    var norm_Erk_star_init = (internal.initial_ERKstar + internal.initial_ERKstar_ERKpase) / 589.5;
    internal.initial_norm_Akt_star = norm_Akt_star_init;
    internal.initial_norm_Erk_star = norm_Erk_star_init;
    var state = Array(120).fill(0);
    ...
    state[118] = internal.initial_norm_Akt_star;
    state[119] = internal.initial_norm_Erk_star;
    return state;
  }
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[4] = 0 + 1 * internal.membrane * (internal.kon1 * E * E1 - internal.EGF_off * E_E1) - 1 * internal.membrane * (internal.kon4 * E_E1 * E_E1 - internal.koff4 * E11) - 1 * internal.membrane * (internal.kon4 * E_E1 * E_E1 - internal.koff4 * E11) - 1 * internal.membrane * (internal.kon5 * E_E1 * E2 - internal.koff5 * E12) - 1 * internal.membrane * (internal.kon61 * H_E3 * E_E1 - internal.koff61 * E13) - 1 * internal.membrane * (internal.kon62 * H_E4 * E_E1 - internal.koff62 * E14) - 1 * internal.membrane * (internal.kf84 * E_E1 * ERKstar / (internal.Kmf84 + E_E1) - internal.Vmaxr84 * E_E1_PT / (internal.Kmr84 + E_E1_PT));
    ...
    dstatedt[6] = 0 + 1 * internal.membrane * (internal.kon3 * H * E4 - internal.HRGoff_4 * H_E4) - 1 * internal.membrane * (internal.kon7 * H_E3 * H_E4 - internal.koff7 * E34) - 1 * internal.kon8 * H_E4 * E2 - internal.koff8 * E24 - 1 * internal.membrane * (internal.kon9 * H_E4 * H_E4 - internal.koff9 * E44) - 1 * internal.membrane * (internal.kon9 * H_E4 * H_E4 - internal.koff9 * E44) - 1 * internal.membrane * (internal.kon62 * H_E4 * E_E1 - internal.koff62 * E14) - 1 * internal.membrane * (internal.kf85 * H_E4 * ERKstar / (internal.Kmf85 + H_E4) - internal.Vmaxr85 * H_E4_PT / (internal.Kmr85 + H_E4_PT));
