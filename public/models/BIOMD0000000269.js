export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var CTR1_init = internal.initial_CTR1T - internal.initial_CTR1_star;
    var Ra_init = internal.initial_RaT - internal.initial_Ra_star;
    var Re_init = internal.initial_ReT - internal.initial_Re_star;
    internal.initial_CTR1 = CTR1_init;
    internal.initial_Ra = Ra_init;
    internal.initial_Re = Re_init;
    var state = Array(18).fill(0);
    state[0] = internal.initial_Auxin;
    state[1] = internal.initial_X;
    state[2] = internal.initial_PLSp;
    state[3] = internal.initial_Ra;
    state[4] = internal.initial_Ra_star;
    state[5] = internal.initial_RaT;
    state[6] = internal.initial_CK;
    state[7] = internal.initial_ET;
    state[8] = internal.initial_PLSm;
    state[9] = internal.initial_Re;
    state[10] = internal.initial_ReT;
    state[11] = internal.initial_Re_star;
    state[12] = internal.initial_CTR1;
    state[13] = internal.initial_CTR1T;
    state[14] = internal.initial_CTR1_star;
    state[15] = internal.initial_IAA;
    state[16] = internal.initial_ACC;
    state[17] = internal.initial_CK_ex;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "CTR1_star_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "CTR1T_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "ET_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PLSm_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "PLSp_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ra_star_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "RaT_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Re_star_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "ReT_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const PLSp = state[2];
    const Ra = state[3];
    const Ra_star = state[4];
    const CK = state[6];
    const ET = state[7];
    const PLSm = state[8];
    const Re = state[9];
    const Re_star = state[11];
    const CTR1 = state[12];
    const CTR1_star = state[14];
    const IAA = state[15];
    const ACC = state[16];
    const CK_ex = state[17];
    dstatedt[16] = 0;
    dstatedt[17] = 0;
    dstatedt[12] = 0 + 0;
    dstatedt[13] = 0;
    ...
    dstatedt[6] = 0 + 1 * internal.compartment_1 * (internal.k18a / (1 + Auxin / internal.k18)) - 1 * internal.compartment_1 * (internal.k19 * CK) + 1 * internal.compartment_1 * internal.k_cytokinin * CK_ex;
    dstatedt[14] = 0 + 1 * internal.compartment_1 * (internal.k14 * Re_star * CTR1) - 1 * internal.compartment_1 * (internal.k15 * CTR1_star);
    dstatedt[7] = 0 + 1 * internal.compartment_1 * (internal.k12 + internal.k12a * Auxin * CK) - 1 * internal.compartment_1 * (internal.k13 * ET) + 1 * internal.compartment_1 * internal.k_ethylene * ACC;
    dstatedt[8] = 0 + 1 * internal.compartment_1 * (internal.k6 * Ra_star / (1 + ET / internal.k6a)) - 1 * internal.compartment_1 * (internal.k7 * PLSm);
    dstatedt[2] = 0 + 1 * internal.compartment_1 * (internal.k8 * PLSm) - 1 * internal.compartment_1 * (internal.k9 * PLSp);
    dstatedt[4] = 0 + 1 * internal.compartment_1 * (internal.k4 * Auxin * Ra) - 1 * internal.compartment_1 * internal.k5 * Ra_star;
    dstatedt[11] = 0 + 1 * internal.compartment_1 * ((internal.k10 + internal.k10a * PLSp) * Re) - 1 * internal.compartment_1 * (internal.k11 * Re_star * ET);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Auxin", "X", "PLSp", "Ra", "Ra_star", "RaT", "CK", "ET", "PLSm", "Re", "ReT", "Re_star", "CTR1", "CTR1T", "CTR1_star", "IAA", "ACC", "CK_ex"];
    this.metadata.internalOrder = {ACC_init: null, Auxin_init: null, CK_ex_init: null, CK_init: null, compartment_1: null, CTR1_star_init: null, CTR1T_init: null, ET_init: null, extra: null, IAA_init: null, initial_ACC: null, initial_Auxin: null, initial_CK: null, initial_CK_ex: null, initial_CTR1: null, initial_CTR1_star: null, initial_CTR1T: null, initial_ET: null, initial_IAA: null, initial_PLSm: null, initial_PLSp: null, initial_Ra: null, initial_Ra_star: null, initial_RaT: null, initial_Re: null, initial_Re_star: null, initial_ReT: null, initial_X: null, k_auxin: null, k_cytokinin: null, k_ethylene: null, k1: null, k10: null, k10a: null, k11: null, k12: null, k12a: null, k13: null, k14: null, k15: null, k16: null, k16a: null, k17: null, k18: null, k18a: null, k19: null, k1a: null, k2: null, k2a: null, k2b: null, k2c: null, k3: null, k3a: null, k4: null, k5: null, k6: null, k6a: null, k7: null, k8: null, k9: null, PLSm_init: null, PLSp_init: null, Ra_star_init: null, RaT_init: null, Re_star_init: null, ReT_init: null, X_init: null};
    this.metadata.variableOrder = {Auxin: null, X: null, PLSp: null, Ra: null, Ra_star: null, RaT: null, CK: null, ET: null, PLSm: null, Re: null, ReT: null, Re_star: null, CTR1: null, CTR1T: null, CTR1_star: null, IAA: null, ACC: null, CK_ex: null};
