export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "hH_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "hLVA_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "hNaP_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "mBK_base", internal, 170, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "mBK_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "mLVA_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "nHVK_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "nK_init", internal, 0, -Infinity, Infinity, false);
