export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["d_P1", "d_P1_prime", "d_P2", "d_P2_prime", "d_P3_prime", "d_R1", "d_R2", "n", "P1_init", "P1_prime_init", "P2_init", "P2_prime_init", "P3_prime_init", "R1_init", "R2_init", "s1", "s2", "s3", "sP1_prime_P1", "sP1R1", "sP2_prime_P2", "sP2R2", "sP3_prime_P2_prime"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[5] = 0 + 1 * internal.sP2_prime_P2 * P2 + 1 * internal.s2 / (1 + Math.pow((P1_prime), (internal.n))) - 1 * internal.d_P2_prime * P2_prime;
    ...
    dstatedt[0] = 0 + 1 * internal.i1 - 1 * internal.d_R1 * R1;
    var i2 = (((t >= 50 && t <= 100) ? 1 : 0));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "R1", "P1", "P1_prime", "R2", "P2", "P2_prime", "P3_prime"];
    this.metadata.internalOrder = {compartment: null, d_P1: null, d_P1_prime: null, d_P2: null, d_P2_prime: null, d_P3_prime: null, d_R1: null, d_R2: null, i1: null, initial_P1: null, initial_P1_prime: null, initial_P2: null, initial_P2_prime: null, initial_P3_prime: null, initial_R1: null, initial_R2: null, n: null, P1_init: null, P1_prime_init: null, P2_init: null, P2_prime_init: null, P3_prime_init: null, R1_init: null, R2_init: null, s1: null, s2: null, s3: null, sP1_prime_P1: null, sP1R1: null, sP2_prime_P2: null, sP2R2: null, sP3_prime_P2_prime: null};
    this.metadata.variableOrder = {R1: null, P1: null, P1_prime: null, R2: null, P2: null, P2_prime: null, P3_prime: null};
