export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "E_d_init", internal, 200000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "E_h_init", internal, 250, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "I_d_init", internal, 100000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "I_h_init", internal, 89, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "R_d_init", internal, 200000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "R_h_init", internal, 200000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "S_d_init", internal, 35000000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "S_h_init", internal, 1290000000, -Infinity, Infinity, false);
