export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "CP_init", internal, 0.036999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "CP2_init", internal, 0.045999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Dex", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IC_init", internal, 0.37, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "M_init", internal, 1.3999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "n", internal, 2, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "TF_init", internal, 0.13, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "M", "TF", "CP", "CP2", "IC"];
    ...
    this.metadata.variableOrder = {M: null, TF: null, CP: null, CP2: null, IC: null};
