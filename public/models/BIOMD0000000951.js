export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "k32", internal, 230000000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "k38", internal, 4200, -Infinity, Infinity, false);
    ...
    internal.k05 = internal.f_pH * internal.k5;
    internal.k06 = internal.f_pH * internal.k6;
    internal.k07 = internal.f_pH * internal.k7;
    internal.k10_0 = internal.f_pH * internal.k10;
    internal.k15_0 = internal.f_pH * internal.k15;
    internal.k16_0 = internal.f_pH * internal.k16;
    internal.k17_0 = internal.f_pH * internal.k17;
    internal.k22_0 = internal.f_pH * internal.k22;
    internal.k26_0 = internal.f_pH * internal.k26;
    internal.k31_0 = internal.f_pH * internal.k31;
    internal.k32_0 = internal.f_pH * internal.k32;
    internal.k43_0 = internal.f_pH * internal.k43;
    internal.k44_0 = internal.f_pH * internal.k44;
    this.updateMetadata();
  }
  getInternal() {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[20] = 0 - 1 * internal.compartment_1 * internal.k26_0 * IIa * V - 1 * internal.compartment_1 * internal.k44_0 * mIIa * V;
    dstatedt[21] = 0 + 1 * internal.compartment_1 * internal.k26_0 * IIa * V - 1 * internal.compartment_1 * (internal.k28 * Xa * Va - internal.k27 * Xa_Va) + 1 * internal.compartment_1 * internal.k44_0 * mIIa * V;
    dstatedt[2] = 0 - 1 * internal.compartment_1 * (internal.k2 * TF * VII - internal.k1 * TF_VII) - 1 * internal.compartment_1 * internal.k05 * TF_VIIa * VII - 1 * internal.compartment_1 * internal.k06 * Xa * VII - 1 * internal.compartment_1 * internal.k07 * IIa * VII;
    dstatedt[4] = 0 - 1 * internal.compartment_1 * (internal.k4 * TF * VIIa - internal.k3 * TF_VIIa) + 1 * internal.compartment_1 * internal.k05 * TF_VIIa * VII + 1 * internal.compartment_1 * internal.k06 * Xa * VII + 1 * internal.compartment_1 * internal.k07 * IIa * VII;
