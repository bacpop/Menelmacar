export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["C_init", "CN_init", "K_1P", "K_1T", "K_2P", "K_2T", "K_3P", "K_3T", "K_4P", "K_4T", "K_dP", "K_dT", "K_mP", "K_mT", "k_sP", "k_sT", "k1", "k2", "k3", "k4", "kd", "kd_C", "kd_CN", "Ki_P", "Ki_T", "l_d", "M_P_init", "M_T_init", "n", "P0_init", "P1_init", "P2_init", "T0_init", "T1_init", "T2_init", "V_1P", "V_1T", "V_2P", "V_2T", "V_3P", "V_3T", "V_4P", "V_4T", "v_dP", "v_dT_dark", "v_dT_fac", "v_mP", "v_mT", "v_sP", "v_sT"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "C_init", internal, 0.17999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "CN_init", internal, 1.2, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "K_1P", internal, 2, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "k1", internal, 1.2, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "kd_C", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kd_CN", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ki_P", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ki_T", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "l_d", internal, 12, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "M_P_init", internal, 0.089999999999999997, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "M_T_init", internal, 1.4099999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "n", internal, 4, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "P0_init", internal, 0.02, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "P1_init", internal, 0.02, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "P2_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "T0_init", internal, 0.54000000000000004, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "T1_init", internal, 0.79000000000000004, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "T2_init", internal, 4.6500000000000004, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "v_mP", internal, 0.80000000000000004, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "v_mT", internal, 0.69999999999999996, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "v_sP", internal, 0.80000000000000004, -Infinity, Infinity, false);
