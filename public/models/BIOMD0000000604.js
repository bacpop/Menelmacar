export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0 - 1 * internal.intra * (internal.kv14_1 * Math.pow((cellvol), (internal.kv14_3)) / (Math.pow((cellvol), (internal.kv14_3)) + internal.kv14_2) * (1 - OsmoE / (OsmoE + internal.kv14_4)) * G6P / internal.kv14_5 / (1 + G6P / internal.kv14_5)) + 1 * internal.intra * (internal.kv2_1 * glucose_i / (internal.kv2_2 + glucose_i)) - 2 * internal.intra * ((internal.kv3_1 * G6P / internal.kv3_2 - internal.kv3_3 * trehalose / internal.kv3_4) / (1 + G6P / internal.kv3_2 + trehalose / internal.kv3_4)) - 1 * internal.intra * ((internal.kv4_2 * (1 - Math.pow((F26DP), (internal.kv4_5)) / Math.pow((F26DP + internal.kv4_3), (internal.kv4_5))) + internal.kv4_1 * Math.pow((F26DP), (internal.kv4_5)) / Math.pow((F26DP + internal.kv4_3), (internal.kv4_5))) * Math.pow((G6P / internal.kv4_4), (2)) / (1 + Math.pow((G6P / internal.kv4_4), (2)))) - 1 * internal.intra * (G6P * volchangespeed / cellvol);
    ...
    dstatedt[14] = 0 - 1 * internal.intra * (Pfk2627a * volchangespeed / cellvol);
    dstatedt[15] = 0 - 1 * internal.intra * (Pfk2627i * volchangespeed / cellvol);
