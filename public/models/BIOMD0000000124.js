export class model {
  ...
  initial(t) {
    ...
    state[2] = internal.initial_nIR;
    state[3] = internal.initial_rIR;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[5] = (ainf - a) / internal.taua;
    dstatedt[4] = (ninf - n) / internal.taun;
    ...
    dstatedt[2] = (nIRinf - nIR) / tauIRn;
    dstatedt[3] = (rIRinf - rIR) / tauIRr;
    dstatedt[6] = - (ica + ik + ikca + ikatp + iir) / internal.cm;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "c", "cer", "nIR", "rIR", "n", "a", "V"];
    ...
    this.metadata.variableOrder = {c: null, cer: null, nIR: null, rIR: null, n: null, a: null, V: null};
