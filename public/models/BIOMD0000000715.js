export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "E_init", internal, 2.5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "gamma", internal, 0.69999999999999996, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "I_init", internal, 3, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "M_init", internal, 6, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "S_init", internal, 3.5, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "S", "E", "I", "M"];
    this.metadata.internalOrder = {A: null, alpha: null, alpha1: null, alpha2: null, beta: null, compartment: null, E_init: null, gamma: null, I_init: null, initial_E: null, initial_I: null, initial_M: null, initial_S: null, M_init: null, mu1: null, mu2: null, mu3: null, rho: null, S_init: null, tau: null};
    this.metadata.variableOrder = {S: null, E: null, I: null, M: null};
