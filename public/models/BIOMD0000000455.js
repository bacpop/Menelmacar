export class model {
  ...
  initial(t) {
    ...
    state[8] = internal.initial_y6;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["e1", "e2", "e3", "e4", "e5", "p1", "p2", "p3", "p4", "p5", "x1_init", "x2_init", "x3_init", "y1_init", "y2_init", "y3_init", "y4_init", "y5_init", "y6_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 + 1 * internal.e1 * (internal.p1 * y1 * x2 - x1 * x3) / (1 + y1 + x2 + x1 + x3 + y1 * x2 + x1 * x3) - 1 * internal.e2 * (internal.p2 * y4 * x3 - y5 * x2) / (1 + x3 + x2 + y4 + y5 + x3 * y4 + x2 * y5) - 1 * internal.e5 * internal.p5 * x3;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "x1", "x2", "x3", "y1", "y2", "y3", "y4", "y5", "y6"];
    this.metadata.internalOrder = {cell: null, e1: null, e2: null, e3: null, e4: null, e5: null, initial_x1: null, initial_x2: null, initial_x3: null, initial_y1: null, initial_y2: null, initial_y3: null, initial_y4: null, initial_y5: null, initial_y6: null, p1: null, p2: null, p3: null, p4: null, p5: null, x1_init: null, x2_init: null, x3_init: null, y1_init: null, y2_init: null, y3_init: null, y4_init: null, y5_init: null, y6_init: null};
    this.metadata.variableOrder = {x1: null, x2: null, x3: null, y1: null, y2: null, y3: null, y4: null, y5: null, y6: null};
