export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.IfrSfrPfr = 0.10000000000000001;
    internal.IrSrPr = 0;
    internal.kai = 0.80000000000000004;
    internal.kd = 0.10000000000000001;
    internal.kd_s = 1;
    internal.kd_v = 1;
    internal.kG = 0.10000000000000001;
    internal.kia = 0.10000000000000001;
    internal.kx = 0.20000000000000001;
    internal.ky = 1;
  ...
  initial(t) {
    ...
    state[8] = internal.initial_Gluc;
    state[9] = internal.initial_Yi;
    state[10] = internal.initial_V;
    state[11] = internal.initial_Pi;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Gluc_init", "Pfr_init", "Pi_init", "Pr_init", "prepreS_init", "preS_init", "S_init", "V_init", "Xa_init", "Xi_init", "Ya_init", "Yi_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[11] = 0 + 1 * internal.compartment * internal.kd * Pr;
    ...
    dstatedt[10] = 0 + 1 * internal.compartment * (internal.alpha2 / (1 + Math.pow((S), (3)))) - 1 * internal.compartment * V * internal.kd_v;
    ...
    dstatedt[6] = 0 - 1 * internal.kG * Ya * Gluc * internal.compartment;
    dstatedt[9] = 0 + 1 * internal.kG * Ya * Gluc * internal.compartment;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Pfr", "Pr", "Xi", "Xa", "prepreS", "preS", "Ya", "S", "Gluc", "Yi", "V", "Pi"];
    this.metadata.internalOrder = {alpha1: null, alpha2: null, compartment: null, Gluc_init: null, IfrSfrPfr: null, initial_Gluc: null, initial_Pfr: null, initial_Pi: null, initial_Pr: null, initial_prepreS: null, initial_preS: null, initial_S: null, initial_V: null, initial_Xa: null, initial_Xi: null, initial_Ya: null, initial_Yi: null, IrSrPr: null, kai: null, kd: null, kd_s: null, kd_v: null, kG: null, kia: null, kx: null, ky: null, Pfr_init: null, Pi_init: null, Pr_init: null, prepreS_init: null, preS_init: null, S_init: null, V_init: null, Xa_init: null, Xi_init: null, Ya_init: null, Yi_init: null};
    this.metadata.variableOrder = {Pfr: null, Pr: null, Xi: null, Xa: null, prepreS: null, preS: null, Ya: null, S: null, Gluc: null, Yi: null, V: null, Pi: null};
