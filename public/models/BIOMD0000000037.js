export class model {
  ...
  initial(t) {
    ...
    state[11] = internal.initial_Gluc;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["alpha1", "alpha2", "Gluc_init", "IfrSfrPfr", "IrSrPr", "kai", "kd", "kd_s", "kd_v", "kG", "kia", "kx", "ky", "Pfr_init", "Pi_init", "Pr_init", "prepreS_init", "preS_init", "S_init", "V_init", "Xa_init", "Xi_init", "Ya_init", "Yi_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[8] = 0 + 1 * internal.kG * Ya * Gluc * internal.compartment;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Pfr", "Pr", "Xi", "Xa", "prepreS", "preS", "Ya", "S", "Yi", "V", "Pi", "Gluc"];
    ...
    this.metadata.variableOrder = {Pfr: null, Pr: null, Xi: null, Xa: null, prepreS: null, preS: null, Ya: null, S: null, Yi: null, V: null, Pi: null, Gluc: null};
