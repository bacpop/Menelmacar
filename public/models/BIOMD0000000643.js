export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a", "A46_init", "A46bar", "A88_init", "ARPPtot", "b", "BB_init", "cAMP", "Complex_init", "k46", "k88", "KA", "kass", "kcamp", "kcatmast", "kcatpka", "kcatpp1", "kcatpp2a", "kdiss", "kmmast", "kmpka", "kmpp1", "kmpp2a", "kppx", "M_init", "MASTtot", "ModelValue_0", "ModelValue_1", "ModelValue_10", "ModelValue_11", "ModelValue_12", "ModelValue_13", "ModelValue_14", "ModelValue_15", "ModelValue_16", "ModelValue_17", "ModelValue_18", "ModelValue_19", "ModelValue_2", "ModelValue_20", "ModelValue_22", "ModelValue_23", "ModelValue_3", "ModelValue_4", "ModelValue_5", "ModelValue_6", "ModelValue_8", "ModelValue_9", "n", "PKA_init", "PKActot", "pp1", "PP2Atot"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "A88_init", internal, 0.19999999999999399, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "BB_init", internal, 11.8161515151515, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "cAMP", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Complex_init", internal, 1.9958693267679, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "kmpp2a", internal, 0.016151515151515201, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[4] = 0;
    dstatedt[5] = 0;
    dstatedt[0] = internal.ModelValue_8 * M * (internal.ModelValue_0 - A46) / (internal.ModelValue_9 + internal.ModelValue_22 * A88 / internal.ModelValue_0 + (internal.ModelValue_0 - A46)) - internal.ModelValue_6 * Complex;
    dstatedt[1] = internal.ModelValue_10 * PKA * (internal.ModelValue_0 - A88) / (internal.ModelValue_11 + internal.ModelValue_23 * A46 / internal.ModelValue_0 + internal.ModelValue_0 - A88) - internal.ModelValue_12 * internal.ModelValue_13 * A88 / (internal.ModelValue_14 + A88);
    dstatedt[2] = internal.kppx * (internal.ModelValue_2 - M) - internal.ModelValue_15 * A88 * M;
    dstatedt[3] = internal.ModelValue_16 * (internal.ModelValue_3 - PKA) * Math.pow((internal.ModelValue_20), (internal.ModelValue_17)) / (Math.pow((internal.ModelValue_18), (internal.ModelValue_17)) + Math.pow((internal.ModelValue_20), (internal.ModelValue_17))) - internal.ModelValue_19 * A46 * PKA;
  }
  names() {
