export class model {
  ...
  initial(t) {
    ...
    state[11] = internal.initial_lactate;
    state[12] = internal.initial_halfglucose;
    state[13] = internal.initial_Ac;
    state[14] = internal.initial_EtOH;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Ac_init", "AcCoA_init", "AcetoinIn_init", "AcetoinOut_init", "AcLac_init", "AcO_init", "AcP_init", "ADP_init", "ATP_init", "Butanediol_init", "CoA_init", "EtOH_init", "halfglucose_init", "k_14", "Kac_5", "Kaccoa_3", "Kaccoa_6", "Kacet_10", "Kacet_11", "Kacet_9", "Kaclac_8", "Kaclac_9", "Kaco_6", "Kaco_7", "Kacp_4", "Kacp_5", "Kadp_1", "Kadp_5", "Katp_1", "Katp_12", "Katp_5", "Kbut_11", "Kcoa_3", "Kcoa_6", "Keq_11", "Keq_2", "Keq_4", "Keq_5", "Keq_6", "Keq_7", "Keq_8", "Ketoh_7", "Kglc_1", "Ki_3", "Kiaccoa_4", "Kiacp_4", "Kicoa_4", "Kipi_4", "Klac_2", "Knad_1", "Knad_11", "Knad_13", "Knad_2", "Knad_3", "Knad_6", "Knad_7", "Knadh_1", "Knadh_11", "Knadh_13", "Knadh_2", "Knadh_3", "Knadh_6", "Knadh_7", "Ko_13", "Kpi_4", "Kpyr_1", "Kpyr_2", "Kpyr_3", "Kpyr_8", "lactate_init", "n_12", "n_8", "NAD_init", "NADH_init", "O2_init", "PO4_init", "pyruvate_init", "V_1", "V_10", "V_11", "V_12", "V_13", "V_2", "V_3", "V_4", "V_5", "V_6", "V_7", "V_8", "V_9"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    const lactate = state[11];
    const halfglucose = state[12];
    const Ac = state[13];
    const EtOH = state[14];
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "ADP", "NAD", "ATP", "NADH", "pyruvate", "CoA", "AcCoA", "AcP", "AcO", "AcLac", "AcetoinIn", "lactate", "halfglucose", "Ac", "EtOH", "AcetoinOut", "Butanediol", "O2", "PO4"];
    ...
    this.metadata.variableOrder = {ADP: null, NAD: null, ATP: null, NADH: null, pyruvate: null, CoA: null, AcCoA: null, AcP: null, AcO: null, AcLac: null, AcetoinIn: null, lactate: null, halfglucose: null, Ac: null, EtOH: null, AcetoinOut: null, Butanediol: null, O2: null, PO4: null};
