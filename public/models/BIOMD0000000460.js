export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["kbd", "kbs", "kbx", "kxd", "kxs", "kzd", "kzs", "lacz_init", "sigb_init", "x_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.IPTG * internal.kbs - sigb * (internal.kbd + internal.kbx * x) - 1 * - (internal.kzd * lacz) + internal.kzs * sigb - 1 * internal.kxs * sigb - internal.kxd * x;
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {compartment: null, initial_lacz: null, initial_sigb: null, initial_x: null, IPTG: null, kbd: null, kbs: null, kbx: null, kxd: null, kxs: null, kzd: null, kzs: null, lacz_init: null, sigb_init: null, x_init: null};
