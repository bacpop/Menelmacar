export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "IFNaenv_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IFNam_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IFNBenv_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IFNBm_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IRF7m_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IRF7Pn_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "SOCSm_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "sp", internal, 0.29999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "STAT_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "STATm_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "STATP2n_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "TFNenv_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "TJ_tot", internal, 0.0001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "TNFam_init", internal, 1, -Infinity, Infinity, false);
