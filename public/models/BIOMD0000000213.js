export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "HCOOH_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "p_10fTHF_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "p_5_10_CH2THF_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "p_5_10_CHTHF_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "p_5mTHF_init", internal, 0, -Infinity, Infinity, false);
