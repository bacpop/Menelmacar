export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["EI_init", "EIIA_init", "EIIAP_init", "EIIAPIICB_init", "EIICB_init", "EIICBP_init", "EIICBPGlc_init", "EIP_init", "EIPHPr_init", "Glc_init", "GlcP_init", "HPr_init", "HPrP_init", "HPrPIIA_init", "k10f", "k10r", "k1f", "k1r", "k2f", "k2r", "k3f", "k3r", "k4f", "k4r", "k5f", "k5r", "k6f", "k6r", "k7f", "k7r", "k8f", "k8r", "k9f", "k9r", "PEP_init", "Pyr_init", "PyrPI_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "Glc_init", internal, 500, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "GlcP_init", internal, 50, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PEP_init", internal, 2800, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Pyr_init", internal, 900, -Infinity, Infinity, false);
