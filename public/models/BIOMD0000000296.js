export class model {
  ...
  initial(t) {
    ...
    state[5] = internal.initial_source;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A1_init", "A2_init", "C1_init", "C2_init", "Cm", "D", "d2", "dAA1", "dAA2", "K1", "K2", "kA1", "kc1", "kc2", "sink_init", "source_init"], unusedUserAction);
    var internal = this.internal;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "C1", "C2", "A1", "A2", "sink", "source"];
    this.metadata.internalOrder = {A1_init: null, A2_init: null, C1_init: null, C2_init: null, Cm: null, D: null, d1: null, d2: null, dAA1: null, dAA2: null, environment: null, initial_A1: null, initial_A2: null, initial_C1: null, initial_C2: null, initial_sink: null, initial_source: null, IPTG: null, K1: null, K2: null, kA1: null, kA2: null, kc1: null, kc2: null, sink_init: null, source_init: null};
    this.metadata.variableOrder = {C1: null, C2: null, A1: null, A2: null, sink: null, source: null};
