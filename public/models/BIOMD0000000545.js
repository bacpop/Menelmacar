export class model {
  ...
  initial(t) {
    ...
    state[11] = internal.initial_DWD;
    state[12] = internal.initial_CDW;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["CD_init", "CDCS_init", "CDW_init", "COP1_init", "CS_init", "DWD_init", "HY5_init", "k1", "k2", "ka1", "ka2", "ka3", "ka4", "kd1", "kd2", "kd3", "kd4", "kdr1", "kdr2", "kdr3", "kdr3a", "kdr3b", "ks1", "ks2", "ks3", "ksr", "n1", "n2", "n3", "RUP_init", "UCS_init", "UR_init", "UV", "UVR8_M_init", "UVR8D_init", "UVR8M_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.ks1 * (1 + internal.UV * internal.n3 * (HY5 + internal.FHY3)) - internal.kdr1 * (1 + internal.n1 * internal.UV) * CS - 2 * internal.ka1 * Math.pow((CS), (2)) * Math.pow((UVR8M), (2)) - internal.kd1 * UCS - 2 * internal.ka2 * Math.pow((CS), (2)) * CD - internal.kd2 * CDCS;
    dstatedt[11] = 0 - 1 * internal.ka4 * CD * DWD - internal.kd4 * CDW;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "CS", "CD", "CDCS", "UVR8M", "UCS", "UVR8D", "RUP", "UR", "UVR8_M", "COP1", "HY5", "DWD", "CDW"];
    this.metadata.internalOrder = {CD_init: null, CDCS_init: null, CDW_init: null, COP1_init: null, CS_init: null, DWD_init: null, FHY3: null, HY5_init: null, Hypctol: null, initial_CD: null, initial_CDCS: null, initial_CDW: null, initial_COP1: null, initial_CS: null, initial_DWD: null, initial_HY5: null, initial_RUP: null, initial_UCS: null, initial_UR: null, initial_UVR8_M: null, initial_UVR8D: null, initial_UVR8M: null, k1: null, k2: null, ka1: null, ka2: null, ka3: null, ka4: null, kd1: null, kd2: null, kd3: null, kd4: null, kdr1: null, kdr2: null, kdr3: null, kdr3a: null, kdr3b: null, ks1: null, ks2: null, ks3: null, ksr: null, n1: null, n2: null, n3: null, RUP_init: null, UCS_init: null, UR_init: null, UV: null, UVR8_M_init: null, UVR8D_init: null, UVR8M_init: null};
    this.metadata.variableOrder = {CS: null, CD: null, CDCS: null, UVR8M: null, UCS: null, UVR8D: null, RUP: null, UR: null, UVR8_M: null, COP1: null, HY5: null, DWD: null, CDW: null};
