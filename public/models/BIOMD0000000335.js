export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ATIII_init", "II_init", "IIa_ATIII_init", "IIa_init", "IX_init", "IXa_ATIII_init", "IXa_init", "IXa_VIIIa_init", "IXa_VIIIa_X_init", "k1", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18", "k19", "k2", "k20", "k21", "k22", "k23", "k24", "k25", "k26", "k27", "k28", "k29", "k3", "k30", "k31", "k32", "k33", "k34", "k35", "k36", "k37", "k38", "k39", "k4", "k40", "k41", "k42", "k5", "k6", "k7", "k8", "k9", "mIIa_ATIII_init", "mIIa_init", "TF_init", "TF_VII_init", "TF_VIIa_ATIII_init", "TF_VIIa_init", "TF_VIIa_IX_init", "TF_VIIa_X_init", "TF_VIIa_Xa_init", "TF_VIIa_Xa_TFPI_init", "TFPI_init", "V_init", "Va_init", "VII_init", "VIIa_init", "VIII_init", "VIIIa_init", "VIIIa1_L_init", "VIIIa2_init", "X_init", "Xa_ATIII_init", "Xa_init", "Xa_TFPI_init", "Xa_Va_II_init", "Xa_Va_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "TF_init", internal, 2.5000000000000001e-11, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[12] = 0 - 1 * internal.compartment_1 * (internal.k19 * IXa * VIIIa - internal.k18 * IXa_VIIIa) + 1 * internal.compartment_1 * internal.k25 * IXa_VIIIa_X + 1 * internal.compartment_1 * internal.k25 * IXa_VIIIa - 1 * internal.compartment_1 * internal.k40 * IXa * ATIII + 1 * internal.compartment_1 * internal.k15 * TF_VIIa_IX;
    ...
    dstatedt[24] = 0 - 1 * internal.compartment_1 * internal.k32 * mIIa * Xa_Va - 1 * internal.compartment_1 * internal.k39 * mIIa * ATIII + 1 * internal.compartment_1 * internal.k31 * Xa_Va_II;
    ...
    dstatedt[20] = 0 - 1 * internal.compartment_1 * internal.k26 * IIa * V;
    dstatedt[21] = 0 + 1 * internal.compartment_1 * internal.k26 * IIa * V - 1 * internal.compartment_1 * (internal.k28 * Xa * Va - internal.k27 * Xa_Va);
    ...
    dstatedt[8] = 0 - 1 * internal.compartment_1 * (internal.k9 * TF_VIIa * X - internal.k8 * TF_VIIa_X) - 1 * internal.compartment_1 * (internal.k21 * IXa_VIIIa * X - internal.k20 * IXa_VIIIa_X) + 1 * internal.compartment_1 * internal.k25 * IXa_VIIIa_X;
