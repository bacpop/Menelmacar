export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A", "delta_l", "I", "K_l", "K_m", "l_init", "m_init", "N", "n_init", "S", "xi"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "l_init", internal, 0.099999999999998507, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "m_init", internal, 0.89999999999998803, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "N", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "n_init", internal, 0.89999999999998803, -Infinity, Infinity, false);
    ...
    internal.initial_lxl = internal.l_init;
  ...
  rhs(t, state, dstatedt) {
    ...
    const m = state[2];
    dstatedt[0] = 0;
    dstatedt[2] = internal.xi * m * (internal.N + 1) / (internal.N + lxl + m + n) - m - internal.K_m * lxl * m * m;
    dstatedt[1] = n * (internal.N + 1) / (internal.N + lxl + m + n) - n;
  }
  names() {
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {A: null, cell: null, delta_l: null, I: null, initial_lxl: null, initial_m: null, initial_n: null, K_l: null, K_m: null, l_init: null, m_init: null, N: null, n_init: null, S: null, xi: null};
