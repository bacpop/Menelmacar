export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.k1 = 0.75616000000000005;
    ...
    internal.v = 8.5492699999999994e-09;
  ...
  initial(t) {
    ...
    state[10] = internal.initial_FeOutside;
    state[11] = internal.initial_FeBM;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Avogadro", "Fe1Tf_init", "Fe2Tf_init", "FeBM_init", "FeDuo_init", "FeLiver_init", "FeOutside_init", "FeRBC_init", "FeRest_init", "FeSpleen_init", "Hepcidin_init", "kBMSpleen", "kDuoLoss", "kFe1Tf_Fe2Tf", "Ki", "kInBM", "kInDuo", "kInLiver", "kInRBC", "kInRest", "Km", "kNTBI_Fe1Tf", "kRestLoss", "ModelValue_28", "NTBI_init", "quantity_to_number_factor", "Tf_init", "vDiet", "VDuoNTBI", "VLiverNTBI", "vRBCSpleen", "VRestNTBI", "VSpleenNTBI"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Avogadro", internal, 6.0221417899999999e+23, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Fe1Tf_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Fe2Tf_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeBM_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeDuo_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeLiver_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeOutside_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeRBC_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeRest_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FeSpleen_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Hepcidin_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "ModelValue_28", internal, 6.0221417899999999e+23, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NTBI_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "vDiet", internal, 0, -Infinity, Infinity, false);
    ...
    internal.initial_FeOutside = internal.FeOutside_init;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[11] = 0 + 2 * (internal.kInBM * Fe2Tf * internal.Plasma) + 1 * (internal.kInBM * Fe1Tf * internal.Plasma) - 1 * (internal.kInRBC * FeBM * internal.BoneMarrow) - 1 * (internal.kBMSpleen * FeBM * internal.BoneMarrow);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "FeDuo", "FeRBC", "FeSpleen", "FeLiver", "Tf", "Hepcidin", "Fe2Tf", "Fe1Tf", "NTBI", "FeRest", "FeOutside", "FeBM"];
    this.metadata.internalOrder = {Avogadro: null, BoneMarrow: null, Duodenum: null, Fe1Tf_init: null, Fe2Tf_init: null, FeBM_init: null, FeDuo_init: null, FeLiver_init: null, FeOutside_init: null, FeRBC_init: null, FeRest_init: null, FeSpleen_init: null, Hepcidin_init: null, initial_Fe1Tf: null, initial_Fe2Tf: null, initial_FeBM: null, initial_FeDuo: null, initial_FeLiver: null, initial_FeOutside: null, initial_FeRBC: null, initial_FeRest: null, initial_FeSpleen: null, initial_Hepcidin: null, initial_NTBI: null, initial_Tf: null, k1: null, kBMSpleen: null, kDuoLoss: null, kFe1Tf_Fe2Tf: null, Ki: null, kInBM: null, kInDuo: null, kInLiver: null, kInRBC: null, kInRest: null, Km: null, kNTBI_Fe1Tf: null, kRestLoss: null, Liver: null, ModelValue_28: null, NTBI_init: null, Plasma: null, quantity_to_number_factor: null, RBC: null, RestOfBody: null, Spleen: null, Tf_init: null, v: null, vDiet: null, VDuoNTBI: null, VLiverNTBI: null, vRBCSpleen: null, VRestNTBI: null, VSpleenNTBI: null};
    this.metadata.variableOrder = {FeDuo: null, FeRBC: null, FeSpleen: null, FeLiver: null, Tf: null, Hepcidin: null, Fe2Tf: null, Fe1Tf: null, NTBI: null, FeRest: null, FeOutside: null, FeBM: null};
