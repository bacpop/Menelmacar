export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[21] = 0 + 1 * internal.intra * (((t < internal.kv22_Hog1D_t ? internal.kv22_1 * - Turgor / (internal.kv22_3 + - Turgor) * 1.5 * 1 - internal.kv22_1 * Fps1r : (internal.kv22_1 * internal.kv22_Hog1D_fT / (internal.kv22_3 + internal.kv22_Hog1D_fT) * 1.5 * 1 - internal.kv22_1 * Fps1r) * internal.kv22_Hog1D_d)));
    ...
    dstatedt[12] = 0 - 1 * internal.intra * (Hog1 * volchangespeed / cellvol);
    dstatedt[13] = 0 - 1 * internal.intra * (Hog1PP * volchangespeed / cellvol);
