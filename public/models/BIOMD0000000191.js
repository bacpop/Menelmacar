export class model {
  ...
  initial(t) {
    ...
    state[2] = internal.initial_ARGex;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ARGex_init", "ARGin_init", "Kioarg", "Kiornhat", "Kmarg", "Kmeffllat", "Kmhat", "Kmlat", "Kmnos1", "Kmodc", "ORN_init", "Vmaxarg", "Vmaxefflhat", "Vmaxeffllat", "Vmaxhat", "Vmaxlat", "Vmaxnos1", "Vmaxodc"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "ARGex_init", internal, 330, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "ORN", "ARGin", "ARGex"];
    ...
    this.metadata.variableOrder = {ORN: null, ARGin: null, ARGex: null};
