export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var Orai1_init = internal.Orai1_t - (internal.r_hill * internal.initial_Oc + internal.r_hill * internal.initial_O_o);
    var S2_init = Math.pow((internal.K1), (2)) / (Math.pow((internal.initial_Ca_ER), (2)) + Math.pow((internal.K1), (2))) * (internal.St - internal.initial_S2a);
    internal.initial_Orai1 = Orai1_init;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A", "Ca_Cyt_init", "Ca_ec", "Ca_ER_init", "IP3_Cyt_init", "k_a", "K_deg", "k_i", "K_PLC", "K_PMCA", "K_SERCA", "k_soc", "K1", "K2", "Ka", "Kc", "Kd", "kd_oligo", "kdc", "kdeg", "kdo", "Ki", "Ko", "kod", "kop", "L", "l_hill", "n_hill", "O_o_init", "Oc_init", "Orai1_t", "p", "P_IP3R", "q", "r_hill", "S2a_init", "S4_init", "St", "V_PLC", "V_PMCA", "V_PMleak", "V_SERCA", "Vcp", "Vs4"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "S2a_init", internal, 0, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {A: null, Ca_Cyt_init: null, Ca_ec: null, Ca_ER_init: null, Cytoplasm: null, ER: null, initial_Ca_Cyt: null, initial_Ca_ER: null, initial_h: null, initial_IP3_Cyt: null, initial_O_o: null, initial_Oc: null, initial_Orai1: null, initial_S2: null, initial_S2a: null, initial_S4: null, IP3_Cyt_init: null, k_a: null, K_deg: null, k_i: null, K_PLC: null, K_PMCA: null, K_SERCA: null, k_soc: null, K1: null, K2: null, Ka: null, Kc: null, Kd: null, kd_oligo: null, kdc: null, kdeg: null, kdo: null, Ki: null, Ko: null, kod: null, kop: null, L: null, l_hill: null, n_hill: null, O_o_init: null, Oc_init: null, Orai1_t: null, p: null, P_IP3R: null, PM: null, q: null, r_hill: null, S2a_init: null, S4_init: null, St: null, V_PLC: null, V_PMCA: null, V_PMleak: null, V_SERCA: null, Vcp: null, Vs4: null};
