export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["alpha1", "alpha2", "B_init", "beta1", "beta2", "C_init", "g11", "g12", "g21", "g22", "gammaT", "k1", "k2", "LT", "r11", "r12", "r21", "r22", "Tumour_init", "z_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "B_init", internal, 316, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "C_init", internal, 15, -Infinity, Infinity, false);
