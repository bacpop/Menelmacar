export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "C_Cytotoxic_T_Lymphocytes_Coverage_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "V_Tumor_Volume_init", internal, 0, -Infinity, Infinity, false);
