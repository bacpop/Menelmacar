export class model {
  ...
  initial(t) {
    ...
    state[3] = internal.initial_p100t;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["k1", "kcat", "Km", "NIK_init", "p100_init", "p100t_init", "p52_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0;
    dstatedt[3] = 0;
    dstatedt[0] = 0 + 1 * internal.compartment * internal.k1 * p100t - 1 * internal.compartment * (NIK * internal.kcat * p100 / (internal.Km + p100)) - 1 * internal.compartment * internal.k1 * p100;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "p100", "p52", "NIK", "p100t"];
    this.metadata.internalOrder = {compartment: null, initial_NIK: null, initial_p100: null, initial_p100t: null, initial_p52: null, k1: null, kcat: null, Km: null, NIK_init: null, p100_init: null, p100t_init: null, p52_init: null};
    this.metadata.variableOrder = {p100: null, p52: null, NIK: null, p100t: null};
