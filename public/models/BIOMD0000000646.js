export class model {
  ...
  initial(t) {
    ...
    state[9] = internal.initial_Emi1Cdh1;
    state[10] = internal.initial_Emi1Cdh1p;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Cdh1_init", internal, 1, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const p27 = state[7];
    const Cdh1 = state[8];
    const Emi1Cdh1 = state[9];
    const Emi1Cdh1p = state[10];
    ...
    dstatedt[9] = 0 + 1 * internal.compartment * (internal.kasec * Cdh1 * Emi1 - internal.kdiec * Emi1Cdh1) - 1 * internal.compartment * internal.kdemi1 * Emi1Cdh1 - 1 * internal.compartment * ((internal.kicdh1e * CycE / (1 + internal.Inhibitor) + internal.kicdh1a * CycA / (1 + internal.Inhibitor)) * Emi1Cdh1) + 1 * internal.compartment * internal.kacdh1 * Emi1Cdh1p;
    dstatedt[10] = 0 + 1 * internal.compartment * (internal.kasec * Cdh1p * Emi1 - internal.kdiec * Emi1Cdh1p) + 1 * internal.compartment * ((internal.kicdh1e * CycE / (1 + internal.Inhibitor) + internal.kicdh1a * CycA / (1 + internal.Inhibitor)) * Emi1Cdh1) - 1 * internal.compartment * internal.kacdh1 * Emi1Cdh1p - 1 * internal.compartment * internal.kdemi1 * Emi1Cdh1p;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "CycE", "CycA", "CycEp27", "CycAp27", "Skp2", "Cdh1p", "Emi1", "p27", "Cdh1", "Emi1Cdh1", "Emi1Cdh1p"];
    this.metadata.internalOrder = {Cdh1_init: null, Cdh1p_init: null, compartment: null, CycA_init: null, CycAp27_init: null, CycE_init: null, CycEp27_init: null, Emi1_init: null, Emi1Cdh1_init: null, Emi1Cdh1p_init: null, Inhibitor: null, initial_Cdh1: null, initial_Cdh1p: null, initial_CycA: null, initial_CycAp27: null, initial_CycE: null, initial_CycEp27: null, initial_Emi1: null, initial_Emi1Cdh1: null, initial_Emi1Cdh1p: null, initial_p27: null, initial_Skp2: null, kacdh1: null, kasec: null, kassa: null, kasse: null, kd27: null, kd27a: null, kd27e: null, kdcyca: null, kdcycac1: null, kdcyce: null, kdcycea: null, kdcycee: null, kdemi1: null, kdiec: null, kdisa: null, kdise: null, kdskp2: null, kdskp2c1: null, kicdh1a: null, kicdh1e: null, ks27: null, kscyca: null, kscyce: null, ksemi1: null, ksskp2: null, p27_init: null, Skp2_init: null};
    this.metadata.variableOrder = {CycE: null, CycA: null, CycEp27: null, CycAp27: null, Skp2: null, Cdh1p: null, Emi1: null, p27: null, Cdh1: null, Emi1Cdh1: null, Emi1Cdh1p: null};
