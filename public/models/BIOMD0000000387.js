export class model {
  ...
  initial(t) {
    ...
    state[6] = internal.initial_starch;
    return state;
  }
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 - 2 * internal.chloroplast * (((Vc + Vj - Math.abs(Vc - Vj)) / 2 + Vp - Math.abs((Vc + Vj - Math.abs(Vc - Vj)) / 2 - Vp)) / 2) - 2 * internal.chloroplast * (phi * ((Vc + Vj - Math.abs(Vc - Vj)) / 2 + Vp - Math.abs((Vc + Vj - Math.abs(Vc - Vj)) / 2 - Vp)) / 2) + 1 * internal.chloroplast * (J / 2 * (NADP / internal.Nt));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "RuBP", "PGA", "NADPH", "CO2", "O2", "NADP", "starch"];
    this.metadata.internalOrder = {a: null, alpha: null, chloroplast: null, CO2_init: null, initial_CO2: null, initial_NADP: null, initial_NADPH: null, initial_O2: null, initial_PGA: null, initial_RuBP: null, initial_starch: null, Jmax: null, Kc: null, Ko: null, NADPH_init: null, Nt: null, O2_init: null, PGA_init: null, Q: null, Rp: null, RuBP_init: null, starch_init: null, TPU: null, Vcmax: null};
    this.metadata.variableOrder = {RuBP: null, PGA: null, NADPH: null, CO2: null, O2: null, NADP: null, starch: null};
