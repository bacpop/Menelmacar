export class model {
  ...
  initial(t) {
    ...
    state[4] = internal.initial_HeP;
    state[5] = internal.initial_E4P;
    state[6] = internal.initial_SBP;
    state[7] = internal.initial_S7P;
    state[8] = internal.initial_PeP;
    state[9] = internal.initial_RuBP;
    state[10] = internal.initial_ATP;
    state[11] = internal.initial_PGCA;
    state[12] = internal.initial_GCA;
    state[13] = internal.initial_GCEA;
    state[14] = internal.initial_HPRc;
    state[15] = internal.initial_GCAc;
    state[16] = internal.initial_GOAc;
    state[17] = internal.initial_GLYc;
    state[18] = internal.initial_SERc;
    state[19] = internal.initial_GCEAc;
    state[20] = internal.initial_PGAc;
    state[21] = internal.initial_TPc;
    state[22] = internal.initial_FBPc;
    state[23] = internal.initial_HePc;
    state[24] = internal.initial_F26BPc;
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "F26BPc_init", internal, 7.7999999999999999e-06, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FBP_init", internal, 0.66999999999999904, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FBPc_init", internal, 2, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "GCA_init", internal, 0.35999999999999999, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "HePc_init", internal, 5.7999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "HPRc_init", internal, 0.0035000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "K", internal, 0.02, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Kp2", internal, 0.11, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Kr1", internal, 4, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "KR1", internal, 0.83999999999999997, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Kr2", internal, 2.5499999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "KR2", internal, 0.040000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Kr3", internal, 0.16, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "KR3", internal, 0.074999999999999997, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Kr4", internal, 50, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Kr5", internal, 11, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PGCA_init", internal, 0.0028999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "q", internal, 607, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "SERc_init", internal, 7.5, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const GLYc = state[17];
    const SERc = state[18];
    const GCEAc = state[19];
    const PGAc = state[20];
    const TPc = state[21];
    const FBPc = state[22];
    const HePc = state[23];
    const F26BPc = state[24];
    ...
    var F6P = HeP / 2.2999999999999998 / (1 + 1 / 2.2999999999999998 + 0.058000000000000003);
    var F6Pc = HePc / 2.2999999999999998 / (1 + 1 / 2.2999999999999998 + 0.058400000000000001);
    var G1P = HeP * 0.058000000000000003 / (1 + 1 / 2.2999999999999998 + 0.058000000000000003);
    var G1Pc = HePc * 0.058400000000000001 / (1 + 1 / 2.2999999999999998 + 0.058400000000000001);
    var GAP = 0.050000000000000003 * TP / (1 + 0.050000000000000003);
