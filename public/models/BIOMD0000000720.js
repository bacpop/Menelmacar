export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["CycD_init", "CycE_init", "E2F_init", "JCD", "JCE", "JE", "JM", "JP", "JS", "kdCD1", "kdCD2", "kdCE1", "kdCE2", "kdE", "kdM1", "kdM2", "kdmiR", "kdP", "kdR", "kdRE", "kP", "kP1", "kP2", "kRE", "ksCD1", "ksCD2", "ksCE", "ksE1", "ksE2", "ksM", "ksmiR", "ksR", "miR449_init", "Myc_init", "PRB_init", "RB_init", "RE_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    const PRB = state[7];
    dstatedt[2] = 0 - 1 * internal.compartment * (internal.kdCD2 * miR449 * (CycD / (internal.JCD + CycD))) + 1 * internal.compartment * (internal.ksCD1 * internal.S / (internal.JS + internal.S)) + 1 * internal.compartment * (internal.ksCD2 * Myc / (internal.JM + Myc)) - 1 * internal.compartment * internal.kdCD1 * CycD;
    ...
    dstatedt[1] = 0 - 1 * internal.compartment * (internal.kdM2 * miR449 * (Myc / (internal.JM + Myc))) + 1 * internal.compartment * (internal.ksM * internal.S / (internal.JS + internal.S)) - 1 * internal.compartment * internal.kdM1 * Myc;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "E2F", "Myc", "CycD", "RE", "CycE", "RB", "miR449", "PRB"];
    this.metadata.internalOrder = {compartment: null, CycD_init: null, CycE_init: null, E2F_init: null, initial_CycD: null, initial_CycE: null, initial_E2F: null, initial_miR449: null, initial_Myc: null, initial_PRB: null, initial_RB: null, initial_RE: null, JCD: null, JCE: null, JE: null, JM: null, JP: null, JS: null, kdCD1: null, kdCD2: null, kdCE1: null, kdCE2: null, kdE: null, kdM1: null, kdM2: null, kdmiR: null, kdP: null, kdR: null, kdRE: null, kP: null, kP1: null, kP2: null, kRE: null, ksCD1: null, ksCD2: null, ksCE: null, ksE1: null, ksE2: null, ksM: null, ksmiR: null, ksR: null, miR449_init: null, Myc_init: null, PRB_init: null, RB_init: null, RE_init: null, S: null};
    this.metadata.variableOrder = {E2F: null, Myc: null, CycD: null, RE: null, CycE: null, RB: null, miR449: null, PRB: null};
