export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A", "K1", "k10", "K10", "K11", "K12", "k2", "K2", "k3", "K3", "k4", "K4", "k5", "K5", "k6", "K6", "k7", "K7", "k8", "K8", "k9", "K9", "Ka", "KI", "species_0_init", "species_1_init", "species_10_init", "species_11_init", "species_12_init", "species_2_init", "species_3_init", "species_4_init", "species_5_init", "species_6_init", "species_7_init", "species_8_init", "species_9_init", "V1", "V11", "V12"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "K11", internal, 50, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "K12", internal, 50, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "species_11_init", internal, 99.999990368875203, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "V11", internal, 0.10000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "V12", internal, 0.5, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[11] = 0 - 1 * internal.compartment_0 * (internal.V11 * species_11 / internal.K11 / (1 + species_11 / internal.K11) * ((1 + internal.A * species_7 / internal.Ka) / (1 + species_7 / internal.Ka))) + 1 * internal.compartment_0 * (internal.V12 * species_12 / (internal.K12 + species_12));
    dstatedt[12] = 0 + 1 * internal.compartment_0 * (internal.V11 * species_11 / internal.K11 / (1 + species_11 / internal.K11) * ((1 + internal.A * species_7 / internal.Ka) / (1 + species_7 / internal.Ka))) - 1 * internal.compartment_0 * (internal.V12 * species_12 / (internal.K12 + species_12));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "species_0", "species_1", "species_2", "species_3", "species_4", "species_5", "species_6", "species_7", "species_8", "species_9", "species_10", "species_11", "species_12"];
    this.metadata.internalOrder = {A: null, compartment_0: null, initial_species_0: null, initial_species_1: null, initial_species_10: null, initial_species_11: null, initial_species_12: null, initial_species_2: null, initial_species_3: null, initial_species_4: null, initial_species_5: null, initial_species_6: null, initial_species_7: null, initial_species_8: null, initial_species_9: null, K1: null, k10: null, K10: null, K11: null, K12: null, k2: null, K2: null, k3: null, K3: null, k4: null, K4: null, k5: null, K5: null, k6: null, K6: null, k7: null, K7: null, k8: null, K8: null, k9: null, K9: null, Ka: null, KI: null, species_0_init: null, species_1_init: null, species_10_init: null, species_11_init: null, species_12_init: null, species_2_init: null, species_3_init: null, species_4_init: null, species_5_init: null, species_6_init: null, species_7_init: null, species_8_init: null, species_9_init: null, V1: null, V11: null, V12: null};
    this.metadata.variableOrder = {species_0: null, species_1: null, species_2: null, species_3: null, species_4: null, species_5: null, species_6: null, species_7: null, species_8: null, species_9: null, species_10: null, species_11: null, species_12: null};
