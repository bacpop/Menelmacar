export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var Anaphase_promoting_complex_init = internal.initial_Anaphase_promoting_complex_total - internal.initial_Anaphase_promoting_complex_Phosphorylated;
    internal.initial_Anaphase_promoting_complex = Anaphase_promoting_complex_init;
    ...
    state[3] = internal.initial_Anaphase_promoting_complex;
    state[4] = internal.initial_Anaphase_promoting_complex_total;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Anaphase_promoting_complex_total_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdk_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Securin_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const Anaphase_promoting_complex = state[3];
    dstatedt[3] = 0 + 0;
    dstatedt[4] = 0;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Cdk", "Anaphase_promoting_complex_Phosphorylated", "Securin", "Anaphase_promoting_complex", "Anaphase_promoting_complex_total"];
    this.metadata.internalOrder = {Anaphase_promoting_complex_Phosphorylated_init: null, Anaphase_promoting_complex_total_init: null, Cdk_init: null, initial_Anaphase_promoting_complex: null, initial_Anaphase_promoting_complex_Phosphorylated: null, initial_Anaphase_promoting_complex_total: null, initial_Cdk: null, initial_Securin: null, K_1APC: null, k_2APC: null, K_2APC: null, k_d1cdk: null, k_d1sec: null, k_dcdk: null, K_dcdk: null, k_dsec: null, K_dsec: null, nuclear: null, Securin_init: null, V_1APC: null, V_scdk: null, V_ssec: null};
    this.metadata.variableOrder = {Cdk: null, Anaphase_promoting_complex_Phosphorylated: null, Securin: null, Anaphase_promoting_complex: null, Anaphase_promoting_complex_total: null};
