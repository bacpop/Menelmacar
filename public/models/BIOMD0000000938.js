export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.Anaphase_promoting_complex_total = 1;
    internal.nuclear = 1;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Anaphase_promoting_complex_Phosphorylated_init", "Cdk_init", "K_1APC", "k_2APC", "K_2APC", "k_d1cdk", "k_d1sec", "k_dcdk", "K_dcdk", "k_dsec", "K_dsec", "Securin_init", "V_1APC", "V_scdk", "V_ssec"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    var Anaphase_promoting_complex = internal.Anaphase_promoting_complex_total - Anaphase_promoting_complex_Phosphorylated;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Cdk", "Anaphase_promoting_complex_Phosphorylated", "Securin"];
    this.metadata.internalOrder = {Anaphase_promoting_complex_Phosphorylated_init: null, Anaphase_promoting_complex_total: null, Cdk_init: null, initial_Anaphase_promoting_complex_Phosphorylated: null, initial_Cdk: null, initial_Securin: null, K_1APC: null, k_2APC: null, K_2APC: null, k_d1cdk: null, k_d1sec: null, k_dcdk: null, K_dcdk: null, k_dsec: null, K_dsec: null, nuclear: null, Securin_init: null, V_1APC: null, V_scdk: null, V_ssec: null};
    this.metadata.variableOrder = {Cdk: null, Anaphase_promoting_complex_Phosphorylated: null, Securin: null};
