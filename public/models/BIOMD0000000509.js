export class model {
  ...
  initial(t) {
    ...
    var rscon_init = (Math.tanh((internal.rscrit - internal.initial_rs) / 0.01) + 1) / 2;
    ...
    internal.initial_rscon = rscon_init;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["addash", "ae", "af", "alpha", "atp_init", "ax", "cabasil", "d_init", "datpp", "ddd", "dee", "dip", "dist", "dxx", "e_init", "f", "g", "gamma", "gf", "ip3_init", "ip30", "ip3min", "ka", "kd", "kdeg", "kkdeg", "kr", "krel", "kxk", "m", "n", "p1", "p2", "p3", "p4", "p5", "pd", "pe", "ps", "px", "qd", "qe", "qx", "r_init", "rhstar", "rs_init", "rscrit", "rt", "scale", "smoothness", "vatp_s", "vdeg", "x_init", "y_init", "ymax", "yo"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[9] = 0 + 0;
    dstatedt[11] = 0 + 0;
    dstatedt[12] = 0 + internal.scale * (internal.vatp_s * (y - atp) * rscon * ip3con * ((ip3 - internal.ip3min) / (internal.krel + ip3)) - internal.vdeg * atp / (internal.kkdeg + atp));
    ...
    dstatedt[13] = 0 + internal.scale * (internal.alpha * (internal.ymax - y) - rscon * ip3con * internal.vatp_s * (y - atp) * ((ip3 - internal.ip3min) / (internal.krel + ip3)));
  }
  names() {
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {addash: null, ae: null, af: null, alpha: null, atp_init: null, ax: null, cabasil: null, cell: null, d_init: null, datpp: null, ddd: null, dee: null, dip: null, dist: null, dxx: null, e_init: null, f: null, g: null, gamma: null, gf: null, initial_ad: null, initial_atp: null, initial_ca: null, initial_d: null, initial_delta: null, initial_e: null, initial_gstar: null, initial_ip3: null, initial_ip3con: null, initial_kg: null, initial_r: null, initial_ro: null, initial_rs: null, initial_rscon: null, initial_x: null, initial_y: null, ip3_init: null, ip30: null, ip3min: null, ka: null, kd: null, kdeg: null, kg_init: null, kkdeg: null, kr: null, krel: null, kxk: null, m: null, n: null, p1: null, p2: null, p3: null, p4: null, p5: null, pd: null, pe: null, ps: null, px: null, qd: null, qe: null, qx: null, r_init: null, rhstar: null, rs_init: null, rscrit: null, rt: null, scale: null, smoothness: null, vatp_s: null, vdeg: null, x_init: null, y_init: null, ymax: null, yo: null};
