export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["k1cat", "k2cat", "k3cat", "k4cat", "Km1", "Km2", "Km3", "Km4", "Km5", "M_init", "MAPKK_init", "MKP3_init", "Mp_init", "Mpp_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0;
    dstatedt[4] = 0;
    dstatedt[0] = 0 - 1 * internal.uVol * (internal.k1cat * MAPKK * M / internal.Km1 / (1 + M / internal.Km1 + Mp / internal.Km2)) + 1 * internal.uVol * (internal.k4cat * MKP3 * Mp / internal.Km4 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5));
    dstatedt[1] = 0 + 1 * internal.uVol * (internal.k1cat * MAPKK * M / internal.Km1 / (1 + M / internal.Km1 + Mp / internal.Km2)) - 1 * internal.uVol * (internal.k2cat * MAPKK * Mp / internal.Km2 / (1 + M / internal.Km1 + Mp / internal.Km2)) + 1 * internal.uVol * (internal.k3cat * MKP3 * Mpp / internal.Km3 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5)) - 1 * internal.uVol * (internal.k4cat * MKP3 * Mp / internal.Km4 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5));
    dstatedt[2] = 0 + 1 * internal.uVol * (internal.k2cat * MAPKK * Mp / internal.Km2 / (1 + M / internal.Km1 + Mp / internal.Km2)) - 1 * internal.uVol * (internal.k3cat * MKP3 * Mpp / internal.Km3 / (1 + Mpp / internal.Km3 + Mp / internal.Km4 + M / internal.Km5));
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "M", "Mp", "Mpp", "MAPKK", "MKP3"];
    this.metadata.internalOrder = {initial_M: null, initial_MAPKK: null, initial_MKP3: null, initial_Mp: null, initial_Mpp: null, k1cat: null, k2cat: null, k3cat: null, k4cat: null, Km1: null, Km2: null, Km3: null, Km4: null, Km5: null, M_init: null, MAPKK_init: null, MKP3_init: null, Mp_init: null, Mpp_init: null, uVol: null};
    this.metadata.variableOrder = {M: null, Mp: null, Mpp: null, MAPKK: null, MKP3: null};
