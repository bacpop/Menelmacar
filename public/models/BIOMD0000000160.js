export class model {
  ...
  initial(t) {
    ...
    state[18] = internal.initial_CYC;
    state[19] = internal.initial_prcper;
    state[20] = internal.initial_prcv;
    state[21] = internal.initial_prcpdp;
    state[22] = internal.initial_prvc;
    state[23] = internal.initial_prpc;
    state[24] = internal.initial_prct;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "CCPT_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "CLK_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "clkm_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "clkp_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PDP_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "pdpm_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "pdpp_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "PER_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "perm_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "perp_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "TIM_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "timm_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "timp_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "VRI_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "vrim_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "vrip_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const TIM = state[17];
    const CYC = state[18];
    const prcper = state[19];
    const prcv = state[20];
    const prcpdp = state[21];
    const prvc = state[22];
    const prpc = state[23];
    const prct = state[24];
    dstatedt[2] = 0;
    ...
    dstatedt[21] = 0 - 1 * internal.wholeCell * internal.ubccpdpp * prcpdp + 1 * internal.wholeCell * (1 - prcpdp) * internal.bccpdpp * CC;
    dstatedt[19] = 0 + 1 * internal.wholeCell * (1 - prcper) * internal.bccperp * CC - 1 * internal.wholeCell * prcper * internal.ubccperp;
    dstatedt[24] = 0 + 1 * internal.wholeCell * (1 - prct) * internal.bcctimp * CC - 1 * internal.wholeCell * prct * internal.ubcctimp;
    dstatedt[20] = 0 - 1 * internal.wholeCell * internal.ubccvrip * prcv + 1 * internal.wholeCell * (1 - prcv) * internal.bccvrip * CC;
    dstatedt[23] = 0 + 1 * internal.wholeCell * (1 - prvc - prpc) * internal.bpdpclkp * PDP - 1 * internal.wholeCell * prpc * internal.ubpdpclkp;
    dstatedt[22] = 0 + 1 * internal.wholeCell * (1 - prvc - prpc) * internal.bvriclkp * VRI - 1 * internal.wholeCell * prvc * internal.ubvriclkp;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "CC", "CCPT", "clkp", "perp", "clkm", "perm", "PT", "vrip", "vrim", "VRI", "pdpp", "pdpm", "PDP", "CLK", "PER", "timp", "timm", "TIM", "CYC", "prcper", "prcv", "prcpdp", "prvc", "prpc", "prct"];
    ...
    this.metadata.variableOrder = {CC: null, CCPT: null, clkp: null, perp: null, clkm: null, perm: null, PT: null, vrip: null, vrim: null, VRI: null, pdpp: null, pdpm: null, PDP: null, CLK: null, PER: null, timp: null, timm: null, TIM: null, CYC: null, prcper: null, prcv: null, prcpdp: null, prvc: null, prpc: null, prct: null};
