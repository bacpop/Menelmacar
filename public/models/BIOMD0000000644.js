export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a", "A46_init", "ARPPtot", "b", "cAMP", "k46", "k88", "KA", "kass", "kcamp", "kcatmast", "kcatpka", "kcatpp1", "kcatpp2a", "kdiss", "kmmast", "kmpka", "kmpp1", "kpka", "kppx", "M_init", "MASTtot", "ModelValue_0", "ModelValue_1", "ModelValue_10", "ModelValue_11", "ModelValue_12", "ModelValue_13", "ModelValue_14", "ModelValue_17", "ModelValue_18", "ModelValue_19", "ModelValue_2", "ModelValue_20", "ModelValue_21", "ModelValue_22", "ModelValue_25", "ModelValue_28", "ModelValue_29", "ModelValue_3", "ModelValue_30", "ModelValue_4", "ModelValue_5", "ModelValue_6", "ModelValue_8", "ModelValue_9", "n", "PKA_init", "PKActot", "pp1", "PP2Atot", "r"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "M_init", internal, 0.0093807000000000005, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "ModelValue_30", internal, 0.050000000000000003, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PKA_init", internal, 0.01, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[4] = 0 + 0;
    dstatedt[5] = 0 + 0;
    dstatedt[0] = 0 + internal.ModelValue_8 * M * (internal.ARPPtot - A46) / (internal.ModelValue_9 + internal.ModelValue_25 * A88 / internal.ModelValue_0 + internal.ModelValue_29 * (internal.ModelValue_2 - M) / internal.ModelValue_2 + (internal.ARPPtot - A46)) - internal.ModelValue_6 * Complex;
    dstatedt[1] = 0 + internal.ModelValue_10 * PKA * (internal.ARPPtot - A88) / (internal.ModelValue_11 + internal.ModelValue_28 * A46 / internal.ModelValue_0 + internal.ARPPtot - A88) - internal.ModelValue_12 * internal.ModelValue_13 * A88 / (internal.ModelValue_14 + A88);
    dstatedt[2] = 0 + internal.ModelValue_30 * (internal.ModelValue_2 - M) - internal.ModelValue_17 * A88 * M - internal.kpka * PKA * M;
    dstatedt[3] = 0 + internal.ModelValue_18 * (internal.ModelValue_3 - PKA) * Math.pow((internal.ModelValue_22), (internal.ModelValue_19)) / (Math.pow((internal.ModelValue_20), (internal.ModelValue_19)) + Math.pow((internal.ModelValue_22), (internal.ModelValue_19))) - internal.ModelValue_21 * A46 * PKA;
  }
  names() {
