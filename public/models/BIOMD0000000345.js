export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var I2RPen_init = internal.Rtotal - internal.initial_R - internal.initial_IR - internal.initial_I2R - internal.initial_Rp - internal.initial_IRp - internal.initial_I2Rp - internal.initial_Ren - internal.initial_IRen - internal.initial_I2Ren - internal.initial_RPen - internal.initial_IRPen;
    internal.initial_I2RPen = I2RPen_init;
    ...
    state[12] = internal.initial_I2RPen;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "ins_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Ren_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    var i5xi5 = internal.kyden * RPen;
    var i6xi6 = internal.kyp * IRen - internal.kyden * IRPen;
    var i7xi7 = internal.kyp * I2Ren - internal.kyden * I2RPen;
    ...
    dstatedt[3] = 0 + r3 - r7 - f3;
    dstatedt[9] = 0 + - i3 - i7xi7 + f3;
    dstatedt[6] = 0 + r4 + r7 - f6;
    dstatedt[2] = 0 + r1 - r3 - r6 - f2;
    dstatedt[8] = 0 + - i1 + i3 - i6xi6 + f2;
    dstatedt[5] = 0 + r2 - r4 + r6 - f5;
    dstatedt[11] = 0 + - i2 + i4 + i6xi6 + f5;
    dstatedt[0] = 0 + - r1 + r5 - f1;
    dstatedt[7] = 0 + i1 + i5xi5 + f1;
    dstatedt[4] = 0 + - r2 - r5 - f4;
    dstatedt[10] = 0 + i2 - i5xi5 + f4;
  }
  names() {
