export class model {
  ...
  initial(t) {
    ...
    state[2] = internal.initial_I2R;
    state[3] = internal.initial_Rp;
    state[4] = internal.initial_IRp;
    state[5] = internal.initial_I2Rp;
    state[6] = internal.initial_Ren;
    state[7] = internal.initial_IRen;
    state[8] = internal.initial_I2Ren;
    state[9] = internal.initial_RPen;
    state[10] = internal.initial_IRPen;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["bw", "I2R_init", "I2Ren_init", "I2Rp_init", "intk1", "intk2", "IR_init", "IRen_init", "IRp_init", "IRPen_init", "k1ub", "k2ub", "kins", "kins1d", "kins1den", "kins2d", "kins2den", "Kpan", "kyd", "kyden", "kyp", "pansec", "R_init", "reck1", "Ren_init", "rholiver", "Rp_init", "RPen_init", "Rtotal"], unusedUserAction);
    var internal = this.internal;
    ...
    internal.parameter_2 = internal.Kkidney * internal.ins / internal.vp;
    internal.vd = 0.27200000000000002 * Math.pow((10), (- 3)) * internal.vhep * internal.rholiver;
    internal.parameter_7 = internal.parameter_2 * internal.vp * 6000 / internal.ins;
    this.updateMetadata();
  }
  getInternal() {
  ...
  rhs(t, state, dstatedt) {
    ...
    var r1 = internal.kins * R * internal.ins - internal.kins1d * IR;
    var r2 = internal.kins * Rp * internal.ins - internal.kins1d * IRp;
    var r3 = internal.kins * IR * internal.ins - internal.kins2d * I2R;
    var r4 = internal.kins * IRp * internal.ins - internal.kins2d * I2Rp;
    var r5 = internal.kyd * Rp;
    var r6 = internal.kyp * IR - internal.kyd * IRp;
    var r7 = internal.kyp * I2R - internal.kyd * I2Rp;
    dstatedt[2] = r3 - r7 - f3;
    dstatedt[8] = - i3 - internal.i7xi7 + f3;
    dstatedt[5] = r4 + r7 - f6;
    dstatedt[1] = r1 - r3 - r6 - f2;
    dstatedt[7] = - i1 + i3 - internal.i6xi6 + f2;
    dstatedt[4] = r2 - r4 + r6 - f5;
    dstatedt[0] = - r1 + r5 - f1;
    dstatedt[6] = i1 + internal.i5xi5 + f1;
    dstatedt[3] = - r2 - r5 - f4;
    dstatedt[9] = i2 - internal.i5xi5 + f4;
    var i4 = internal.kins2den * I2RPen;
    dstatedt[10] = - i2 + i4 + internal.i6xi6 + f5;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "R", "IR", "I2R", "Rp", "IRp", "I2Rp", "Ren", "IRen", "I2Ren", "RPen", "IRPen"];
    this.metadata.internalOrder = {bw: null, compartment1: null, I2R_init: null, I2Ren_init: null, I2Rp_init: null, i5xi5: null, i6xi6: null, i7xi7: null, initial_I2R: null, initial_I2Ren: null, initial_I2Rp: null, initial_IR: null, initial_IRen: null, initial_IRp: null, initial_IRPen: null, initial_R: null, initial_Ren: null, initial_Rp: null, initial_RPen: null, ins: null, intk1: null, intk2: null, IR_init: null, IRen_init: null, IRp_init: null, IRPen_init: null, k1ub: null, k2ub: null, kins: null, kins1d: null, kins1den: null, kins2d: null, kins2den: null, Kkidney: null, Kpan: null, kyd: null, kyden: null, kyp: null, mkidney: null, mliver: null, pansec: null, parameter_2: null, parameter_7: null, R_init: null, reck1: null, Ren_init: null, rholiver: null, Rp_init: null, RPen_init: null, Rtotal: null, vd: null, vhep: null, vp: null};
    this.metadata.variableOrder = {R: null, IR: null, I2R: null, Rp: null, IRp: null, I2Rp: null, Ren: null, IRen: null, I2Ren: null, RPen: null, IRPen: null};
