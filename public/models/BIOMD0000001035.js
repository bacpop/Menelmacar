export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "free_virus_init", internal, 0.01, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "immune_cells_init", internal, 0.01, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "uninfected_cancer_cells_init", internal, 0.5, -Infinity, Infinity, false);
