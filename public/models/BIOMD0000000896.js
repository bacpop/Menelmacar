export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "HSE_init", internal, 18.984000000000002, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "HSF_3_HSE_init", internal, 1.01603, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "HSF_3_init", internal, 0.0535203, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "HSF_init", internal, 0.33201900000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Hsp70_HSF_init", internal, 76.459299999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Hsp70_init", internal, 2.7354599999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Hsp70_S_init", internal, 1.7478200000000001e-14, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "mRNA_init", internal, 1.01603, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "S_init", internal, 3.09e-17, -Infinity, Infinity, false);
