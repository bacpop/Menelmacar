export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0 - 1 * internal.aada * Math.pow((ATP), (internal.fada4)) - 1 * internal.aadrnr * Math.pow((ATP), (internal.fadrnr4)) * Math.pow((dATP), (internal.fadrnr9)) * Math.pow((dGTP), (internal.fadrnr10)) - 1 * internal.aampd * Math.pow((ATP), (internal.fampd4)) * Math.pow((GTP), (internal.fampd8)) * Math.pow((internal.Pi), (internal.fampd18)) + 1 * internal.aaprt * Math.pow((PRPP), (internal.faprt1)) * Math.pow((ATP), (internal.faprt4)) * Math.pow((Ade), (internal.faprt6)) - 1 * internal.aarna * Math.pow((ATP), (internal.frnap4)) * Math.pow((GTP), (internal.frnap8)) + 1 * internal.aasli * Math.pow((SAMP), (internal.fasli3)) * Math.pow((ATP), (internal.fasli4)) - 1 * internal.amat * Math.pow((ATP), (internal.fmat4)) * Math.pow((SAM), (internal.fmat5)) + 1 * internal.arnaa * Math.pow((RNA), (internal.frnan11)) + 1 * internal.atrans * Math.pow((SAM), (internal.ftrans5));
    ...
    dstatedt[7] = 0 - 1 * internal.agdrnr * Math.pow((GTP), (internal.fgdrnr8)) * Math.pow((dATP), (internal.fgdrnr9)) * Math.pow((dGTP), (internal.fgdrnr10)) - 1 * internal.agmpr * Math.pow((IMP), (internal.fgmpr2)) * Math.pow((ATP), (internal.fgmpr4)) * Math.pow((XMP), (internal.fgmpr7)) * Math.pow((GTP), (internal.fgmpr8)) + 1 * internal.agmps * Math.pow((ATP), (internal.fgmps4)) * Math.pow((XMP), (internal.fgmps7)) - 1 * internal.agnuc * Math.pow((GTP), (internal.fgnuc8)) * Math.pow((internal.Pi), (internal.fgnuc18)) + 1 * internal.agprt * Math.pow((PRPP), (internal.fgprt1)) * Math.pow((GTP), (internal.fgprt8)) * Math.pow((Gua), (internal.fgprt15)) - 1 * internal.agrna * Math.pow((ATP), (internal.frnap4)) * Math.pow((GTP), (internal.frnap8)) + 1 * internal.arnag * Math.pow((RNA), (internal.frnan11));
    dstatedt[14] = 0 + 1 * internal.adgnuc * Math.pow((dGTP), (internal.fdgnuc10)) + 1 * internal.agnuc * Math.pow((GTP), (internal.fgnuc8)) * Math.pow((internal.Pi), (internal.fgnuc18)) - 1 * internal.agprt * Math.pow((PRPP), (internal.fgprt1)) * Math.pow((GTP), (internal.fgprt8)) * Math.pow((Gua), (internal.fgprt15)) - 1 * internal.agua * Math.pow((Gua), (internal.fgua15));
    dstatedt[12] = 0 + 1 * internal.aada * Math.pow((ATP), (internal.fada4)) + 1 * internal.adada * Math.pow((dATP), (internal.fdada9)) - 1 * internal.ahprt * Math.pow((PRPP), (internal.fhprt1)) * Math.pow((IMP), (internal.fhprt2)) * Math.pow((HX), (internal.fhprt13)) - 1 * internal.ahx * Math.pow((HX), (internal.fhx13)) - 1 * internal.ahxd * Math.pow((HX), (internal.fhxd13)) + 1 * internal.ainuc * Math.pow((IMP), (internal.finuc2)) * Math.pow((internal.Pi), (internal.finuc18));
    dstatedt[1] = 0 + 1 * internal.aampd * Math.pow((ATP), (internal.fampd4)) * Math.pow((GTP), (internal.fampd8)) * Math.pow((internal.Pi), (internal.fampd18)) - 1 * internal.aasuc * Math.pow((IMP), (internal.fasuc2)) * Math.pow((ATP), (internal.fasuc4)) * Math.pow((GTP), (internal.fasuc8)) * Math.pow((internal.Pi), (internal.fasuc18)) + 1 * internal.aden * Math.pow((PRPP), (internal.fden1)) * Math.pow((IMP), (internal.fden2)) * Math.pow((ATP), (internal.fden4)) * Math.pow((GTP), (internal.fden8)) * Math.pow((internal.Pi), (internal.fden18)) + 1 * internal.agmpr * Math.pow((IMP), (internal.fgmpr2)) * Math.pow((ATP), (internal.fgmpr4)) * Math.pow((XMP), (internal.fgmpr7)) * Math.pow((GTP), (internal.fgmpr8)) + 1 * internal.ahprt * Math.pow((PRPP), (internal.fhprt1)) * Math.pow((IMP), (internal.fhprt2)) * Math.pow((HX), (internal.fhprt13)) - 1 * internal.aimpd * Math.pow((IMP), (internal.fimpd2)) * Math.pow((XMP), (internal.fimpd7)) * Math.pow((GTP), (internal.fimpd8)) - 1 * internal.ainuc * Math.pow((IMP), (internal.finuc2)) * Math.pow((internal.Pi), (internal.finuc18));
    dstatedt[0] = 0 - 1 * internal.aaprt * Math.pow((PRPP), (internal.faprt1)) * Math.pow((ATP), (internal.faprt4)) * Math.pow((Ade), (internal.faprt6)) - 1 * internal.aden * Math.pow((PRPP), (internal.fden1)) * Math.pow((IMP), (internal.fden2)) * Math.pow((ATP), (internal.fden4)) * Math.pow((GTP), (internal.fden8)) * Math.pow((internal.Pi), (internal.fden18)) - 1 * internal.agprt * Math.pow((PRPP), (internal.fgprt1)) * Math.pow((GTP), (internal.fgprt8)) * Math.pow((Gua), (internal.fgprt15)) - 1 * internal.ahprt * Math.pow((PRPP), (internal.fhprt1)) * Math.pow((IMP), (internal.fhprt2)) * Math.pow((HX), (internal.fhprt13)) + 1 * internal.aprpps * Math.pow((PRPP), (internal.fprpps1)) * Math.pow((ATP), (internal.fprpps4)) * Math.pow((GTP), (internal.fprpps8)) * Math.pow((internal.R5P), (internal.fprpps17)) * Math.pow((internal.Pi), (internal.fprpps18)) - 1 * internal.apyr * Math.pow((PRPP), (internal.fpyr1));
    ...
    dstatedt[2] = 0 + 1 * internal.aasuc * Math.pow((IMP), (internal.fasuc2)) * Math.pow((ATP), (internal.fasuc4)) * Math.pow((GTP), (internal.fasuc8)) * Math.pow((internal.Pi), (internal.fasuc18)) - 1 * internal.aasli * Math.pow((SAMP), (internal.fasli3)) * Math.pow((ATP), (internal.fasli4));
