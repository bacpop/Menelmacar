export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[1] = - internal.parameter_5 * species_2 + 1 / (1 + Math.pow((species_1), (2))) * (internal.parameter_1 + internal.parameter_2 * (Math.pow((species_2), (2)) / (1 + Math.pow((species_2), (2)))));
  }
  names() {
