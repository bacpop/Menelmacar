export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["parameter_1", "parameter_2", "parameter_3", "parameter_4", "parameter_5", "species_1_init", "species_2_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "parameter_4", internal, 3.5, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[1] = 0 + - internal.parameter_5 * species_2 + 1 / (1 + Math.pow((species_1), (2))) * (internal.parameter_1 + internal.parameter_2 * (Math.pow((species_2), (2)) / (1 + Math.pow((species_2), (2)))));
  }
  names() {
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {compartment_1: null, initial_species_1: null, initial_species_2: null, parameter_1: null, parameter_2: null, parameter_3: null, parameter_4: null, parameter_5: null, species_1_init: null, species_2_init: null};
