export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.Keq = 0.29999999999999999;
    internal.Kf6p = 0.28999999999999998;
    internal.Kg1p = 0.023;
    internal.Kg6p = 1.3999999999999999;
    internal.Kglc = 1.1918;
    internal.Ki = 0.91000000000000003;
    internal.Kit6p = 0.040000000000000001;
    internal.Kiudg = 0.0035000000000000001;
    internal.Kiutp = 0.11;
    internal.Kt6p = 0.5;
    internal.Ktrh = 2.9900000000000002;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["adp_init", "atp_init", "f6p_init", "g1p_0", "g6p_0", "glc_0", "glx_init", "h_init", "h2o_init", "heat", "pho_init", "ppi_init", "t6p_0", "trh_0", "udg_0", "udp_init", "utp_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "glx_init", internal, 0, -Infinity, Infinity, false);
