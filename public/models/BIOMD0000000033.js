export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.cell = 1;
    internal.PP2AActive = 120000;
    internal.Raf1PPtase = 120000;
    internal.RapGapActive = 120000;
    internal.RasGapActive = 120000;
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "BRafInactive_init", internal, 120000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C3GActive_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C3GInactive_init", internal, 120000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "EGF_init", internal, 10002000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "ErkActive_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "ErkInactive_init", internal, 600000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "freeEGFReceptor_init", internal, 80000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "freeNGFReceptor_init", internal, 10000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "MekInactive_init", internal, 600000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NGF_init", internal, 456000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PI3KInactive_init", internal, 120000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Raf1Active_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Raf1Inactive_init", internal, 120000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Rap1Active_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Rap1Inactive_init", internal, 120000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "RasActive_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "RasInactive_init", internal, 120000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "SosActive_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "SosInactive_init", internal, 120000, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const Raf1Inactive = state[12];
    const Raf1Active = state[13];
    const BRafInactive = state[14];
    const BRafActive = state[15];
    const MekInactive = state[16];
    const MekActive = state[17];
    const ErkInactive = state[18];
    const ErkActive = state[19];
    const PI3KInactive = state[20];
    const PI3KActive = state[21];
    const AktInactive = state[22];
    const AktActive = state[23];
    const C3GInactive = state[24];
    const C3GActive = state[25];
    const Rap1Inactive = state[26];
    const Rap1Active = state[27];
    dstatedt[23] = 0 + 1 * internal.cell * (internal.kAkt * PI3KActive * AktInactive / (AktInactive + internal.KmAkt));
    dstatedt[22] = 0 - 1 * internal.cell * (internal.kAkt * PI3KActive * AktInactive / (AktInactive + internal.KmAkt));
    ...
    dstatedt[15] = 0 + 1 * internal.cell * (internal.kRap1ToBRaf * Rap1Active * BRafInactive / (BRafInactive + internal.KmRap1ToBRaf)) - 1 * internal.cell * (internal.kdBRaf * internal.Raf1PPtase * BRafActive / (BRafActive + internal.KmdBRaf));
    dstatedt[14] = 0 - 1 * internal.cell * (internal.kRap1ToBRaf * Rap1Active * BRafInactive / (BRafInactive + internal.KmRap1ToBRaf)) + 1 * internal.cell * (internal.kdBRaf * internal.Raf1PPtase * BRafActive / (BRafActive + internal.KmdBRaf));
    dstatedt[25] = 0 + 1 * internal.cell * (internal.kC3GNGF * boundNGFReceptor * C3GInactive / (C3GInactive + internal.KmC3GNGF));
    dstatedt[24] = 0 - 1 * internal.cell * (internal.kC3GNGF * boundNGFReceptor * C3GInactive / (C3GInactive + internal.KmC3GNGF));
    dstatedt[0] = 0 - 1 * internal.cell * internal.krbEGF * EGF * freeEGFReceptor + 1 * internal.cell * internal.kruEGF * boundEGFReceptor;
    dstatedt[19] = 0 + 1 * internal.cell * (internal.kpMekCytoplasmic * MekActive * ErkInactive / (ErkInactive + internal.KmpMekCytoplasmic)) - 1 * internal.cell * (internal.kdErk * internal.PP2AActive * ErkActive / (ErkActive + internal.KmdErk));
    dstatedt[18] = 0 - 1 * internal.cell * (internal.kpMekCytoplasmic * MekActive * ErkInactive / (ErkInactive + internal.KmpMekCytoplasmic)) + 1 * internal.cell * (internal.kdErk * internal.PP2AActive * ErkActive / (ErkActive + internal.KmdErk));
    ...
    dstatedt[17] = 0 + 1 * internal.cell * (internal.kpRaf1 * Raf1Active * MekInactive / (MekInactive + internal.KmpRaf1)) + 1 * internal.cell * (internal.kpBRaf * BRafActive * MekInactive / (MekInactive + internal.KmpBRaf)) - 1 * internal.cell * (internal.kdMek * internal.PP2AActive * MekActive / (MekActive + internal.KmdMek));
    dstatedt[16] = 0 - 1 * internal.cell * (internal.kpRaf1 * Raf1Active * MekInactive / (MekInactive + internal.KmpRaf1)) - 1 * internal.cell * (internal.kpBRaf * BRafActive * MekInactive / (MekInactive + internal.KmpBRaf)) + 1 * internal.cell * (internal.kdMek * internal.PP2AActive * MekActive / (MekActive + internal.KmdMek));
    ...
    dstatedt[20] = 0 - 1 * internal.cell * (internal.kPI3K * boundEGFReceptor * PI3KInactive / (PI3KInactive + internal.KmPI3K)) - 1 * internal.cell * (internal.kPI3KRas * RasActive * PI3KInactive / (PI3KInactive + internal.KmPI3KRas));
    dstatedt[13] = 0 + 1 * internal.cell * (internal.kRasToRaf1 * RasActive * Raf1Inactive / (Raf1Inactive + internal.KmRasToRaf1)) - 1 * internal.cell * (internal.kdRaf1 * internal.Raf1PPtase * Raf1Active / (Raf1Active + internal.KmdRaf1)) - 1 * internal.cell * (internal.kdRaf1ByAkt * AktActive * Raf1Active / (Raf1Active + internal.KmRaf1ByAkt));
    dstatedt[12] = 0 - 1 * internal.cell * (internal.kRasToRaf1 * RasActive * Raf1Inactive / (Raf1Inactive + internal.KmRasToRaf1)) + 1 * internal.cell * (internal.kdRaf1 * internal.Raf1PPtase * Raf1Active / (Raf1Active + internal.KmdRaf1)) + 1 * internal.cell * (internal.kdRaf1ByAkt * AktActive * Raf1Active / (Raf1Active + internal.KmRaf1ByAkt));
    dstatedt[27] = 0 + 1 * internal.cell * (internal.kC3G * C3GActive * Rap1Inactive / (Rap1Inactive + internal.KmC3G)) - 1 * internal.cell * (internal.kRapGap * internal.RapGapActive * Rap1Active / (Rap1Active + internal.KmRapGap));
    dstatedt[26] = 0 - 1 * internal.cell * (internal.kC3G * C3GActive * Rap1Inactive / (Rap1Inactive + internal.KmC3G)) + 1 * internal.cell * (internal.kRapGap * internal.RapGapActive * Rap1Active / (Rap1Active + internal.KmRapGap));
    dstatedt[11] = 0 + 1 * internal.cell * (internal.kSos * SosActive * RasInactive / (RasInactive + internal.KmSos)) - 1 * internal.cell * (internal.kRasGap * internal.RasGapActive * RasActive / (RasActive + internal.KmRasGap));
    dstatedt[10] = 0 - 1 * internal.cell * (internal.kSos * SosActive * RasInactive / (RasInactive + internal.KmSos)) + 1 * internal.cell * (internal.kRasGap * internal.RasGapActive * RasActive / (RasActive + internal.KmRasGap));
