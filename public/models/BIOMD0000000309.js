export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Et", "J3", "J4", "k0", "k2", "k3", "k4", "R_init", "S_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 + 0;
    dstatedt[1] = 0;
    dstatedt[0] = 0 + 1 * internal.env * internal.k0 * E - 1 * internal.env * internal.k2 * R * S;
  }
  names() {
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {env: null, Et: null, initial_E: null, initial_Ep: null, initial_R: null, initial_S: null, J3: null, J4: null, k0: null, k2: null, k3: null, k4: null, Km3: null, Km4: null, R_init: null, S_init: null};
