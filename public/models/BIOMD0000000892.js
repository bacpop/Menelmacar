export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "VI_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "VNI_init", internal, 0, -Infinity, Infinity, false);
