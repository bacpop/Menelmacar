export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.comp * internal.Vgk * Math.pow((GLC / internal.Sgk), (internal.hGK)) / (1 + Math.pow((GLC / internal.Sgk), (internal.hGK))) - 1 * internal.comp * internal.Vpfk * Math.pow((F6P / internal.Spfk), (internal.hpfk - (internal.hpfk - internal.hact) * (FBP / internal.Sfba / (1 + FBP / internal.Sfba)))) / (Math.pow((F6P / internal.Spfk), (internal.hpfk - (internal.hpfk - internal.hact) * (FBP / internal.Sfba / (1 + FBP / internal.Sfba)))) + (1 + Math.pow((FBP / internal.Xpfk), (internal.hx))) / (1 + Math.pow((internal.alpha), (internal.hpfk - (internal.hpfk - internal.hact) * (FBP / internal.Sfba / (1 + FBP / internal.Sfba)))) * Math.pow((FBP / internal.Xpfk), (internal.hx))));
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "G6P_F6P", "FBP", "GLC", "G3P"];
    this.metadata.internalOrder = {alpha: null, comp: null, dw_per_ml: null, FBP_init: null, G3P_init: null, G6P_F6P_init: null, GLC_init: null, hact: null, hGK: null, hpfk: null, hx: null, initial_FBP: null, initial_G3P: null, initial_G6P_F6P: null, initial_GLC: null, KeqGPI: null, min_to_sec: null, Sfba: null, Sgk: null, sigcorr: null, Spfk: null, Vfba: null, Vfba_min: null, Vgk: null, Vgk_min: null, Vpfk: null, Vpfk_min: null, Xpfk: null};
    this.metadata.variableOrder = {G6P_F6P: null, FBP: null, GLC: null, G3P: null};
