export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["damaged_cancer_cells_init", "f", "free_virus_init", "h", "infected_cancer_cells_init", "m", "uninfected_cancer_cells_init"], unusedUserAction);
    var internal = this.internal;
