export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A", "k1", "K1", "k10", "K10", "k11b", "k11f", "K12", "k15", "k2", "K2", "k21", "K21", "K21i", "k22", "K22", "K22i", "k3", "K3", "k4", "K4", "k5", "K5", "k6", "K6", "k7", "K7", "k8", "K8", "k9", "K9", "Ka", "KI", "n12", "species_0_init", "species_1_init", "species_10_init", "species_11_init", "species_12_init", "species_13_init", "species_14_init", "species_15_init", "species_16_init", "species_17_init", "species_18_init", "species_2_init", "species_3_init", "species_4_init", "species_5_init", "species_6_init", "species_7_init", "species_8_init", "species_9_init", "V1", "V12"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "A", internal, 10, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "k1", internal, 0.00025000000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "K10", internal, 200, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "k2", internal, 15.4, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "K5", internal, 200, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "k6", internal, 0.10000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "K6", internal, 200, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "K9", internal, 200, -Infinity, Infinity, false);
