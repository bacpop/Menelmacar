export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Fructose_1_6_Bisphosphatase_init", internal, 100, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Fructose_1_6_Bisphosphate_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Fructose_6_Phosphate_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Glucose_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Glycosylated_Phosphofructokinase_init", internal, 0.01, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Metabolic_outcome_of_Glycolytic_Flux_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Metabolic_outcome_of_Pentose_Phosphate_Shunt_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Metabolic_outcome_of_Serine_Biosynthesis_Flux_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Oxaloacetate_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "p_3_Phosphoglycerate_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Phosphoenolpyruvate_Carboxykinase_1_init", internal, 100, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Phosphoenolpyruvate_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Phosphofructokinase_1_init", internal, 99.989999999998503, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Pyruvate_init", internal, 0.01, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Pyruvate_Kinase_M2_dimers_init", internal, 99.989999999998503, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Pyruvate_Kinase_M2_tetramers_init", internal, 0.999999999999996, -Infinity, Infinity, false);
