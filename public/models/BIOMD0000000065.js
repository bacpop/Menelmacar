export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.cell = 1;
    internal.L_e = 0.080000000000000002;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "alpha_A", "alpha_B", "alpha_L", "alpha_M", "alpha_P", "B_init", "beta_A", "beta_L1", "gamma_0", "gamma_A", "gamma_B", "gamma_L", "gamma_M", "gamma_P", "I1_init", "I2_init", "I3_init", "K", "K_1", "K_A", "K_L", "K_L1", "K_Le", "L_init", "M_init", "mu", "P_init", "tau_B", "tau_M", "tau_P"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0 - 1 * internal.cell * internal.alpha_A * B * (L / (internal.K_L + L)) - 1 * internal.cell * L * (internal.gamma_L + internal.mu) - 1 * internal.cell * internal.beta_L1 * P * (L / (internal.K_L1 + L)) + 1 * internal.cell * internal.alpha_L * P * (internal.L_e / (internal.K_Le + internal.L_e));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "M", "B", "A", "L", "P", "I1", "I2", "I3"];
    this.metadata.internalOrder = {A_init: null, alpha_A: null, alpha_B: null, alpha_L: null, alpha_M: null, alpha_P: null, B_init: null, beta_A: null, beta_L1: null, cell: null, gamma_0: null, gamma_A: null, gamma_B: null, gamma_L: null, gamma_M: null, gamma_P: null, I1_init: null, I2_init: null, I3_init: null, initial_A: null, initial_B: null, initial_I1: null, initial_I2: null, initial_I3: null, initial_L: null, initial_M: null, initial_P: null, K: null, K_1: null, K_A: null, K_L: null, K_L1: null, K_Le: null, L_e: null, L_init: null, M_init: null, mu: null, P_init: null, tau_B: null, tau_M: null, tau_P: null};
    this.metadata.variableOrder = {M: null, B: null, A: null, L: null, P: null, I1: null, I2: null, I3: null};
