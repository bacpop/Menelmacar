export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    const A = state[5];
    dstatedt[0] = 0;
    dstatedt[5] = 0 + 1 * internal.cell * internal.k3 * X - 1 * internal.cell * internal.kdegA * A;
    dstatedt[2] = 0 + 1 * internal.cell * (internal.kon * L * R - internal.koff * C) - 1 * internal.cell * internal.kdegC * C - 1 * internal.cell * (internal.k1 * C * I - internal.k2 * X) + 1 * internal.cell * internal.k3 * X;
    dstatedt[3] = 0 - 1 * internal.cell * (internal.k1 * C * I - internal.k2 * X) + 1 * internal.cell * (internal.BI + internal.TFs * A / (internal.KD + A)) - 1 * internal.cell * internal.kdegI * I;
    dstatedt[1] = 0 + 1 * internal.cell * (internal.BR + internal.Rs * A / (internal.KD + A)) - 1 * internal.cell * internal.kdegR * R - 1 * internal.cell * (internal.kon * L * R - internal.koff * C);
    dstatedt[4] = 0 + 1 * internal.cell * (internal.k1 * C * I - internal.k2 * X) - 1 * internal.cell * internal.k3 * X - 1 * internal.cell * internal.kdegX * X;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "L", "R", "C", "I", "X", "A"];
    ...
    this.metadata.variableOrder = {L: null, R: null, C: null, I: null, X: null, A: null};
