export class model {
  ...
  initial(t) {
    ...
    state[9] = internal.initial_aca;
    state[10] = internal.initial_oaa;
    state[11] = internal.initial_coa;
    state[12] = internal.initial_biosyn;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["aca_init", "akg_init", "biosyn_init", "cit_init", "coa_init", "fa_init", "gly_init", "icit_init", "Kaca_cs", "Kaca_ms", "Kakg_icd1", "Kakg_icd2", "Kakg_kdh", "Kakg_kgd", "Kcit_acn", "Kcit_cs", "Kcoa_cs", "Kcoa_ms", "Kfa_fum", "Kfa_sdh", "Kgly_icl1", "Kgly_icl2", "Kgly_ms", "Kicit_acn", "Kicit_icd1", "Kicit_icd2", "Kicit_icl1", "Kicit_icl2", "Kmal_fum", "Kmal_mdh", "Kmal_ms", "Koaa_cs", "Koaa_mdh", "Ksca_kdh", "Ksca_scas", "Kssa_kgd", "Kssa_ssadh", "Ksuc_icl1", "Ksuc_icl2", "Ksuc_scas", "Ksuc_sdh", "Ksuc_ssadh", "mal_init", "oaa_init", "sca_init", "ssa_init", "suc_init", "Vf_acn", "Vf_cs", "Vf_fum", "Vf_icd1", "Vf_icd2", "Vf_icl1", "Vf_icl2", "Vf_kdh", "Vf_kgd", "Vf_mdh", "Vf_ms", "Vf_scas", "Vf_sdh", "Vf_ssadh", "Vr_acn", "Vr_cs", "Vr_fum", "Vr_icd1", "Vr_icd2", "Vr_icl1", "Vr_icl2", "Vr_kdh", "Vr_kgd", "Vr_mdh", "Vr_ms", "Vr_scas", "Vr_sdh", "Vr_ssadh"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "oaa_init", internal, 0.00029999999999999997, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "cit", "icit", "akg", "ssa", "suc", "sca", "fa", "mal", "gly", "aca", "oaa", "coa", "biosyn"];
    ...
    this.metadata.variableOrder = {cit: null, icit: null, akg: null, ssa: null, suc: null, sca: null, fa: null, mal: null, gly: null, aca: null, oaa: null, coa: null, biosyn: null};
