export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "kv17f_1", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "kv20f_1", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[21] = 0 + 1 * internal.intra * (internal.kv22_1 * - Turgor / (internal.kv22_3 + - Turgor) * 1.5 * (1 - Hog1PP * 1.2946200000000001 / (Hog1PP * 1.2946200000000001 + internal.kv22_2)) - internal.kv22_1 * Fps1r);
