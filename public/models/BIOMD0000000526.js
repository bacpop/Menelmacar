export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Bid_init", "CD95_init", "CD95L_init", "DISC_init", "DISCp55_init", "FADD_init", "kBid", "kD216", "kD216trans_p43", "kD216trans_p55", "kD374", "kD374probe", "kD374trans_p43", "kD374trans_p55", "kDISC", "kdiss_p18", "KDL", "KDR", "koff_FADD", "kon_FADD", "mCherry_init", "mGFP_init", "p18_init", "p18inactive_init", "p30_init", "p43_init", "p55free_init", "PrER_init", "PrER_mGFP_init", "PrNES_init", "PrNES_mCherry_init", "tBid_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "kBid", internal, 0.00052134055139546999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD216", internal, 0.0063977593741674603, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD216trans_p43", internal, 5.29906975294056e-05, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD216trans_p55", internal, 0.000223246421372882, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD374", internal, 0.00064461264397514895, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD374probe", internal, 0.0015371000102553901, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD374trans_p43", internal, 0.00413530054938906, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kD374trans_p55", internal, 0.00054351863134248295, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kDISC", internal, 0.00036496587440554398, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kdiss_p18", internal, 0.064713651554491006, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "KDL", internal, 30.0060394758199, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "KDR", internal, 57.205001300849602, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "koff_FADD", internal, 0.00130854998177646, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "kon_FADD", internal, 0.0010887185868436299, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[7] = 0 + 1 * internal.kDISC * p55free * DISC * internal.cell - 1 * internal.kD216 * DISCp55 * internal.cell - 1 * internal.kD216trans_p55 * DISCp55 * (DISCp55 + p30) * internal.cell - 1 * internal.kD216trans_p43 * DISCp55 * p43 * internal.cell - 1 * internal.kD374 * DISCp55 * internal.cell - 1 * internal.kD374trans_p55 * DISCp55 * (DISCp55 + p30) * internal.cell - 1 * internal.kD374trans_p43 * DISCp55 * p43 * internal.cell;
    ...
    dstatedt[10] = 0 + 1 * internal.kD216 * p43 * internal.cell + 1 * internal.kD216trans_p55 * p43 * (DISCp55 + p30) * internal.cell + 1 * internal.kD216trans_p43 * p43 * p43 * internal.cell + 1 * internal.kD374 * p30 * internal.cell + 1 * internal.kD374trans_p55 * p30 * (DISCp55 + p30) * internal.cell + 1 * internal.kD374trans_p43 * p30 * p43 * internal.cell - 1 * internal.kdiss_p18 * p18 * internal.cell;
    dstatedt[11] = 0 + 1 * internal.kdiss_p18 * p18 * internal.cell;
    dstatedt[8] = 0 + 1 * internal.kD216 * DISCp55 * internal.cell + 1 * internal.kD216trans_p55 * DISCp55 * (DISCp55 + p30) * internal.cell + 1 * internal.kD216trans_p43 * DISCp55 * p43 * internal.cell - 1 * internal.kD374 * p30 * internal.cell - 1 * internal.kD374trans_p55 * p30 * (DISCp55 + p30) * internal.cell - 1 * internal.kD374trans_p43 * p30 * p43 * internal.cell;
    dstatedt[9] = 0 - 1 * internal.kD216 * p43 * internal.cell - 1 * internal.kD216trans_p55 * p43 * (DISCp55 + p30) * internal.cell - 1 * internal.kD216trans_p43 * p43 * p43 * internal.cell + 1 * internal.kD374 * DISCp55 * internal.cell + 1 * internal.kD374trans_p55 * DISCp55 * (DISCp55 + p30) * internal.cell + 1 * internal.kD374trans_p43 * DISCp55 * p43 * internal.cell;
    ...
    dstatedt[6] = 0 + 1 * internal.kon_FADD * CD95act * FADD * internal.cell - 1 * internal.koff_FADD * DISC * internal.cell - 1 * internal.kDISC * p55free * DISC * internal.cell + 1 * internal.kD216 * p43 * internal.cell + 1 * internal.kD216trans_p55 * p43 * (DISCp55 + p30) * internal.cell + 1 * internal.kD216trans_p43 * p43 * p43 * internal.cell + 1 * internal.kD374 * p30 * internal.cell + 1 * internal.kD374trans_p55 * p30 * (DISCp55 + p30) * internal.cell + 1 * internal.kD374trans_p43 * p30 * p43 * internal.cell;
