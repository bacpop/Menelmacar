export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "MAPKK_init", internal, 180, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "MKP_init", internal, 100, -Infinity, Infinity, false);
