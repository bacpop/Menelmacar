export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "anti_inflammatory__A_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "bacterial_infection__B_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "inflammation__I_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "pro_inflammatory__P_init", internal, 0, -Infinity, Infinity, false);
