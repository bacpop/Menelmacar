export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    const P = state[1];
    const C = state[2];
    dstatedt[2] = 0 + internal.gamma * F * P - internal.nu * C;
    dstatedt[0] = 0 + internal.m / (1 + P) - internal.gamma * F * P;
    dstatedt[1] = 0 + internal.sigma - P - internal.gamma * F * P + internal.nu * C;
  }
  names() {
