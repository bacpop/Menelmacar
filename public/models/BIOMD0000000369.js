export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["C", "E1_init", "E2_init", "E3_init", "E4_init", "k1", "k2", "k3", "k4", "mu1", "mu2", "mu3", "mu4", "mu5", "Z1_init", "Z2_init", "Z4_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    const E3 = state[5];
    const E4 = state[6];
    dstatedt[3] = (internal.mu1 * E2 + internal.mu5 * E4) * Z1 - internal.k1 * E1;
    dstatedt[4] = internal.mu2 * E1 * Z2 - internal.mu3 * E4 * E2 - internal.k2 * E2;
    dstatedt[5] = internal.mu2 * internal.C * E1 * Z2 + internal.mu3 * E4 * E2 - internal.k3 * E3;
    dstatedt[6] = internal.mu4 * E3 * Z4 - internal.k4 * E4;
    dstatedt[0] = - (internal.mu1 * E2 + internal.mu5 * E4) * Z1;
    dstatedt[1] = - internal.mu2 * (1 + internal.C) * E1 * Z2;
    dstatedt[2] = - internal.mu4 * E3 * Z4;
  }
  names() {
