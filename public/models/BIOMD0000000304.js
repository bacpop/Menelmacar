export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a", "b", "c_init", "f", "g_Ca", "g_I", "g_K", "g_K_Ca", "g_L", "g_T", "h1_init", "K_c", "K_p", "n1_init", "tau_x", "V_Ca", "V_I", "V_K", "V_L", "V_membrane_init", "x1_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "g_Ca", internal, 0.0040000000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "n1_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "V_membrane_init", internal, 0, -Infinity, Infinity, false);
