export class model {
  ...
  initial(t) {
    ...
    state[10] = internal.initial_EmptySet;
    state[11] = internal.initial_species_0000012;
    state[12] = internal.initial_species_0000013;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a", "A1", "A2", "A3", "B1", "B2", "B3", "c1", "c2", "c3", "CCc_init", "CCn_init", "Clkc_init", "Clkm_init", "D0", "D1", "D10", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "EmptySet_init", "k1", "k2", "k3", "k4", "L1", "L10", "L2", "L3", "L4", "L5", "L6", "L7", "L8", "L9", "parameter_0000072", "parameter_0000073", "Perc_init", "Perm_init", "PTc_init", "PTn_init", "r", "r1", "r2", "r3", "s1", "s2", "s3", "s4", "s5", "s6", "species_0000012_init", "species_0000013_init", "T1", "T2", "T3", "T4", "Timc_init", "Timm_init", "v1", "v3"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 - 1 * internal.compartment_0000003 * (Clkc * internal.v3 * species_0000012 - internal.parameter_0000073 * CCc) + 1 * internal.compartment_0000003 * Clkm * internal.s6 - 1 * internal.compartment_0000003 * Clkc * internal.D0 - 1 * internal.compartment_0000003 * (Clkc * internal.D8 / (Clkc + internal.L8));
    ...
    dstatedt[4] = 0 - 1 * internal.compartment_0000003 * (Perc * Timc * internal.v1 - internal.parameter_0000072 * PTc) + 1 * internal.compartment_0000003 * internal.s2 * Perm - 1 * internal.Drosophilia * internal.D0 * Perc - 1 * internal.compartment_0000003 * (internal.D2 * species_0000013 * Perc / (internal.L2 + Perc));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "CCc", "CCn", "Clkc", "Clkm", "Perc", "Perm", "PTc", "PTn", "Timc", "Timm", "EmptySet", "species_0000012", "species_0000013"];
    ...
    this.metadata.variableOrder = {CCc: null, CCn: null, Clkc: null, Clkm: null, Perc: null, Perm: null, PTc: null, PTn: null, Timc: null, Timm: null, EmptySet: null, species_0000012: null, species_0000013: null};
