export class model {
  ...
  initial(t) {
    ...
    state[4] = internal.initial_GP;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "alpha", "beta", "EC_init", "epsilon", "G", "gamma", "GP_init", "K", "K1", "K2", "K5", "Ka", "Ka1", "Ka2", "Ka5", "Ka6", "Kd", "Kf", "Kp2", "Ky", "Kz", "m", "n", "p", "v0", "v1", "V4", "Vm2", "Vm3", "Vm5", "Vpm1", "Vpm2", "Y_init", "Z_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "GP_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const GP = state[4];
    dstatedt[0] = 0;
    dstatedt[2] = 0 + 1 * internal.cytosol * internal.beta * internal.V4 - 1 * internal.cytosol * internal.Vm5 * Math.pow((A), (internal.p)) * Math.pow((Z), (internal.n)) / ((Math.pow((internal.K5), (internal.p)) + Math.pow((A), (internal.p))) * (Math.pow((internal.Kd), (internal.n)) + Math.pow((Z), (internal.n)))) - 1 * internal.cytosol * internal.epsilon * A;
    dstatedt[4] = 0 + 1 * internal.cytosol * (internal.Vpm1 * (1 + internal.gamma * Math.pow((Z), (4)) / (Math.pow((internal.Ka5), (4)) + Math.pow((Z), (4)))) * (1 - GP) / (internal.K1 / (1 + Math.pow((Z), (4)) / Math.pow((internal.Ka6), (4))) + 1 - GP)) - 1 * internal.cytosol * (internal.Vpm2 * (1 + internal.alpha * internal.G / (internal.Ka1 + internal.G)) * GP / (internal.Kp2 / (1 + internal.G / internal.Ka2) + GP));
    dstatedt[3] = 0 + 1 * internal.cytosol * (internal.Vm2 * Math.pow((Z), (2)) / (Math.pow((internal.K2), (2)) + Math.pow((Z), (2)))) - 1 * internal.intravesicular * internal.Vm3 * Math.pow((A), (4)) * Math.pow((Y), (2)) * Math.pow((Z), (internal.m)) / ((Math.pow((internal.Ka), (4)) + Math.pow((A), (4))) * (Math.pow((internal.Ky), (2)) + Math.pow((Y), (2))) * (Math.pow((internal.Kz), (internal.m)) + Math.pow((Z), (internal.m)))) - 1 * internal.intravesicular * internal.Kf * Y;
    dstatedt[1] = 0 + 1 * internal.extracellular * (internal.v0 + internal.v1 * internal.beta) - 1 * internal.cytosol * (internal.Vm2 * Math.pow((Z), (2)) / (Math.pow((internal.K2), (2)) + Math.pow((Z), (2)))) + 1 * internal.intravesicular * internal.Vm3 * Math.pow((A), (4)) * Math.pow((Y), (2)) * Math.pow((Z), (internal.m)) / ((Math.pow((internal.Ka), (4)) + Math.pow((A), (4))) * (Math.pow((internal.Ky), (2)) + Math.pow((Y), (2))) * (Math.pow((internal.Kz), (internal.m)) + Math.pow((Z), (internal.m)))) + 1 * internal.intravesicular * internal.Kf * Y - 1 * internal.cytosol * internal.K * Z;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "EC", "Z", "A", "Y", "GP"];
    this.metadata.internalOrder = {A_init: null, alpha: null, beta: null, cytosol: null, EC_init: null, epsilon: null, extracellular: null, G: null, gamma: null, GP_init: null, initial_A: null, initial_EC: null, initial_GP: null, initial_Y: null, initial_Z: null, intravesicular: null, K: null, K1: null, K2: null, K5: null, Ka: null, Ka1: null, Ka2: null, Ka5: null, Ka6: null, Kd: null, Kf: null, Kp2: null, Ky: null, Kz: null, m: null, n: null, p: null, v0: null, v1: null, V4: null, Vm2: null, Vm3: null, Vm5: null, Vpm1: null, Vpm2: null, Y_init: null, Z_init: null};
    this.metadata.variableOrder = {EC: null, Z: null, A: null, Y: null, GP: null};
