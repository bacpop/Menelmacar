export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "EC_init", internal, 1000, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Z", "A", "Y", "GP", "EC"];
    ...
    this.metadata.variableOrder = {Z: null, A: null, Y: null, GP: null, EC: null};
