export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "I_gamma_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "T_beta_init", internal, 0, -Infinity, Infinity, false);
