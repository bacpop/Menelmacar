export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var E_CTL_init = internal.ModelValue_11 - internal.initial_X_Complex;
    var T_Cancer_Cell_Total_init = internal.initial_C_Cancer_Uncomplexed + internal.initial_X_Complex;
    internal.initial_E_CTL = E_CTL_init;
    internal.initial_T_Cancer_Cell_Total = T_Cancer_Cell_Total_init;
    ...
    state[4] = internal.initial_E_CTL;
    state[5] = internal.initial_T_Cancer_Cell_Total;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "C_Cancer_Uncomplexed_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "P_Perforin_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "T_ast_init", internal, 0, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "X_Complex", "P_Perforin", "C_Cancer_Uncomplexed", "T_ast", "E_CTL", "T_Cancer_Cell_Total"];
    this.metadata.internalOrder = {C_Cancer_Uncomplexed_init: null, compartment: null, E_init1: null, initial_C_Cancer_Uncomplexed: null, initial_E_CTL: null, initial_P_Perforin: null, initial_T_ast: null, initial_T_Cancer_Cell_Total: null, initial_X_Complex: null, k_1: null, k_2: null, k_3: null, k_4: null, k_5: null, k_6: null, k_m: null, k_m_1: null, k_m_2: null, k_p: null, kxk: null, ModelValue_11: null, P_Perforin_init: null, T_ast_init: null, X_Complex_init: null};
    this.metadata.variableOrder = {X_Complex: null, P_Perforin: null, C_Cancer_Uncomplexed: null, T_ast: null, E_CTL: null, T_Cancer_Cell_Total: null};
