export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "species_0_init", internal, 9.5, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "species_5_init", internal, 1.7, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "species_6_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "species_7_init", internal, 2.5, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    var parameter_0000081 = (Math.ceil(Math.sin(internal.pi * t / 12 + 0.001) / 2));
    var parameter_0000082 = 1.5 + (1.8 - 1.5) * parameter_0000081;
    dstatedt[7] = 0 + 1 * internal.cell * (parameter_0000082 * Math.pow((species_3), (internal.n)) / (Math.pow((internal.K), (internal.n)) + Math.pow((species_3), (internal.n)))) - 1 * internal.cell * internal.k1 * species_7 - 1 * internal.cell * (internal.V * species_7 / (internal.Km + species_7));
  }
  names() {
