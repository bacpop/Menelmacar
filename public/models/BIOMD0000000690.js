export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "k1", internal, 0.0080000000000000002, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "v", internal, 2.35e-07, -Infinity, Infinity, false);
