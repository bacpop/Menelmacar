export class model {
  ...
  initial(t) {
    ...
    state[0] = internal.initial_cytoplasm_Foxo1_Pa0_pUb0;
    state[1] = internal.initial_nucleus_Foxo1_Pa0_pUb0;
    state[2] = internal.initial_dnabound_Foxo1_Pa0_pUb0;
    state[3] = internal.initial_cytoplasm_Foxo1_Pa0_pUb1;
    state[4] = internal.initial_nucleus_Foxo1_Pa0_pUb1;
    state[5] = internal.initial_dnabound_Foxo1_Pa0_pUb1;
    state[6] = internal.initial_cytoplasm_Foxo1_Pa1_pUb0;
    state[7] = internal.initial_nucleus_Foxo1_Pa1_pUb0;
    state[8] = internal.initial_dnabound_Foxo1_Pa1_pUb0;
    state[9] = internal.initial_cytoplasm_Foxo1_Pa1_pUb1;
    state[10] = internal.initial_nucleus_Foxo1_Pa1_pUb1;
    state[11] = internal.initial_dnabound_Foxo1_Pa1_pUb1;
    state[12] = internal.initial_nucleus_RNA_Inr;
    state[13] = internal.initial_cytoplasm_RNA_Inr;
    state[14] = internal.initial_cytoplasm_Inr;
    state[15] = internal.initial_nucleus_RNA_Sod2;
    state[16] = internal.initial_cytoplasm_RNA_Sod2;
    state[17] = internal.initial_cytoplasm_Sod2;
    state[18] = internal.initial_E2F1;
    state[19] = internal.initial_Akt;
    state[20] = internal.initial_SGK;
    state[21] = internal.initial_CDK2;
    state[22] = internal.initial_AMPK;
    state[23] = internal.initial_IKKb;
    state[24] = internal.initial_JNK;
    state[25] = internal.initial_PP2A;
    state[26] = internal.initial_CBPP300;
    state[27] = internal.initial_SIRT1;
    state[28] = internal.initial_E3;
    state[29] = internal.initial_USP7;
    state[30] = internal.initial_SCF;
    state[31] = internal.initial_Proteasome;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["Akt_init", "AMPK_init", "CBPP300_init", "CDK2_init", "cytoplasm_Foxo1_Pa0_pUb0_init", "cytoplasm_Foxo1_Pa0_pUb1_init", "cytoplasm_Foxo1_Pa1_pUb0_init", "cytoplasm_Foxo1_Pa1_pUb1_init", "cytoplasm_Inr_init", "cytoplasm_RNA_Inr_init", "cytoplasm_RNA_Sod2_init", "cytoplasm_Sod2_init", "dnabound_Foxo1_Pa0_pUb0_init", "dnabound_Foxo1_Pa0_pUb1_init", "dnabound_Foxo1_Pa1_pUb0_init", "dnabound_Foxo1_Pa1_pUb1_init", "E2F1_init", "E3_init", "IKKb_init", "JNK_init", "kdeg", "kdephos", "kexp", "kkin", "kmdeg", "kpdeg", "ksynth", "ktr1_181818", "ktr2_0181818", "ktr3_125", "ktr4_055", "ktr4_55", "ktr5_25", "ktranscr", "ktransl", "kub1", "kub2", "Metabolite_21", "nucleus_Foxo1_Pa0_pUb0_init", "nucleus_Foxo1_Pa0_pUb1_init", "nucleus_Foxo1_Pa1_pUb0_init", "nucleus_Foxo1_Pa1_pUb1_init", "nucleus_RNA_Inr_init", "nucleus_RNA_Sod2_init", "PP2A_init", "Proteasome_init", "SCF_init", "SGK_init", "SIRT1_init", "transcription_rate", "USP7_init"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Akt_init", internal, 1515151515151520, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "cytoplasm_Foxo1_Pa0_pUb0_init", internal, 60606060606060.602, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "E2F1_init", internal, 6060606060606.0596, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PP2A_init", internal, 606060606060606, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Proteasome_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "SCF_init", internal, 60606060606060.602, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "USP7_init", internal, 60606060606060.602, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    var internal = this.internal;
    const cytoplasm_Foxo1_Pa0_pUb0 = state[0];
    const nucleus_Foxo1_Pa0_pUb0 = state[1];
    const dnabound_Foxo1_Pa0_pUb0 = state[2];
    const cytoplasm_Foxo1_Pa0_pUb1 = state[3];
    const nucleus_Foxo1_Pa0_pUb1 = state[4];
    const dnabound_Foxo1_Pa0_pUb1 = state[5];
    const cytoplasm_Foxo1_Pa1_pUb0 = state[6];
    const nucleus_Foxo1_Pa1_pUb0 = state[7];
    const dnabound_Foxo1_Pa1_pUb0 = state[8];
    const cytoplasm_Foxo1_Pa1_pUb1 = state[9];
    const nucleus_Foxo1_Pa1_pUb1 = state[10];
    const dnabound_Foxo1_Pa1_pUb1 = state[11];
    const nucleus_RNA_Inr = state[12];
    const cytoplasm_RNA_Inr = state[13];
    const cytoplasm_Inr = state[14];
    const nucleus_RNA_Sod2 = state[15];
    const cytoplasm_RNA_Sod2 = state[16];
    const cytoplasm_Sod2 = state[17];
    const E2F1 = state[18];
    const Akt = state[19];
    const SGK = state[20];
    const PP2A = state[25];
    const SCF = state[30];
    const Proteasome = state[31];
    dstatedt[19] = 0;
    dstatedt[22] = 0;
    dstatedt[26] = 0;
    dstatedt[21] = 0;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "cytoplasm_Foxo1_Pa0_pUb0", "nucleus_Foxo1_Pa0_pUb0", "dnabound_Foxo1_Pa0_pUb0", "cytoplasm_Foxo1_Pa0_pUb1", "nucleus_Foxo1_Pa0_pUb1", "dnabound_Foxo1_Pa0_pUb1", "cytoplasm_Foxo1_Pa1_pUb0", "nucleus_Foxo1_Pa1_pUb0", "dnabound_Foxo1_Pa1_pUb0", "cytoplasm_Foxo1_Pa1_pUb1", "nucleus_Foxo1_Pa1_pUb1", "dnabound_Foxo1_Pa1_pUb1", "nucleus_RNA_Inr", "cytoplasm_RNA_Inr", "cytoplasm_Inr", "nucleus_RNA_Sod2", "cytoplasm_RNA_Sod2", "cytoplasm_Sod2", "E2F1", "Akt", "SGK", "CDK2", "AMPK", "IKKb", "JNK", "PP2A", "CBPP300", "SIRT1", "E3", "USP7", "SCF", "Proteasome"];
    this.metadata.internalOrder = {Akt_init: null, AMPK_init: null, CBPP300_init: null, CDK2_init: null, cellsurface: null, cytoplasm: null, cytoplasm_Foxo1_Pa0_pUb0_init: null, cytoplasm_Foxo1_Pa0_pUb1_init: null, cytoplasm_Foxo1_Pa1_pUb0_init: null, cytoplasm_Foxo1_Pa1_pUb1_init: null, cytoplasm_Inr_init: null, cytoplasm_RNA_Inr_init: null, cytoplasm_RNA_Sod2_init: null, cytoplasm_Sod2_init: null, degr_Foxo1: null, dnabound: null, dnabound_Foxo1_Pa0_pUb0_init: null, dnabound_Foxo1_Pa0_pUb1_init: null, dnabound_Foxo1_Pa1_pUb0_init: null, dnabound_Foxo1_Pa1_pUb1_init: null, E2F1_init: null, E3_init: null, extracellular: null, IKKb_init: null, initial_Akt: null, initial_AMPK: null, initial_CBPP300: null, initial_CDK2: null, initial_cytoplasm_Foxo1_Pa0_pUb0: null, initial_cytoplasm_Foxo1_Pa0_pUb1: null, initial_cytoplasm_Foxo1_Pa1_pUb0: null, initial_cytoplasm_Foxo1_Pa1_pUb1: null, initial_cytoplasm_Inr: null, initial_cytoplasm_RNA_Inr: null, initial_cytoplasm_RNA_Sod2: null, initial_cytoplasm_Sod2: null, initial_dnabound_Foxo1_Pa0_pUb0: null, initial_dnabound_Foxo1_Pa0_pUb1: null, initial_dnabound_Foxo1_Pa1_pUb0: null, initial_dnabound_Foxo1_Pa1_pUb1: null, initial_E2F1: null, initial_E3: null, initial_IKKb: null, initial_JNK: null, initial_nucleus_Foxo1_Pa0_pUb0: null, initial_nucleus_Foxo1_Pa0_pUb1: null, initial_nucleus_Foxo1_Pa1_pUb0: null, initial_nucleus_Foxo1_Pa1_pUb1: null, initial_nucleus_RNA_Inr: null, initial_nucleus_RNA_Sod2: null, initial_PP2A: null, initial_Proteasome: null, initial_SCF: null, initial_SGK: null, initial_SIRT1: null, initial_USP7: null, JNK_init: null, kdeg: null, kdephos: null, kexp: null, kkin: null, kmdeg: null, kpdeg: null, ksynth: null, ktr1_181818: null, ktr2_0181818: null, ktr3_125: null, ktr4_055: null, ktr4_55: null, ktr5_25: null, ktranscr: null, ktransl: null, kub1: null, kub2: null, Metabolite_21: null, nucleus: null, nucleus_Foxo1_Pa0_pUb0_init: null, nucleus_Foxo1_Pa0_pUb1_init: null, nucleus_Foxo1_Pa1_pUb0_init: null, nucleus_Foxo1_Pa1_pUb1_init: null, nucleus_RNA_Inr_init: null, nucleus_RNA_Sod2_init: null, null: null, PP2A_init: null, Proteasome_init: null, SCF_init: null, SGK_init: null, SIRT1_init: null, transcription_rate: null, USP7_init: null};
    this.metadata.variableOrder = {cytoplasm_Foxo1_Pa0_pUb0: null, nucleus_Foxo1_Pa0_pUb0: null, dnabound_Foxo1_Pa0_pUb0: null, cytoplasm_Foxo1_Pa0_pUb1: null, nucleus_Foxo1_Pa0_pUb1: null, dnabound_Foxo1_Pa0_pUb1: null, cytoplasm_Foxo1_Pa1_pUb0: null, nucleus_Foxo1_Pa1_pUb0: null, dnabound_Foxo1_Pa1_pUb0: null, cytoplasm_Foxo1_Pa1_pUb1: null, nucleus_Foxo1_Pa1_pUb1: null, dnabound_Foxo1_Pa1_pUb1: null, nucleus_RNA_Inr: null, cytoplasm_RNA_Inr: null, cytoplasm_Inr: null, nucleus_RNA_Sod2: null, cytoplasm_RNA_Sod2: null, cytoplasm_Sod2: null, E2F1: null, Akt: null, SGK: null, CDK2: null, AMPK: null, IKKb: null, JNK: null, PP2A: null, CBPP300: null, SIRT1: null, E3: null, USP7: null, SCF: null, Proteasome: null};
