export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Cdc25_active_init", internal, 9.9999999999999995e-07, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdc25_inactive_init", internal, 9.9999999999999995e-07, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdc25Ps216_14_3_3_inactive_init", internal, 0.029999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdc25Ps216_active_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cdc25Ps216_inactive_init", internal, 2.0000000000000002e-05, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Chk1_init", internal, 0.99999899999999997, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Chk1P_init", internal, 9.9999999999999995e-07, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "MPF_init", internal, 1e-08, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "preMPF_init", internal, 9.9999999999999995e-07, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "protein_14_3_3_init", internal, 2, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Rad3_ATM_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Wee1_init", internal, 0.001, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Cdc25_active", "Cdc25Ps216_active", "Cdc25_inactive", "Cdc25Ps216_inactive", "Chk1P", "protein_14_3_3", "Cdc25Ps216_14_3_3_inactive", "p53", "p21", "MPF", "p21_MPF", "preMPF", "Wee1", "Chk1", "Rad3_ATM", "Wee1_phosphorylated"];
    ...
    this.metadata.variableOrder = {Cdc25_active: null, Cdc25Ps216_active: null, Cdc25_inactive: null, Cdc25Ps216_inactive: null, Chk1P: null, protein_14_3_3: null, Cdc25Ps216_14_3_3_inactive: null, p53: null, p21: null, MPF: null, p21_MPF: null, preMPF: null, Wee1: null, Chk1: null, Rad3_ATM: null, Wee1_phosphorylated: null};
