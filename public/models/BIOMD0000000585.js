export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var RSNCex_init = (internal.initial_Stat1Un + internal.initial_Stat1Pdn) / (internal.initial_Stat1U + internal.initial_Stat1Pd);
    var Socs1ex_init = internal.initial_mRNA;
    var Stat1cex_init = (internal.initial_Stat1U + internal.initial_Stat1Pd) * internal.scale_Stat1cex;
    var Stat1ex_init = (internal.initial_Stat1U + internal.initial_Stat1Pd + internal.initial_Stat1Un + internal.initial_Stat1Pdn) / 2;
    var Stat1nex_init = (internal.initial_Stat1Un + internal.initial_Stat1Pdn) * internal.scale_Stat1nex;
    var Stat1Pcex_init = internal.initial_Stat1Pd * internal.scale_Stat1Pcex;
    var Stat1Pex_init = (internal.initial_Stat1Pd + internal.initial_Stat1Pdn) / 2 * internal.scale_Stat1Pex;
    var Stat1Pnex_init = internal.initial_Stat1Pdn * internal.scale_Stat1Pnex;
    internal.initial_RSNCex = RSNCex_init;
    internal.initial_Socs1ex = Socs1ex_init;
    internal.initial_Stat1cex = Stat1cex_init;
    internal.initial_Stat1ex = Stat1ex_init;
    internal.initial_Stat1nex = Stat1nex_init;
    internal.initial_Stat1Pcex = Stat1Pcex_init;
    internal.initial_Stat1Pex = Stat1Pex_init;
    internal.initial_Stat1Pnex = Stat1Pnex_init;
    ...
    state[20] = internal.initial_Stat1ex;
    state[21] = internal.initial_Stat1cex;
    state[22] = internal.initial_Stat1nex;
    state[23] = internal.initial_Stat1Pex;
    state[24] = internal.initial_Stat1Pcex;
    state[25] = internal.initial_Stat1Pnex;
    state[26] = internal.initial_Socs1ex;
    state[27] = internal.initial_RSNCex;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Ifng_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Stat1U_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Stat1Un_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[23] = 0 + 0;
    dstatedt[25] = 0 + 0;
    dstatedt[2] = 0 + 4 * (II - d1) / internal.taud;
    dstatedt[3] = 0 + 4 * (d1 - d2) / internal.taud;
    dstatedt[4] = 0 + 4 * (d2 - d3) / internal.taud;
    dstatedt[5] = 0 + 4 * (d3 - d4) / internal.taud;
    dstatedt[8] = 0 + 4 * (Stat1Pdn - i1) / internal.tau;
    dstatedt[9] = 0 + 4 * (i1 - i2) / internal.tau;
    dstatedt[10] = 0 + 4 * (i2 - i3) / internal.tau;
    dstatedt[11] = 0 + 4 * (i3 - i4) / internal.tau;
    dstatedt[0] = 0 + - (internal.k1 * Ifng * Ir);
    dstatedt[1] = 0 + internal.k1 * Ifng * Ir;
    dstatedt[16] = 0 + - (internal.k1 * Ifng * Ir);
    dstatedt[12] = 0 + 4 * (mRNA - j1) / internal.tauj;
    dstatedt[13] = 0 + 4 * (j1 - j2) / internal.tauj;
    dstatedt[14] = 0 + 4 * (j2 - j3) / internal.tauj;
    dstatedt[15] = 0 + 4 * (j3 - j4) / internal.tauj;
    dstatedt[19] = 0 + internal.k13 + internal.k9 * i4 - internal.k10 * mRNA;
    dstatedt[6] = 0 + internal.k4 * II * Stat1U / (1 + internal.k14 * j4) - internal.k6 * Stat1Pd;
    dstatedt[7] = 0 + internal.k6 * Stat1Pd - internal.k5 * Stat1Pdn;
    dstatedt[17] = 0 + internal.k3 * d4 + internal.k12 * Stat1Un - internal.k11 * Stat1U - internal.k4 * II * Stat1U / (1 + internal.k14 * j4);
    dstatedt[18] = 0 + internal.k11 * Stat1U - internal.k12 * Stat1Un + internal.k5 * Stat1Pdn;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Ifng", "II", "d1", "d2", "d3", "d4", "Stat1Pd", "Stat1Pdn", "i1", "i2", "i3", "i4", "j1", "j2", "j3", "j4", "Ir", "Stat1U", "Stat1Un", "mRNA", "Stat1ex", "Stat1cex", "Stat1nex", "Stat1Pex", "Stat1Pcex", "Stat1Pnex", "Socs1ex", "RSNCex"];
    this.metadata.internalOrder = {cell: null, d1_init: null, d2_init: null, d3_init: null, d4_init: null, i1_init: null, i2_init: null, i3_init: null, i4_init: null, Ifng_init: null, II_init: null, initial_d1: null, initial_d2: null, initial_d3: null, initial_d4: null, initial_i1: null, initial_i2: null, initial_i3: null, initial_i4: null, initial_Ifng: null, initial_II: null, initial_Ir: null, initial_j1: null, initial_j2: null, initial_j3: null, initial_j4: null, initial_mRNA: null, initial_RSNCex: null, initial_Socs1ex: null, initial_Stat1cex: null, initial_Stat1ex: null, initial_Stat1nex: null, initial_Stat1Pcex: null, initial_Stat1Pd: null, initial_Stat1Pdn: null, initial_Stat1Pex: null, initial_Stat1Pnex: null, initial_Stat1U: null, initial_Stat1Un: null, Ir_init: null, j1_init: null, j2_init: null, j3_init: null, j4_init: null, k1: null, k10: null, k11: null, k12: null, k13: null, k14: null, k3: null, k4: null, k5: null, k6: null, k9: null, mRNA_init: null, scale_RSNCex: null, scale_Socs1ex: null, scale_Stat1cex: null, scale_Stat1ex: null, scale_Stat1nex: null, scale_Stat1Pcex: null, scale_Stat1Pex: null, scale_Stat1Pnex: null, Stat1Pd_init: null, Stat1Pdn_init: null, Stat1U_init: null, Stat1Un_init: null, tau: null, taud: null, tauj: null};
    this.metadata.variableOrder = {Ifng: null, II: null, d1: null, d2: null, d3: null, d4: null, Stat1Pd: null, Stat1Pdn: null, i1: null, i2: null, i3: null, i4: null, j1: null, j2: null, j3: null, j4: null, Ir: null, Stat1U: null, Stat1Un: null, mRNA: null, Stat1ex: null, Stat1cex: null, Stat1nex: null, Stat1Pex: null, Stat1Pcex: null, Stat1Pnex: null, Socs1ex: null, RSNCex: null};
