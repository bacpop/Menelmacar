export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var c1_init = internal.L * internal.initial_sumrc1 / (internal.KDL + internal.L);
    var eGEF_init = (internal.KGR * internal.initial_c2 + internal.KGP * internal.initial_m3PI) / (1 + internal.KGR * internal.initial_c2 + internal.KGP * internal.initial_m3PI) * internal.initial_fGEF;
    var ePI3K_init = (1 + internal.kappaPI3K + 2 * internal.alphaPI3K * internal.initial_c2 - Math.pow((Math.pow((1 + internal.kappaPI3K + 2 * internal.alphaPI3K * internal.initial_c2), (2)) - 8 * internal.alphaPI3K * internal.initial_c2), (0.5))) / 2;
    var r_init = internal.KDL * internal.initial_sumrc1 / (internal.KDL + internal.L);
    var yp_init = 1 - internal.initial_y - internal.initial_ypp;
    var zp_init = 1 - internal.initial_z - internal.initial_zpp;
    internal.initial_c1 = c1_init;
    internal.initial_eGEF = eGEF_init;
    internal.initial_ePI3K = ePI3K_init;
    internal.initial_r = r_init;
    internal.initial_yp = yp_init;
    internal.initial_zp = zp_init;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["alphaPI3K", "c2_init", "eph_init", "fGEF_init", "Gamma", "k3PI", "kappaPI3K", "KDL", "kdw", "kdx1", "kdx2", "ke", "Kf", "kFBf", "kFBph", "KGP", "KGR", "kminusx", "KMx11", "KMx12", "KMx21", "KMx22", "KMy1", "KMy2", "KMyph1", "KMyph2", "KMzph1", "KMzph2", "Kph", "kRas", "kt", "Kx2", "kxR0", "L", "m3PI_init", "mRas_init", "n", "p", "sumrc1_init", "VmaxOVERKMx11", "VmaxOVERKMx12", "VmaxOVERKMx21", "VmaxOVERKMx22", "VmaxOVERKMy1", "VmaxOVERKMy2", "VmaxOVERKMyph1", "VmaxOVERKMyph2", "VmaxOVERKMzph1", "VmaxOVERKMzph2", "w_init", "Wph", "x1_init", "x2_init", "y_init", "ypp_init", "z_init", "Zf", "zpp_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "eph_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "fGEF_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "sumrc1_init", internal, 0, -Infinity, Infinity, false);
