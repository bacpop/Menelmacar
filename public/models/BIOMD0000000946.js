export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["alpha", "B_T", "D", "H_c_init", "H_e_init", "H_m_init", "k_b", "k_cc", "k_cm", "k_dh", "k_dl", "k_e", "k_i", "k_mi", "k_mo", "k_oc", "k_om", "L_c_init", "L_e_init", "L_m_init", "L_n_init", "V_c", "V_e", "V_m", "V_n", "v0", "v1", "v2"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "V_e", internal, 30089547.302760798, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "V_m", internal, 1999969910452.7, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "v1", internal, 0.36295516433955299, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "v2", internal, 0.39324487334137498, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const H_c = state[5];
    const L_n = state[6];
    dstatedt[5] = internal.k_oc * L_c - internal.k_cc * H_c + internal.k_dh * internal.v2 * L_n;
    dstatedt[3] = internal.k_mi / internal.v0 * H_m + internal.k_om * L_e - (internal.k_cm + internal.k_mo) * H_e;
    dstatedt[1] = internal.k_om * L_m - (internal.k_cm + internal.k_mi) * H_m + internal.k_mo * internal.v0 * H_e;
    dstatedt[4] = internal.k_i * internal.v1 * L_e - (internal.k_e + internal.k_oc) * L_c + internal.k_cc * H_c + internal.k_dl * internal.v2 * L_n - internal.k_b * (internal.B_T - L_n) * L_c;
    dstatedt[2] = internal.k_mi / internal.v0 * L_m - (internal.k_mo + internal.k_om + internal.k_i) * L_e + internal.k_cm * H_e + internal.k_e / internal.v1 * L_c;
    dstatedt[0] = - (internal.k_om + internal.k_mi) * L_m + internal.k_cm * H_m + internal.k_mo * internal.v0 * L_e;
    dstatedt[6] = internal.k_b / internal.v2 * (internal.B_T - L_n) * L_c - (internal.k_dl + internal.k_dh) * L_n;
  }
  names() {
