export class model {
  ...
  initial(t) {
    ...
    state[7] = internal.initial_s2;
    state[8] = internal.initial_s13;
    state[9] = internal.initial_species_2;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a", "E", "h", "Km", "kxk", "parameter_1", "parameter_10", "parameter_2", "parameter_3", "parameter_4", "parameter_5", "parameter_8", "parameter_9", "s10_init", "s11_init", "s13_init", "s2_init", "s9_init", "species_1_init", "species_12_init", "species_2_init", "species_3_init", "species_4_init", "T", "v"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "s2_init", internal, 1, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0 + 1 * internal.default1 * (internal.v * Math.exp(internal.E / internal.parameter_3 * (T2 - internal.T) / (internal.T * T2)) * species_2) - 1 * internal.default1 * (internal.parameter_1 * Math.exp(internal.parameter_9 / internal.parameter_3 * (T2 - internal.T) / (internal.T * T2)) * species_1) - 1 * internal.default1 * (internal.v * Math.exp(internal.E / internal.parameter_3 * (T2 - internal.T) / (internal.T * T2)) * species_1 / (internal.Km + species_1)) + 1 * internal.default1 * (internal.parameter_2 * Math.exp(internal.parameter_10 / internal.parameter_3 * (T2 - internal.T) / (internal.T * T2)) * species_3);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "s9", "s10", "s11", "species_1", "species_3", "species_4", "species_12", "s2", "s13", "species_2"];
    this.metadata.internalOrder = {a: null, default1: null, E: null, h: null, initial_s10: null, initial_s11: null, initial_s13: null, initial_s2: null, initial_s9: null, initial_species_1: null, initial_species_12: null, initial_species_2: null, initial_species_3: null, initial_species_4: null, Km: null, kxk: null, parameter_1: null, parameter_10: null, parameter_2: null, parameter_3: null, parameter_4: null, parameter_5: null, parameter_6: null, parameter_7: null, parameter_8: null, parameter_9: null, pi: null, s10_init: null, s11_init: null, s13_init: null, s2_init: null, s9_init: null, species_1_init: null, species_12_init: null, species_2_init: null, species_3_init: null, species_4_init: null, T: null, v: null};
    this.metadata.variableOrder = {s9: null, s10: null, s11: null, species_1: null, species_3: null, species_4: null, species_12: null, s2: null, s13: null, species_2: null};
