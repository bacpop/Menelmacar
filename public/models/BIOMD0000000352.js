export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "aux_init", "B_d", "d_A", "d_I", "d_IA", "D_IA_init", "d_II", "D_II_init", "d_r", "f_A", "f_c", "gamma_I", "I_init", "k_Am", "K_aux", "k_IA", "K_IA", "k_II", "K_II", "pi_A", "pi_I", "R_init", "w_A", "w_D", "w_I"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "A_init", internal, 10, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "aux_init", internal, 1.1100000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "D_IA_init", internal, 10, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d_II", internal, 0.0030000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "D_II_init", internal, 10, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 - 1 * internal.k_IA * I * A - internal.kprime_IA * D_IA - 1 * internal.k_II * I * I - internal.kprime_II * D_II - 1 * internal.gamma_I * internal.d_I * internal.K_aux * aux / (internal.K_aux * aux + 1) * I + 1 * internal.gamma_I * internal.d_I * internal.K_aux * aux / (internal.K_aux * aux + 1) * D_II + 1 * internal.pi_I * R;
  }
  names() {
