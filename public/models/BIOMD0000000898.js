export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "L_LSC_init", internal, 10, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "S_HSC_init", internal, 10, -Infinity, Infinity, false);
