export class model {
  ...
  initial(t) {
    ...
    state[3] = internal.initial_stim_PM;
    state[4] = internal.initial_IP3_PHGFP_Cyt;
    state[5] = internal.initial_PIP2_PM;
    state[6] = internal.initial_PIP_PM;
    state[7] = internal.initial_DAG_PM;
    state[8] = internal.initial_hv_Cytosol;
    state[9] = internal.initial_IP3X_Cytosol;
    state[10] = internal.initial_PLC_PM;
    state[11] = internal.initial_PLC_act_PM;
    state[12] = internal.initial_IP3_Cyt;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["DAG_PM_init", "hv_Cytosol_init", "IP3_Cyt_init", "IP3_PHGFP_Cyt_init", "IP3X_Cytosol_init", "kBasalSynPIP_PIPSyn", "kBasalSynPIP2_PIP2Syn", "KdIP3PH_IP3_PHGFP", "KdPIP2PH_PIP2_PH", "kf_IP3PH_IP3_PHGFP", "kf_PIP2PH_PIP2_PH", "KMOLE", "kStimSynPIP_PIPSyn", "kStimSynPIP2_PIP2Syn", "PH_GFP_Cyt_init", "PI_PM_init", "PIP_basal_PIPSyn", "PIP_PM_init", "PIP2_basal_PIP2Syn", "PIP2_PHGFP_PM_init", "PIP2_PM_init", "PIP2syndecay_PIP2Syn", "PIPsyndecay_PIPSyn", "PLC_act_PM_init", "PLC_PM_init", "stim_PM_init", "stimdecay_PLCact", "tau0_PLCact", "tauPIP2syn_PIP2Syn", "tauPIPsyn_PIPSyn"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "DAG_PM_init", internal, 2000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "hv_Cytosol_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "IP3X_Cytosol_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "stim_PM_init", internal, 1, -Infinity, Infinity, false);
    ...
    internal.initial_hv_Cytosol = internal.hv_Cytosol_init;
    internal.initial_IP3_Cyt = internal.IP3_Cyt_init;
    internal.initial_IP3_PHGFP_Cyt = internal.IP3_PHGFP_Cyt_init;
    internal.initial_IP3X_Cytosol = internal.IP3X_Cytosol_init;
    ...
    internal.initial_stim_PM = internal.stim_PM_init;
  ...
  rhs(t, state, dstatedt) {
    ...
    const PI_PM = state[2];
    const stim_PM = state[3];
    const IP3_PHGFP_Cyt = state[4];
    const PIP2_PM = state[5];
    const PIP_PM = state[6];
    const PLC_PM = state[10];
    const PLC_act_PM = state[11];
    const IP3_Cyt = state[12];
    dstatedt[8] = 0;
    dstatedt[9] = 0;
    dstatedt[3] = 0;
    dstatedt[7] = 0 + 1 * (internal.k_PIP2hyd * PIP2_PM * PLC_act_PM * internal.PM) + 1 * (internal.k_PIP2PHhyd * PLC_act_PM * PIP2_PHGFP_PM * internal.PM);
    ...
    dstatedt[6] = 0 + 1 * internal.PM * ((Ratebasal_PIPsyn_PIPSyn + Ratestim_PIPsyn_PIPSyn) * PI_PM) - 1 * internal.PM * ((Rate_PIP2Synbasal_PIP2Syn + Rate_PIP2SynStim_PIP2Syn) * PIP_PM);
    ...
    dstatedt[5] = 0 - 1 * (internal.k_PIP2hyd * PIP2_PM * PLC_act_PM * internal.PM) - 1 * ((internal.kf_PIP2PH_PIP2_PH * 0.0016611295681063099 * PH_GFP_Cyt * PIP2_PM + - (internal.kr_PIP2PH_PIP2_PH * PIP2_PHGFP_PM)) * internal.PM) + 1 * internal.PM * ((Rate_PIP2Synbasal_PIP2Syn + Rate_PIP2SynStim_PIP2Syn) * PIP_PM);
    dstatedt[11] = 0 + 1 * internal.PM * (internal.KfPLCact * PLC_PM * stim_PM * signal_PLCact + - (internal.krPLCact * PLC_act_PM));
    dstatedt[10] = 0 - 1 * internal.PM * (internal.KfPLCact * PLC_PM * stim_PM * signal_PLCact + - (internal.krPLCact * PLC_act_PM));
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "PIP2_PHGFP_PM", "PH_GFP_Cyt", "PI_PM", "stim_PM", "IP3_PHGFP_Cyt", "PIP2_PM", "PIP_PM", "DAG_PM", "hv_Cytosol", "IP3X_Cytosol", "PLC_PM", "PLC_act_PM", "IP3_Cyt"];
    this.metadata.internalOrder = {Cytosol: null, DAG_PM_init: null, Extracellular: null, hv_Cytosol_init: null, initial_DAG_PM: null, initial_hv_Cytosol: null, initial_IP3_Cyt: null, initial_IP3_PHGFP_Cyt: null, initial_IP3X_Cytosol: null, initial_PH_GFP_Cyt: null, initial_PI_PM: null, initial_PIP_PM: null, initial_PIP2_PHGFP_PM: null, initial_PIP2_PM: null, initial_PLC_act_PM: null, initial_PLC_PM: null, initial_stim_PM: null, IP3_basal: null, IP3_Cyt_init: null, IP3_PHGFP_Cyt_init: null, IP3X_Cytosol_init: null, k_PIP2hyd: null, k_PIP2PHhyd: null, kBasalSynPIP_PIPSyn: null, kBasalSynPIP2_PIP2Syn: null, KdIP3PH_IP3_PHGFP: null, KdPIP2PH_PIP2_PH: null, kf_IP3PH_IP3_PHGFP: null, kf_PIP2PH_PIP2_PH: null, KfPLCact: null, kIP3deg: null, KMOLE: null, kr_IP3PH_IP3_PHGFP: null, kr_PIP2PH_PIP2_PH: null, krPLCact: null, kStimSynPIP_PIPSyn: null, kStimSynPIP2_PIP2Syn: null, NM: null, Nucleus: null, PH_GFP_Cyt_init: null, PI_PM_init: null, PIP_basal_PIPSyn: null, PIP_PM_init: null, PIP2_basal_PIP2Syn: null, PIP2_PHGFP_PM_init: null, PIP2_PM_init: null, PIP2syndecay_PIP2Syn: null, PIPsyndecay_PIPSyn: null, PLC_act_PM_init: null, PLC_PM_init: null, PM: null, stim_PM_init: null, stimdecay_PLCact: null, tau0_PLCact: null, tauPIP2syn_PIP2Syn: null, tauPIPsyn_PIPSyn: null};
    this.metadata.variableOrder = {PIP2_PHGFP_PM: null, PH_GFP_Cyt: null, PI_PM: null, stim_PM: null, IP3_PHGFP_Cyt: null, PIP2_PM: null, PIP_PM: null, DAG_PM: null, hv_Cytosol: null, IP3X_Cytosol: null, PLC_PM: null, PLC_act_PM: null, IP3_Cyt: null};
