export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = internal.alpha * K_T + internal.k1 * internal.k2 * phi_I * (1 - internal.k3 * (phi_I + phi_R)) - internal.d1 * phi_I;
    dstatedt[1] = (1 - internal.alpha) * K_T + internal.k1 * internal.k2 * phi_R * (1 - internal.k3 * (phi_I + phi_R)) - internal.d1 * phi_R;
  }
  names() {
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {alpha: null, COMpartment: null, d1: null, d2: null, initial_phi_I: null, initial_phi_R: null, initial_T: null, k1: null, k2: null, k3: null, k4: null, phi_I_init: null, phi_R_init: null, T_init: null, tau1: null, tau2: null, tau3: null, tau4: null};
