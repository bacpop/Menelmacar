export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.cdc14_total = 0.5;
    internal.cdc15_total = 1;
    internal.cdh1_total = 1;
    internal.Inh = 0;
    internal.net1_total = 1;
    internal.nucleus = 1;
    internal.pp2a_total = 1;
    internal.tem1_total = 1;
  ...
  initial(t) {
    ...
    state[8] = internal.initial_polo_total;
    state[9] = internal.initial_men;
    state[10] = internal.initial_polo;
    state[11] = internal.initial_tem1;
    state[12] = internal.initial_cdc15;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["cdc15_init", "cdc20_init", "cdh1_init", "clb2_init", "J_cdc15", "J_cdh", "J_polo", "J_tem1", "Jnet", "ka_cdc15", "ka_cdc15_p", "ka_polo", "ka_polo_p", "ka_tem", "ka_tem_p", "kd", "kd_cdc20", "kd_cdc20_p", "kd_cdh", "kd_cdh_p", "kd_clb2", "kd_clb2_p", "kd_clb2_pp", "kd_p", "kd_polo", "kd_polo_p", "kd_securin", "kd_securin_p", "kd_separase", "ki", "ki_cdc15", "ki_cdc15_p", "ki_polo", "ki_tem", "kitem_p", "kp", "kp_cdh_p", "kp_p", "kpp", "ks_cdc20", "ks_clb2", "ks_polo", "ks_securin", "ks_separase", "l_a_net", "l_d_net", "la_men", "la_securin", "ld_men", "ld_securin", "men_init", "net1_init", "net1cdc14_init", "polo_init", "polo_total_init", "securin_separase_init", "securin_total_init", "separase_total_init", "tem1_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "polo_total_init", internal, 0.98999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "securin_separase_init", internal, 0.248, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "securin_total_init", internal, 0.59999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "separase_total_init", internal, 0.25, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "tem1_init", internal, 1, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const polo_total = state[8];
    const men = state[9];
    const polo = state[10];
    const tem1 = state[11];
    const cdc15 = state[12];
    var cdc14 = internal.cdc14_total - net1cdc14;
    ...
    dstatedt[8] = 0 + 1 * internal.nucleus * (internal.ks_polo) - 1 * internal.nucleus * ((internal.kd_polo + internal.kd_polo_p * cdh1) * polo_total);
    ...
    var net1p = internal.net1_total - net1 - net1cdc14;
    var securin = securin_total - securin_separase;
    var separase = separase_total - securin_separase;
    dstatedt[12] = 0 + 1 * internal.nucleus * ((internal.ka_cdc15 + internal.ka_cdc15_p * cdc14) * (internal.cdc15_total - cdc15) / (internal.J_cdc15 + internal.cdc15_total - cdc15)) - 1 * internal.nucleus * ((internal.ki_cdc15 + internal.ki_cdc15_p * cdk) * cdc15 / (internal.J_cdc15 + cdc15));
    dstatedt[2] = 0 + 1 * internal.nucleus * ((internal.kd_cdh + internal.kd_cdh_p * cdc14) * (internal.cdh1_total - cdh1) / (internal.J_cdh + internal.cdh1_total - cdh1)) - 1 * internal.nucleus * (internal.kp_cdh_p * cdk * cdh1 / (internal.J_cdh + cdh1));
    dstatedt[7] = 0 + 1 * internal.nucleus * (internal.l_a_net * net1 * cdc14 - internal.l_d_net * net1cdc14) - 1 * internal.nucleus * ((internal.kp * cdk + internal.kp_p * men) * net1cdc14 / (internal.Jnet + net1 + net1cdc14));
    dstatedt[10] = 0 + 1 * internal.nucleus * ((internal.ka_polo + internal.ka_polo_p * cdk) * (polo_total - polo) / (internal.J_polo + polo_total - polo)) - 1 * internal.nucleus * (internal.ki_polo * polo / (internal.J_polo + polo)) - 1 * internal.nucleus * ((internal.kd_polo + internal.kd_polo_p * cdh1) * polo);
    ...
    var pp2a = (1 + internal.kpp * internal.ki * separase) / (1 + internal.ki * separase) * internal.pp2a_total;
    dstatedt[9] = 0 + 1 * internal.nucleus * (internal.la_men * (tem1 - men) * (cdc15 - men)) - 1 * internal.nucleus * (internal.ld_men * men) - 1 * internal.nucleus * ((internal.ki_tem + internal.kitem_p * pp2a) * men / (internal.J_tem1 + tem1)) - 1 * internal.nucleus * ((internal.ki_cdc15 + internal.ki_cdc15_p * cdk) * men / (internal.J_cdc15 + cdc15));
    ...
    dstatedt[11] = 0 + 1 * internal.nucleus * ((internal.ka_tem + internal.ka_tem_p * polo) * (internal.tem1_total - tem1) / (internal.J_tem1 + internal.tem1_total - tem1)) - 1 * internal.nucleus * ((internal.ki_tem + internal.kitem_p * pp2a) * tem1 / (internal.J_tem1 + tem1));
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "clb2", "cdc20", "cdh1", "securin_total", "separase_total", "securin_separase", "net1", "net1cdc14", "polo_total", "men", "polo", "tem1", "cdc15"];
    this.metadata.internalOrder = {cdc14_total: null, cdc15_init: null, cdc15_total: null, cdc20_init: null, cdh1_init: null, cdh1_total: null, clb2_init: null, Inh: null, initial_cdc15: null, initial_cdc20: null, initial_cdh1: null, initial_clb2: null, initial_men: null, initial_net1: null, initial_net1cdc14: null, initial_polo: null, initial_polo_total: null, initial_securin_separase: null, initial_securin_total: null, initial_separase_total: null, initial_tem1: null, J_cdc15: null, J_cdh: null, J_polo: null, J_tem1: null, Jnet: null, ka_cdc15: null, ka_cdc15_p: null, ka_polo: null, ka_polo_p: null, ka_tem: null, ka_tem_p: null, kd: null, kd_cdc20: null, kd_cdc20_p: null, kd_cdh: null, kd_cdh_p: null, kd_clb2: null, kd_clb2_p: null, kd_clb2_pp: null, kd_p: null, kd_polo: null, kd_polo_p: null, kd_securin: null, kd_securin_p: null, kd_separase: null, ki: null, ki_cdc15: null, ki_cdc15_p: null, ki_polo: null, ki_tem: null, kitem_p: null, kp: null, kp_cdh_p: null, kp_p: null, kpp: null, ks_cdc20: null, ks_clb2: null, ks_polo: null, ks_securin: null, ks_separase: null, l_a_net: null, l_d_net: null, la_men: null, la_securin: null, ld_men: null, ld_securin: null, men_init: null, net1_init: null, net1_total: null, net1cdc14_init: null, nucleus: null, polo_init: null, polo_total_init: null, pp2a_total: null, securin_separase_init: null, securin_total_init: null, separase_total_init: null, tem1_init: null, tem1_total: null};
    this.metadata.variableOrder = {clb2: null, cdc20: null, cdh1: null, securin_total: null, separase_total: null, securin_separase: null, net1: null, net1cdc14: null, polo_total: null, men: null, polo: null, tem1: null, cdc15: null};
