export class model {
  ...
  initial(t) {
    ...
    state[13] = internal.initial_pp2a_total;
    state[14] = internal.initial_cdh1_total;
    state[15] = internal.initial_net1_total;
    state[16] = internal.initial_tem1_total;
    state[17] = internal.initial_cdc15_total;
    state[18] = internal.initial_Inh;
    state[19] = internal.initial_cdc14_total;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "cdc14_total_init", internal, 0.5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "cdc15_init", internal, 0.025700000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "cdc15_total_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "cdh1_total_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "net1_total_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "pp2a_total_init", internal, 1, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "tem1_total_init", internal, 1, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const pp2a_total = state[13];
    const cdh1_total = state[14];
    const net1_total = state[15];
    const tem1_total = state[16];
    const cdc15_total = state[17];
    const Inh = state[18];
    const cdc14_total = state[19];
    dstatedt[19] = 0;
    dstatedt[17] = 0;
    dstatedt[14] = 0;
    dstatedt[18] = 0;
    ...
    dstatedt[13] = 0;
    dstatedt[16] = 0;
    var cdc14 = cdc14_total - net1cdc14;
    var cdk = clb2 / (1 + Inh);
    ...
    var net1p = net1_total - net1 - net1cdc14;
    var securin = securin_total - securin_separase;
    var separase = separase_total - securin_separase;
    dstatedt[12] = 0 + 1 * internal.nucleus * ((internal.ka_cdc15 + internal.ka_cdc15_p * cdc14) * (cdc15_total - cdc15) / (internal.J_cdc15 + cdc15_total - cdc15)) - 1 * internal.nucleus * ((internal.ki_cdc15 + internal.ki_cdc15_p * cdk) * cdc15 / (internal.J_cdc15 + cdc15));
    ...
    var pp2a = (1 + internal.kpp * internal.ki * separase) / (1 + internal.ki * separase) * pp2a_total;
    ...
    dstatedt[11] = 0 + 1 * internal.nucleus * ((internal.ka_tem + internal.ka_tem_p * polo) * (tem1_total - tem1) / (internal.J_tem1 + tem1_total - tem1)) - 1 * internal.nucleus * ((internal.ki_tem + internal.kitem_p * pp2a) * tem1 / (internal.J_tem1 + tem1));
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "clb2", "cdc20", "cdh1", "securin_total", "separase_total", "securin_separase", "net1", "net1cdc14", "polo_total", "men", "polo", "tem1", "cdc15", "pp2a_total", "cdh1_total", "net1_total", "tem1_total", "cdc15_total", "Inh", "cdc14_total"];
    this.metadata.internalOrder = {cdc14_total_init: null, cdc15_init: null, cdc15_total_init: null, cdc20_init: null, cdh1_init: null, cdh1_total_init: null, clb2_init: null, Inh_init: null, initial_cdc14_total: null, initial_cdc15: null, initial_cdc15_total: null, initial_cdc20: null, initial_cdh1: null, initial_cdh1_total: null, initial_clb2: null, initial_Inh: null, initial_men: null, initial_net1: null, initial_net1_total: null, initial_net1cdc14: null, initial_polo: null, initial_polo_total: null, initial_pp2a_total: null, initial_securin_separase: null, initial_securin_total: null, initial_separase_total: null, initial_tem1: null, initial_tem1_total: null, J_cdc15: null, J_cdh: null, J_polo: null, J_tem1: null, Jnet: null, ka_cdc15: null, ka_cdc15_p: null, ka_polo: null, ka_polo_p: null, ka_tem: null, ka_tem_p: null, kd: null, kd_cdc20: null, kd_cdc20_p: null, kd_cdh: null, kd_cdh_p: null, kd_clb2: null, kd_clb2_p: null, kd_clb2_pp: null, kd_p: null, kd_polo: null, kd_polo_p: null, kd_securin: null, kd_securin_p: null, kd_separase: null, ki: null, ki_cdc15: null, ki_cdc15_p: null, ki_polo: null, ki_tem: null, kitem_p: null, kp: null, kp_cdh_p: null, kp_p: null, kpp: null, ks_cdc20: null, ks_clb2: null, ks_polo: null, ks_securin: null, ks_separase: null, l_a_net: null, l_d_net: null, la_men: null, la_securin: null, ld_men: null, ld_securin: null, men_init: null, net1_init: null, net1_total_init: null, net1cdc14_init: null, nucleus: null, polo_init: null, polo_total_init: null, pp2a_total_init: null, securin_separase_init: null, securin_total_init: null, separase_total_init: null, tem1_init: null, tem1_total_init: null};
    this.metadata.variableOrder = {clb2: null, cdc20: null, cdh1: null, securin_total: null, separase_total: null, securin_separase: null, net1: null, net1cdc14: null, polo_total: null, men: null, polo: null, tem1: null, cdc15: null, pp2a_total: null, cdh1_total: null, net1_total: null, tem1_total: null, cdc15_total: null, Inh: null, cdc14_total: null};
