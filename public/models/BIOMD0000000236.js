export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.cell * internal.Vgk * Math.pow((GLC / internal.Sgk), (internal.hGK)) / (1 + Math.pow((GLC / internal.Sgk), (internal.hGK))) - 1 * internal.cell * internal.Vpfk * Math.pow((F6P / internal.Spfk), (internal.hpfk - (internal.hpfk - internal.hact) * (FBP / internal.Sfba / (1 + FBP / internal.Sfba)))) / (Math.pow((F6P / internal.Spfk), (internal.hpfk - (internal.hpfk - internal.hact) * (FBP / internal.Sfba / (1 + FBP / internal.Sfba)))) + (1 + Math.pow((FBP / internal.Xpfk), (internal.hx))) / (1 + Math.pow((internal.alpha), (internal.hpfk - (internal.hpfk - internal.hact) * (FBP / internal.Sfba / (1 + FBP / internal.Sfba)))) * Math.pow((FBP / internal.Xpfk), (internal.hx))));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "G6P_F6P", "FBP", "DHAP_G3P", "GLC"];
    this.metadata.internalOrder = {alpha: null, cell: null, DHAP_G3P_init: null, dw_per_ml: null, FBP_init: null, G6P_F6P_init: null, GLC_init: null, hact: null, hGK: null, hpfk: null, hx: null, initial_DHAP_G3P: null, initial_FBP: null, initial_G6P_F6P: null, initial_GLC: null, KeqFBA: null, KeqGPI: null, KeqTPI: null, min_to_sec: null, Pfba: null, Qfba: null, Sfba: null, Sgapdh: null, Sgk: null, Spfk: null, Vfba: null, Vfba_min: null, Vgapdh: null, Vgapdh_min: null, Vgk: null, Vgk_min: null, Vpfk: null, Vpfk_min: null, Xpfk: null};
    this.metadata.variableOrder = {G6P_F6P: null, FBP: null, DHAP_G3P: null, GLC: null};
