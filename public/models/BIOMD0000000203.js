export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[11] = 0 + 1 * (internal.g1 * OCT4_SOX2 + internal.eta7) / (1 + internal.eta7 / internal.f + internal.h1 * OCT4_SOX2 + internal.h2 * OCT4_SOX2 * NANOG) - 1 * internal.gamma4 * Protein;
