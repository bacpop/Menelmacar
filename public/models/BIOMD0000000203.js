export class model {
  ...
  initial(t) {
    ...
    state[5] = internal.initial_OCT4_Gene;
    state[6] = internal.initial_NANOG_Gene;
    state[7] = internal.initial_SOX2_Gene;
    state[8] = internal.initial_targetGene;
    state[9] = internal.initial_degradation;
    state[10] = internal.initial_p53;
    state[11] = internal.initial_A;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "A_init", internal, 10, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "b3", internal, 0.00069999999999999999, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "c3", internal, 0.20000000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "d3", internal, 0.00069999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "degradation_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "e1", internal, 0.0050000000000000001, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "f2", internal, 0.00099500000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "f3", internal, 0.01, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "h1", internal, 0.0019, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "h2", internal, 0.050000000000000003, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[7] = 0;
    dstatedt[8] = 0;
    dstatedt[2] = 0 + 1 * (internal.eta5 + internal.e1 * OCT4_SOX2 + internal.e2 * OCT4_SOX2 * NANOG) / (1 + internal.eta5 / internal.f + internal.f2 * OCT4_SOX2 + internal.f1 * OCT4_SOX2 * NANOG + internal.f3 * p53) - 1 * internal.gamma2 * NANOG;
    dstatedt[0] = 0 + 1 * (internal.eta1 + internal.a1 * A + internal.a2 * OCT4_SOX2 + internal.a3 * OCT4_SOX2 * NANOG) / (1 + internal.eta1 / internal.f + internal.b1 * A + internal.b2 * OCT4_SOX2 + internal.b3 * OCT4_SOX2 * NANOG) - 1 * internal.gamma1 * OCT4 - 1 * internal.k1c * OCT4 * SOX2 - internal.k2c * OCT4_SOX2;
    dstatedt[3] = 0 + 1 * internal.k1c * OCT4 * SOX2 - internal.k2c * OCT4_SOX2 - 1 * internal.k3c * OCT4_SOX2;
    dstatedt[4] = 0 + 1 * (internal.g1 * OCT4_SOX2 + internal.eta7) / (1 + internal.eta7 / internal.f + internal.h1 * OCT4_SOX2 + internal.h2 * OCT4_SOX2 * NANOG) - 1 * internal.gamma4 * Protein;
    dstatedt[1] = 0 - 1 * internal.k1c * OCT4 * SOX2 - internal.k2c * OCT4_SOX2 + 1 * (internal.eta3 + internal.c1 * A + internal.c2 * OCT4_SOX2 + internal.c3 * OCT4_SOX2 * NANOG) / (1 + internal.eta3 / internal.f + internal.d1 * A + internal.d2 * OCT4_SOX2 + internal.d3 * OCT4_SOX2 * NANOG) - 1 * internal.gamma3 * SOX2;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "OCT4", "SOX2", "NANOG", "OCT4_SOX2", "Protein", "OCT4_Gene", "NANOG_Gene", "SOX2_Gene", "targetGene", "degradation", "p53", "A"];
    ...
    this.metadata.variableOrder = {OCT4: null, SOX2: null, NANOG: null, OCT4_SOX2: null, Protein: null, OCT4_Gene: null, NANOG_Gene: null, SOX2_Gene: null, targetGene: null, degradation: null, p53: null, A: null};
