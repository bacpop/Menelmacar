export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "X0_init", internal, 1, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[1] = flux_X1_in - flux_X1_out;
    dstatedt[2] = flux_X2_in - flux_X2_out;
    dstatedt[3] = flux_X3_in - flux_X3_out;
    dstatedt[4] = flux_X4_in - flux_X4_out;
    dstatedt[5] = flux_X5_in - flux_X5_out;
    dstatedt[6] = flux_X6_in - flux_X6_out;
    dstatedt[7] = flux_X7_in - flux_X7_out;
  }
  names() {
