export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["heat_shock", "X1_init", "X2_init", "X3_init", "X4_init", "X5_init", "X6_init", "X7_init"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "heat_shock", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X1_init", internal, 0.029999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X2_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X3_init", internal, 0.10000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X4_init", internal, 0.69999999999999996, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X5_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X6_init", internal, 0.02, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X7_init", internal, 0.050000000000000003, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const X6 = state[5];
    const X7 = state[6];
    var flux_X1_in = 31.911999999999999 * Math.pow((internal.X0), (0.96799999999999997)) * Math.pow((X2), (- 0.19400000000000001)) * Math.pow((X7), (0.0096799999999999994)) * Math.pow((internal.X8), (0.96799999999999997)) * Math.pow((internal.X19), (0.032300000000000002));
    ...
    dstatedt[0] = flux_X1_in - flux_X1_out;
    dstatedt[1] = flux_X2_in - flux_X2_out;
    dstatedt[2] = flux_X3_in - flux_X3_out;
    dstatedt[3] = flux_X4_in - flux_X4_out;
    dstatedt[4] = flux_X5_in - flux_X5_out;
    dstatedt[5] = flux_X6_in - flux_X6_out;
    dstatedt[6] = flux_X7_in - flux_X7_out;
  }
  names() {
