export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 + 4 * internal.kpf * AbDim * (AbDim - 1) * 0.5 + 2 * internal.kpg * Abeta * Math.pow((AbP), (2)) / (Math.pow((internal.kpghalf), (2)) + Math.pow((AbP), (2))) - 1 * internal.kpg * Abeta * Math.pow((AbP), (2)) / (Math.pow((internal.kpghalf), (2)) + Math.pow((AbP), (2))) - 1 * internal.kdisagg * AbP;
    dstatedt[5] = 0 + 1 * internal.kdeg * Abeta * Nep * 0.001 - 1 * internal.kdeg * Abeta * Nep * 0.001 - 1 * internal.kdegNep * Nep;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Abeta", "AbDim", "AbP", "Source", "Sink", "Nep"];
    ...
    this.metadata.variableOrder = {Abeta: null, AbDim: null, AbP: null, Source: null, Sink: null, Nep: null};
