export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["AbDim_init", "Abeta_init", "AbP_init", "kdedimer", "kdeg", "kdegNep", "kdimer", "kdisagg", "kpf", "kpg", "kpghalf", "kprod", "Nep_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.kprod * internal.Source - 1 * internal.kdeg * Abeta * Nep * 0.001 - 2 * internal.kdimer * Abeta * (Abeta - 1) * 0.5 + 2 * internal.kdedimer * AbDim - 1 * internal.kpg * Abeta * Math.pow((AbP), (2)) / (Math.pow((internal.kpghalf), (2)) + Math.pow((AbP), (2))) + 1 * internal.kdisagg * AbP;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Abeta", "AbDim", "AbP", "Nep"];
    this.metadata.internalOrder = {AbDim_init: null, Abeta_init: null, AbP_init: null, cell: null, initial_AbDim: null, initial_Abeta: null, initial_AbP: null, initial_Nep: null, kdedimer: null, kdeg: null, kdegNep: null, kdimer: null, kdisagg: null, kpf: null, kpg: null, kpghalf: null, kprod: null, Nep_init: null, Sink: null, Source: null};
    this.metadata.variableOrder = {Abeta: null, AbDim: null, AbP: null, Nep: null};
