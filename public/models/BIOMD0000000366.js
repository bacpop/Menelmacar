export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "II_init", internal, 1.3999999999999999, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PL_init", internal, 0.049999990000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "PT_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "RVV_init", internal, 0.029999999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "V_init", internal, 0.029999990000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Va_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "X_init", internal, 0.19999990000000001, -Infinity, Infinity, false);
