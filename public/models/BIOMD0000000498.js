export class model {
  ...
  initial(t) {
    ...
    state[19] = internal.initial_species_43;
    state[20] = internal.initial_species_11;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a", "a1", "basal", "C", "K", "k1", "K1", "kloss", "Km", "n", "species_1_init", "species_10_init", "species_11_init", "species_12_init", "species_15_init", "species_16_init", "species_17_init", "species_18_init", "species_19_init", "species_2_init", "species_24_init", "species_25_init", "species_26_init", "species_3_init", "species_4_init", "species_43_init", "species_5_init", "species_6_init", "species_7_init", "species_8_init", "species_9_init", "v", "V"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "species_11_init", internal, 9.9999999999999995e-08, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "species_43_init", internal, 5.0000000000000004e-06, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const species_43 = state[19];
    const species_11 = state[20];
    dstatedt[20] = 0;
    dstatedt[19] = 0;
    ...
    dstatedt[18] = 0 + 1 * internal.compartment_3 * (internal.v) - 1 * internal.compartment_3 * (internal.a * (1 - Math.pow((species_43), (internal.n)) / (Math.pow((internal.K), (internal.n)) + Math.pow((species_43), (internal.n)))) * species_10) - 1 * internal.compartment_3 * internal.k1 * Math.pow((species_8), (2)) * species_10 + 1 * internal.compartment_3 * internal.k1 * species_18 - 1 * internal.compartment_3 * internal.k1 * species_43 * species_10 + 1 * internal.compartment_3 * internal.k1 * species_15 + 1 * internal.k1 * species_19;
    dstatedt[10] = 0 + 1 * internal.compartment_3 * internal.k1 * species_43 * species_3 - 1 * internal.compartment_3 * internal.k1 * species_12 - 1 * internal.compartment_3 * internal.k1 * species_12 * species_43 + 1 * internal.compartment_3 * internal.k1 * species_16;
    dstatedt[13] = 0 + 1 * internal.compartment_3 * internal.k1 * species_43 * species_10 - 1 * internal.compartment_3 * internal.k1 * species_15 - 1 * internal.compartment_3 * internal.k1 * species_15 * species_43 + 1 * internal.compartment_3 * internal.k1 * species_19;
    dstatedt[14] = 0 + 1 * internal.compartment_3 * internal.k1 * species_12 * species_43 - 1 * internal.compartment_3 * internal.k1 * species_16 - 1 * internal.k1 * species_16;
    ...
    dstatedt[17] = 0 + 1 * internal.compartment_3 * internal.k1 * species_15 * species_43 - 1 * internal.compartment_3 * internal.k1 * species_19 - 1 * internal.k1 * species_19;
    ...
    dstatedt[5] = 0 + 1 * (internal.V * species_11 / (internal.Km + species_11)) - 1 * (internal.V * species_5 / (internal.Km + species_5)) - 1 * internal.compartment_1 * (species_1 * internal.C * species_5 / (internal.K + species_5));
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "species_7", "species_24", "species_25", "species_26", "species_1", "species_5", "species_2", "species_4", "species_6", "species_3", "species_12", "species_8", "species_9", "species_15", "species_16", "species_17", "species_18", "species_19", "species_10", "species_43", "species_11"];
    this.metadata.internalOrder = {a: null, a1: null, basal: null, C: null, compartment_1: null, compartment_3: null, initial_species_1: null, initial_species_10: null, initial_species_11: null, initial_species_12: null, initial_species_15: null, initial_species_16: null, initial_species_17: null, initial_species_18: null, initial_species_19: null, initial_species_2: null, initial_species_24: null, initial_species_25: null, initial_species_26: null, initial_species_3: null, initial_species_4: null, initial_species_43: null, initial_species_5: null, initial_species_6: null, initial_species_7: null, initial_species_8: null, initial_species_9: null, K: null, k1: null, K1: null, kloss: null, Km: null, n: null, species_1_init: null, species_10_init: null, species_11_init: null, species_12_init: null, species_15_init: null, species_16_init: null, species_17_init: null, species_18_init: null, species_19_init: null, species_2_init: null, species_24_init: null, species_25_init: null, species_26_init: null, species_3_init: null, species_4_init: null, species_43_init: null, species_5_init: null, species_6_init: null, species_7_init: null, species_8_init: null, species_9_init: null, v: null, V: null};
    this.metadata.variableOrder = {species_7: null, species_24: null, species_25: null, species_26: null, species_1: null, species_5: null, species_2: null, species_4: null, species_6: null, species_3: null, species_12: null, species_8: null, species_9: null, species_15: null, species_16: null, species_17: null, species_18: null, species_19: null, species_10: null, species_43: null, species_11: null};
