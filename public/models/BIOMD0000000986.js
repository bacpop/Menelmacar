export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var FITC_Dextran_single_compartment_model_init = internal.FITC_Dextran_max_uptake_rate * (1 - Math.exp(- internal.lambda_single_compartment_model_FITC_Dextran * t));
    var Pyranine_addition_trigger = (t > 90 ? 1 : 0);
    internal.initial_FITC_Dextran_single_compartment_model = FITC_Dextran_single_compartment_model_init;
    var Pyranine_single_compartment_model_init = Pyranine_addition_trigger * internal.Pyranine_max_uptake_rate * (1 - Math.exp(- internal.lambda_single_compartment_model_Pyranine * (t - 90)));
    internal.initial_Pyranine_single_compartment_model = Pyranine_single_compartment_model_init;
    var state = Array(8).fill(0);
    state[0] = internal.initial_FITC_Dextran_single_compartment_model;
    state[1] = internal.initial_Pyranine_single_compartment_model;
    state[2] = internal.initial_FITC_Dextran_three_compartment_model_compartment_1;
    state[3] = internal.initial_FITC_Dextran_three_compartment_model_compartment_2;
    state[4] = internal.initial_FITC_Dextran_three_compartment_model_compartment_3;
    state[5] = internal.initial_Pyranine_three_compartment_model_compartment_1;
    state[6] = internal.initial_Pyranine_three_compartment_model_compartment_2;
    state[7] = internal.initial_Pyranine_three_compartment_model_compartment_3;
    return state;
  }
  ...
  rhs(t, state, dstatedt) {
    var internal = this.internal;
    const FITC_Dextran_three_compartment_model_compartment_1 = state[2];
    const FITC_Dextran_three_compartment_model_compartment_2 = state[3];
    const FITC_Dextran_three_compartment_model_compartment_3 = state[4];
    const Pyranine_three_compartment_model_compartment_1 = state[5];
    const Pyranine_three_compartment_model_compartment_2 = state[6];
    const Pyranine_three_compartment_model_compartment_3 = state[7];
    dstatedt[0] = 0 + 0;
    dstatedt[1] = 0 + 0;
    dstatedt[2] = 0 + 1 * internal.Dictyostelium_discoideum_AX2 * (internal.FITC_Dextran_influx_rate) - 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_1 * FITC_Dextran_three_compartment_model_compartment_1;
    dstatedt[3] = 0 + 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_1 * FITC_Dextran_three_compartment_model_compartment_1 - 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_2 * FITC_Dextran_three_compartment_model_compartment_2;
    dstatedt[4] = 0 + 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_2 * FITC_Dextran_three_compartment_model_compartment_2 - 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_3 * FITC_Dextran_three_compartment_model_compartment_3;
    dstatedt[6] = 0 + 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_1 * Pyranine_three_compartment_model_compartment_1 - 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_2 * Pyranine_three_compartment_model_compartment_2;
    dstatedt[7] = 0 + 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_2 * Pyranine_three_compartment_model_compartment_2 - 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_3 * Pyranine_three_compartment_model_compartment_3;
    var Pyranine_addition_trigger = (t > 90 ? 1 : 0);
    dstatedt[5] = 0 + 1 * internal.Dictyostelium_discoideum_AX2 * (Pyranine_addition_trigger * internal.Pyranine_influx_rate) - 1 * internal.Dictyostelium_discoideum_AX2 * internal.lambda_compartment_1 * Pyranine_three_compartment_model_compartment_1;
  }
  names() {
