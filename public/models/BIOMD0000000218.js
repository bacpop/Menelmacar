export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0;
    dstatedt[1] = 0;
    dstatedt[5] = 0 + 1 * internal.cell * ((internal.Vf_icd1 * (icit / internal.Kicit_icd1) - internal.Vr_icd1 * (akg / internal.Kakg_icd1)) / (1 + icit / internal.Kicit_icd1 + akg / internal.Kakg_icd1)) + 1 * internal.cell * ((internal.Vf_icd2 * (icit / internal.Kicit_icd2) - internal.Vr_icd2 * (akg / internal.Kakg_icd2)) / (1 + icit / internal.Kicit_icd2 + akg / internal.Kakg_icd2)) - 1 * internal.cell * ((internal.Vf_kgd * (akg / internal.Kakg_kgd) - internal.Vr_kgd * (ssa / internal.Kssa_kgd)) / (1 + akg / internal.Kakg_kgd + ssa / internal.Kssa_kgd)) - 1 * internal.cell * 0.034099999999999998 * ((internal.Vf_icd1 * (icit / internal.Kicit_icd1) - internal.Vr_icd1 * (akg / internal.Kakg_icd1)) / (1 + icit / internal.Kicit_icd1 + akg / internal.Kakg_icd1) + (internal.Vf_icd2 * (icit / internal.Kicit_icd2) - internal.Vr_icd2 * (akg / internal.Kakg_icd2)) / (1 + icit / internal.Kicit_icd2 + akg / internal.Kakg_icd2));
    ...
    dstatedt[8] = 0 - 1 * internal.cell * ((internal.Vf_scas * (sca / internal.Ksca_scas) - internal.Vr_scas * (suc / internal.Ksuc_scas)) / (1 + sca / internal.Ksca_scas + suc / internal.Ksuc_scas));
