export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["aca_init", "akg_init", "biosyn_init", "cit_init", "coa_init", "fa_init", "gly_init", "icit_init", "Kaca_cs", "Kaca_ms", "Kakg_icd1", "Kakg_icd2", "Kakg_kgd", "Kcit_acn", "Kcit_cs", "Kcoa_cs", "Kcoa_ms", "Kfa_fum", "Kfa_sdh", "Kgly_icl1", "Kgly_icl2", "Kgly_ms", "Kicit_acn", "Kicit_icd1", "Kicit_icd2", "Kicit_icl1", "Kicit_icl2", "Kmal_fum", "Kmal_mdh", "Kmal_ms", "Koaa_cs", "Koaa_mdh", "Ksca_scas", "Kssa_kgd", "Kssa_ssadh", "Ksuc_icl1", "Ksuc_icl2", "Ksuc_scas", "Ksuc_sdh", "Ksuc_ssadh", "mal_init", "oaa_init", "sca_init", "ssa_init", "suc_init", "Vf_acn", "Vf_cs", "Vf_fum", "Vf_icd1", "Vf_icd2", "Vf_icl1", "Vf_icl2", "Vf_kgd", "Vf_mdh", "Vf_ms", "Vf_scas", "Vf_sdh", "Vf_ssadh", "Vr_acn", "Vr_cs", "Vr_fum", "Vr_icd1", "Vr_icd2", "Vr_icl1", "Vr_icl2", "Vr_kgd", "Vr_mdh", "Vr_ms", "Vr_scas", "Vr_sdh", "Vr_ssadh"], unusedUserAction);
    var internal = this.internal;
