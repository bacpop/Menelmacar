export class model {
  ...
  initial(t) {
    ...
    state[1] = internal.initial_APAP;
    state[2] = internal.initial_NAPQI;
    state[3] = internal.initial_GSH;
    state[4] = internal.initial_NAPQIGSH;
    state[5] = internal.initial_APAPconj_Glu;
    state[6] = internal.initial_APAPconj_Sul;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "APAP_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const GSH = state[3];
    dstatedt[0] = 0;
    dstatedt[1] = 0 - 1 * internal.Vmax_2E1_APAP * APAP / (internal.Km_2E1_APAP + APAP) - 1 * internal.Vmax_PhaseIIEnzGlu_APAP * APAP / (internal.Km_PhaseIIEnzGlu_APAP + APAP) - 1 * internal.Vmax_PhaseIIEnzSul_APAP * APAP / (internal.Km_PhaseIIEnzSul_APAP + APAP);
    dstatedt[5] = 0 + 1 * internal.Vmax_PhaseIIEnzGlu_APAP * APAP / (internal.Km_PhaseIIEnzGlu_APAP + APAP);
    dstatedt[6] = 0 + 1 * internal.Vmax_PhaseIIEnzSul_APAP * APAP / (internal.Km_PhaseIIEnzSul_APAP + APAP);
    dstatedt[3] = 0 - 1 * internal.kNapqiGsh * NAPQI * GSH * internal.compartment * internal.compartment + 1 * internal.kGsh * (internal.GSHmax - GSH) * internal.compartment;
    dstatedt[2] = 0 + 1 * internal.Vmax_2E1_APAP * APAP / (internal.Km_2E1_APAP + APAP) - 1 * internal.kNapqiGsh * NAPQI * GSH * internal.compartment * internal.compartment;
    dstatedt[4] = 0 + 1 * internal.kNapqiGsh * NAPQI * GSH * internal.compartment * internal.compartment;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "X1", "APAP", "NAPQI", "GSH", "NAPQIGSH", "APAPconj_Glu", "APAPconj_Sul"];
    ...
    this.metadata.variableOrder = {X1: null, APAP: null, NAPQI: null, GSH: null, NAPQIGSH: null, APAPconj_Glu: null, APAPconj_Sul: null};
