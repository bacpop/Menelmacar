export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ai", "am", "Ao", "ATP_init1", "Cac_init1", "Cam_init1", "CaR", "Cmit", "F", "fi", "fm", "G3P_init1", "Glu", "hCa", "hgl", "hp", "kACa", "KAD", "kat", "kATP", "kATPCa", "kbt", "kCaA", "KCaj", "KCam", "KgNc", "kgpd", "Klnc", "klp", "Kmadp", "KmATP", "Kmg3p", "Kmgl", "KmLD", "KmNh", "Kmph", "Kmpyr", "knadhc", "knadhm", "KNaj", "KpCam", "KPNm", "KTNc", "KTNm", "NADHc_init1", "NADHm_init1", "Nam", "Ni", "Ntc", "Ntm", "PCa", "Plb", "Plr", "PYR_init1", "Tnadh", "Tv", "u1", "u2", "Vi", "Vm_init1", "Vme", "Vmglu", "Vmgpd", "Vmldh", "Vmmit", "Vmnc", "Vmpdh", "Vmph", "ZCa"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "CaR", internal, 0.089999999999999997, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cmit", internal, 5200, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "hCa", internal, 4, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "kACa", internal, 0.25, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "KAD", internal, 25, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    var Cac = internal.CaR + internal.kACa * Math.pow((ATP * (1 / ADP)), (internal.hCa)) * (1 / (Math.pow((internal.KAD), (internal.hCa)) + Math.pow((ATP * (1 / ADP)), (internal.hCa))));
    ...
    dstatedt[5] = 0 + (Jhres + - Jph + - Jhl + - (2 * Juni) + - JNCa) * internal.F * (1 / internal.Cmit);
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "G3P", "PYR", "ATP", "NADHm", "NADHc", "Vm", "Cam"];
    this.metadata.internalOrder = {ai: null, am: null, Ao: null, ATP_init: null, ATP_init1: null, Cac_init1: null, Cam_init: null, Cam_init1: null, CaR: null, Cmit: null, compartment: null, F: null, fi: null, fm: null, G3P_init: null, G3P_init1: null, Glu: null, hCa: null, hgl: null, hp: null, initial_ATP: null, initial_Cam: null, initial_G3P: null, initial_NADHc: null, initial_NADHm: null, initial_PYR: null, initial_Vm: null, kACa: null, KAD: null, kat: null, kATP: null, kATPCa: null, kbt: null, kCaA: null, KCaj: null, KCam: null, KgNc: null, kgpd: null, Klnc: null, klp: null, Kmadp: null, KmATP: null, Kmg3p: null, Kmgl: null, KmLD: null, KmNh: null, Kmph: null, Kmpyr: null, knadhc: null, knadhm: null, KNaj: null, KpCam: null, KPNm: null, KTNc: null, KTNm: null, NADHc_init: null, NADHc_init1: null, NADHm_init: null, NADHm_init1: null, Nam: null, Ni: null, Ntc: null, Ntm: null, PCa: null, Plb: null, Plr: null, PYR_init: null, PYR_init1: null, Tnadh: null, Tv: null, u1: null, u2: null, Vi: null, Vm_init: null, Vm_init1: null, Vme: null, Vmglu: null, Vmgpd: null, Vmldh: null, Vmmit: null, Vmnc: null, Vmpdh: null, Vmph: null, ZCa: null};
    this.metadata.variableOrder = {G3P: null, PYR: null, ATP: null, NADHm: null, NADHc: null, Vm: null, Cam: null};
