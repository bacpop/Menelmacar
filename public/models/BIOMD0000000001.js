export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "AL_init", "ALL_init", "B_init", "BL_init", "BLL_init", "D_init", "DL_init", "DLL_init", "I_init", "IL_init", "ILL_init", "kf_10", "kf_11", "kf_14", "kf_15", "kf_16", "kf_2", "kf_5", "kf_6", "kf_9", "kr_0", "kr_1", "kr_10", "kr_11", "kr_12", "kr_13", "kr_14", "kr_15", "kr_16", "kr_2", "kr_3", "kr_4", "kr_5", "kr_6", "kr_7", "kr_8", "kr_9", "t2"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "B_init", internal, 1.6605778811026201e-21, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "t2", internal, 20, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const I = state[10];
    const ALL = state[11];
    var kf_0 = (t > internal.t2 ? 0 : 3000);
    var kf_1 = (t > internal.t2 ? 0 : 1500);
    var kf_12 = (t > internal.t2 ? 0 : 3000);
    var kf_13 = (t > internal.t2 ? 0 : 1500);
    var kf_3 = (t > internal.t2 ? 0 : 3000);
    var kf_4 = (t > internal.t2 ? 0 : 1500);
    var kf_7 = (t > internal.t2 ? 0 : 3000);
    var kf_8 = (t > internal.t2 ? 0 : 1500);
    dstatedt[3] = 0 - 1 * internal.comp1 * (kf_3 * A - internal.kr_3 * AL) + 1 * internal.comp1 * (internal.kf_5 * B - internal.kr_5 * A) - 1 * internal.comp1 * (internal.kf_9 * A - internal.kr_9 * I);
    dstatedt[2] = 0 + 1 * internal.comp1 * (kf_3 * A - internal.kr_3 * AL) - 1 * internal.comp1 * (kf_4 * AL - internal.kr_4 * ALL) + 1 * internal.comp1 * (internal.kf_6 * BL - internal.kr_6 * AL) - 1 * internal.comp1 * (internal.kf_10 * AL - internal.kr_10 * IL);
    dstatedt[11] = 0 + 1 * internal.comp1 * (internal.kf_2 * BLL - internal.kr_2 * ALL) + 1 * internal.comp1 * (kf_4 * AL - internal.kr_4 * ALL) - 1 * internal.comp1 * (internal.kf_11 * ALL - internal.kr_11 * ILL);
    dstatedt[5] = 0 - 1 * internal.comp1 * (kf_0 * B - internal.kr_0 * BL) - 1 * internal.comp1 * (internal.kf_5 * B - internal.kr_5 * A);
    dstatedt[4] = 0 + 1 * internal.comp1 * (kf_0 * B - internal.kr_0 * BL) - 1 * internal.comp1 * (kf_1 * BL - internal.kr_1 * BLL) - 1 * internal.comp1 * (internal.kf_6 * BL - internal.kr_6 * AL);
    dstatedt[0] = 0 + 1 * internal.comp1 * (kf_1 * BL - internal.kr_1 * BLL) - 1 * internal.comp1 * (internal.kf_2 * BLL - internal.kr_2 * ALL);
    dstatedt[7] = 0 - 1 * internal.comp1 * (kf_12 * D - internal.kr_12 * DL) + 1 * internal.comp1 * (internal.kf_14 * I - internal.kr_14 * D);
    dstatedt[9] = 0 + 1 * internal.comp1 * (kf_12 * D - internal.kr_12 * DL) - 1 * internal.comp1 * (kf_13 * DL - internal.kr_13 * DLL) + 1 * internal.comp1 * (internal.kf_15 * IL - internal.kr_15 * DL);
    dstatedt[6] = 0 + 1 * internal.comp1 * (kf_13 * DL - internal.kr_13 * DLL) + 1 * internal.comp1 * (internal.kf_16 * ILL - internal.kr_16 * DLL);
    dstatedt[10] = 0 - 1 * internal.comp1 * (kf_7 * I - internal.kr_7 * IL) + 1 * internal.comp1 * (internal.kf_9 * A - internal.kr_9 * I) - 1 * internal.comp1 * (internal.kf_14 * I - internal.kr_14 * D);
    dstatedt[1] = 0 + 1 * internal.comp1 * (kf_7 * I - internal.kr_7 * IL) - 1 * internal.comp1 * (kf_8 * IL - internal.kr_8 * ILL) + 1 * internal.comp1 * (internal.kf_10 * AL - internal.kr_10 * IL) - 1 * internal.comp1 * (internal.kf_15 * IL - internal.kr_15 * DL);
    dstatedt[8] = 0 + 1 * internal.comp1 * (kf_8 * IL - internal.kr_8 * ILL) + 1 * internal.comp1 * (internal.kf_11 * ALL - internal.kr_11 * ILL) - 1 * internal.comp1 * (internal.kf_16 * ILL - internal.kr_16 * DLL);
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "BLL", "IL", "AL", "A", "BL", "B", "DLL", "D", "ILL", "DL", "I", "ALL"];
    this.metadata.internalOrder = {A_init: null, AL_init: null, ALL_init: null, B_init: null, BL_init: null, BLL_init: null, comp1: null, D_init: null, DL_init: null, DLL_init: null, I_init: null, IL_init: null, ILL_init: null, initial_A: null, initial_AL: null, initial_ALL: null, initial_B: null, initial_BL: null, initial_BLL: null, initial_D: null, initial_DL: null, initial_DLL: null, initial_I: null, initial_IL: null, initial_ILL: null, kf_10: null, kf_11: null, kf_14: null, kf_15: null, kf_16: null, kf_2: null, kf_5: null, kf_6: null, kf_9: null, kr_0: null, kr_1: null, kr_10: null, kr_11: null, kr_12: null, kr_13: null, kr_14: null, kr_15: null, kr_16: null, kr_2: null, kr_3: null, kr_4: null, kr_5: null, kr_6: null, kr_7: null, kr_8: null, kr_9: null, t2: null};
    this.metadata.variableOrder = {BLL: null, IL: null, AL: null, A: null, BL: null, B: null, DLL: null, D: null, ILL: null, DL: null, I: null, ALL: null};
