export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 + 1 * internal.nuclear * (internal.k_plxon / (1 + Math.pow((internal.ec50_plx / Cyclin_B1_Cdk1_complex_phosphorylated), (internal.n_plx))) * (internal.Plx1_total - Plx1_active)) - 1 * internal.nuclear * internal.k_plx_off * Plx1_active;
