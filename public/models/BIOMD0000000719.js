export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var Cyclin_B1_Cdk1_complex_total_init = internal.initial_Cyclin_B1_Cdk1_complex_unphosphorylated + internal.initial_Cyclin_B1_Cdk1_complex_phosphorylated;
    internal.initial_Cyclin_B1_Cdk1_complex_total = Cyclin_B1_Cdk1_complex_total_init;
    ...
    state[4] = internal.initial_Plx1_total;
    state[5] = internal.initial_APC_C_total;
    state[6] = internal.initial_Cyclin_B1_Cdk1_complex_total;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "APC_C_active_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "APC_C_total_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Cyclin_B1_Cdk1_complex_phosphorylated_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Plx1_total_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const Plx1_total = state[4];
    const APC_C_total = state[5];
    dstatedt[5] = 0;
    dstatedt[6] = 0 + 0;
    dstatedt[4] = 0;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Cyclin_B1_Cdk1_complex_phosphorylated", "Cyclin_B1_Cdk1_complex_unphosphorylated", "Plx1_active", "APC_C_active", "Plx1_total", "APC_C_total", "Cyclin_B1_Cdk1_complex_total"];
    this.metadata.internalOrder = {APC_C_active_init: null, APC_C_total_init: null, Cyclin_B1_Cdk1_complex_phosphorylated_init: null, Cyclin_B1_Cdk1_complex_unphosphorylated_init: null, ec50_apc: null, ec50_cdc25: null, ec50_plx: null, ec50_wee1: null, initial_APC_C_active: null, initial_APC_C_total: null, initial_Cyclin_B1_Cdk1_complex_phosphorylated: null, initial_Cyclin_B1_Cdk1_complex_total: null, initial_Cyclin_B1_Cdk1_complex_unphosphorylated: null, initial_Plx1_active: null, initial_Plx1_total: null, k_apc_off: null, k_apc_on: null, k_cdk1_off: null, k_cdk1_on: null, k_dest: null, k_plx_off: null, k_plxon: null, k_synth: null, n_apc: null, n_cdc25: null, n_plx: null, n_wee1: null, nuclear: null, p: null, Plx1_active_init: null, Plx1_total_init: null, tau: null};
    this.metadata.variableOrder = {Cyclin_B1_Cdk1_complex_phosphorylated: null, Cyclin_B1_Cdk1_complex_unphosphorylated: null, Plx1_active: null, APC_C_active: null, Plx1_total: null, APC_C_total: null, Cyclin_B1_Cdk1_complex_total: null};
