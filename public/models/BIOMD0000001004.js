export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.k1 = 0.062700000000000006;
    internal.v = 1.0222;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["FOXP3mRNA_init", "FOXP3prot_star_init", "IL6ext_init", "IL6int_init", "RORgtmRNA_init", "STAT3mRNA_init", "STAT3prot_init", "STAT3prot_star_init", "TGFbext_init", "TGFbint_init"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "FOXP3mRNA_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "FOXP3prot_star_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IL6ext_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "IL6int_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "RORgtmRNA_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "STAT3mRNA_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "STAT3prot_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "STAT3prot_star_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "TGFbext_init", internal, 0, -Infinity, Infinity, false);
