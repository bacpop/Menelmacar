export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["IkBd_init", "IkBd_NIK_init", "k1", "k2", "NIK_init", "p100_init", "p100_NIK_init", "p52_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.compartment * internal.k1 * internal.p100t - 1 * internal.compartment * internal.k1 * p100 - 2 * internal.compartment * (internal.k1 * Math.pow((p100), (2)) - internal.k2 * IkBd) - 1 * internal.compartment * (internal.k1 * p100 * NIK - internal.k2 * p100_NIK);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "p100", "p52", "NIK", "IkBd", "IkBd_NIK", "p100_NIK"];
    this.metadata.internalOrder = {compartment: null, IkBd_init: null, IkBd_NIK_init: null, initial_IkBd: null, initial_IkBd_NIK: null, initial_NIK: null, initial_p100: null, initial_p100_NIK: null, initial_p52: null, k1: null, k2: null, NIK_init: null, p100_init: null, p100_NIK_init: null, p100t: null, p52_init: null};
    this.metadata.variableOrder = {p100: null, p52: null, NIK: null, IkBd: null, IkBd_NIK: null, p100_NIK: null};
