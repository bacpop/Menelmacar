export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Act_C_Cyt_init", internal, 9.0999999999999993e-06, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Act_C_Nuc_init", internal, 5.0500000000000001e-05, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ca_Cyt_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ca_Nuc_init", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Inact_C_Cyt_init", internal, 0.0097108000000000003, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Inact_C_Nuc_init", internal, 0.049197999999999999, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "NFAT_Act_C_Cyt_init", internal, 6.1e-06, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Act_C_Nuc_init", internal, 0.0009477, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Cyt_init", internal, 0.00011010000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Nuc_init", internal, 0.00052189999999999995, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Pi_Act_C_Cyt_init", internal, 2.2000000000000001e-06, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Pi_Act_C_Nuc_init", internal, 2.5000000000000002e-06, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Pi_Cyt_init", internal, 0.0094397000000000005, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "NFAT_Pi_Nuc_init", internal, 0.00022719999999999999, -Infinity, Infinity, false);
