export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "ctp_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d", internal, 0.10000000000000001, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "dho_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "omp_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "oro_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "ump_init", internal, 0, -Infinity, Infinity, false);
