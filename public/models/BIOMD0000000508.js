export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ad_init", "addash", "ae", "af", "alpha", "atp_init", "ax", "ca_init", "cabasil", "d_init", "datpp", "dcon_init", "dcrit", "ddd", "dee", "delta_init", "dip", "dist", "dxx", "e_init", "f", "g", "gamma", "gf", "gstar_init", "ip3_init", "ip30", "ip3con_init", "ip3min", "ka", "kd", "kdeg", "kg_init", "kkdeg", "kr", "krel", "kxk", "m", "n", "p1", "p2", "p3", "p4", "p5", "pd", "pe", "ps", "px", "qd", "qe", "qx", "r_init", "rhstar", "ro_init", "rs_init", "rt", "scale", "smoothness", "vatp_s", "vdeg", "x_init", "y_init", "ymax", "yo"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "dcon_init", internal, 0, -Infinity, Infinity, false);
    ...
    internal.initial_dcon = internal.dcon_init;
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {ad_init: null, addash: null, ae: null, af: null, alpha: null, atp_init: null, ax: null, ca_init: null, cabasil: null, cell: null, d_init: null, datpp: null, dcon_init: null, dcrit: null, ddd: null, dee: null, delta_init: null, dip: null, dist: null, dxx: null, e_init: null, f: null, g: null, gamma: null, gf: null, gstar_init: null, initial_ad: null, initial_atp: null, initial_ca: null, initial_d: null, initial_dcon: null, initial_delta: null, initial_e: null, initial_gstar: null, initial_ip3: null, initial_ip3con: null, initial_kg: null, initial_r: null, initial_ro: null, initial_rs: null, initial_x: null, initial_y: null, ip3_init: null, ip30: null, ip3con_init: null, ip3min: null, ka: null, kd: null, kdeg: null, kg_init: null, kkdeg: null, kr: null, krel: null, kxk: null, m: null, n: null, p1: null, p2: null, p3: null, p4: null, p5: null, pd: null, pe: null, ps: null, px: null, qd: null, qe: null, qx: null, r_init: null, rhstar: null, ro_init: null, rs_init: null, rt: null, scale: null, smoothness: null, vatp_s: null, vdeg: null, x_init: null, y_init: null, ymax: null, yo: null};
