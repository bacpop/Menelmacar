export class model {
  ...
  initial(t) {
    ...
    state[3] = internal.initial_GATA6_Gene;
    state[4] = internal.initial_CDX2_Gene;
    state[5] = internal.initial_GCNF_Gene;
    state[6] = internal.initial_targetGene;
    state[7] = internal.initial_degradation;
    state[8] = internal.initial_p53;
    state[9] = internal.initial_A;
    state[10] = internal.initial_OCT4;
    state[11] = internal.initial_SOX2;
    state[12] = internal.initial_NANOG;
    state[13] = internal.initial_GATA6;
    state[14] = internal.initial_CDX2;
    state[15] = internal.initial_GCNF;
    state[16] = internal.initial_OCT4_SOX2;
    state[17] = internal.initial_Protein;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "a0", "a1", "a2", "a3", "b0", "b1", "b2", "b3", "b4", "b5", "c0", "c1", "c2", "CDX2_Gene_init", "CDX2_init", "d0", "d1", "d2", "d3", "degradation_init", "e0", "e1", "e2", "f0", "f1", "f2", "f3", "g0", "g1", "gamma1", "gamma2", "gamma3", "gamma4", "gamma5", "gammag", "gamman", "GATA6_Gene_init", "GATA6_init", "GCNF_Gene_init", "GCNF_init", "h0", "h1", "i0", "i1", "i2", "j0", "j1", "NANOG_Gene_init", "NANOG_init", "OCT4_Gene_init", "OCT4_init", "OCT4_SOX2_init", "p0", "p1", "p2", "p53_init", "Protein_init", "q0", "q1", "q2", "SOX2_Gene_init", "SOX2_init", "targetGene_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "CDX2_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "GATA6_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "GCNF_Gene_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "GCNF_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const OCT4 = state[10];
    const SOX2 = state[11];
    const NANOG = state[12];
    const GATA6 = state[13];
    const CDX2 = state[14];
    const GCNF = state[15];
    const OCT4_SOX2 = state[16];
    dstatedt[9] = 0;
    dstatedt[4] = 0;
    dstatedt[7] = 0;
    dstatedt[3] = 0;
    ...
    dstatedt[2] = 0;
    dstatedt[6] = 0;
    dstatedt[14] = 0 + 1 * (internal.g0 + internal.g1 * CDX2) / (1 + internal.h0 * CDX2 + internal.h1 * CDX2 * OCT4) - 1 * internal.gamma4 * CDX2;
    dstatedt[13] = 0 + 1 * (internal.c1 * OCT4_SOX2 + internal.c2 * GATA6) / (1 + internal.d1 * OCT4_SOX2 + internal.d2 * GATA6 + internal.d3 * NANOG) - 1 * internal.gammag * GATA6;
    dstatedt[15] = 0 + 1 * (internal.i0 + internal.i1 * CDX2 + internal.i2 * GATA6) / (1 + internal.j0 * CDX2 + internal.j1 * GATA6) - 1 * internal.gamma5 * GCNF;
    dstatedt[12] = 0 + 1 * (internal.a1 * OCT4_SOX2 + internal.a2 * OCT4_SOX2 * NANOG) / (1 + internal.b1 * OCT4_SOX2 + internal.b2 * OCT4_SOX2 * NANOG + internal.b3 * OCT4_SOX2 * GATA6) - 1 * internal.gamman * NANOG;
    dstatedt[10] = 0 + 1 * (internal.a0 + internal.a1 * A + internal.a2 * OCT4 * SOX2 + internal.a3 * OCT4 * SOX2 * NANOG) / (1 + internal.b0 * A + internal.b1 * OCT4 + internal.b2 * OCT4 * SOX2 + internal.b3 * OCT4 * SOX2 * NANOG + internal.b4 * CDX2 * OCT4 + internal.b5 * GCNF) - 1 * internal.gamma1 * OCT4;
    dstatedt[11] = 0 + 1 * (internal.c0 + internal.c1 * OCT4 * SOX2 + internal.c2 * OCT4 * SOX2 * NANOG) / (1 + internal.d0 * OCT4 + internal.d1 * OCT4 * SOX2 + internal.d2 * OCT4 * SOX2 * NANOG) - 1 * internal.gamma2 * SOX2;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "OCT4_Gene", "NANOG_Gene", "SOX2_Gene", "GATA6_Gene", "CDX2_Gene", "GCNF_Gene", "targetGene", "degradation", "p53", "A", "OCT4", "SOX2", "NANOG", "GATA6", "CDX2", "GCNF", "OCT4_SOX2", "Protein"];
    this.metadata.internalOrder = {A_init: null, a0: null, a1: null, a2: null, a3: null, b0: null, b1: null, b2: null, b3: null, b4: null, b5: null, c0: null, c1: null, c2: null, CDX2_Gene_init: null, CDX2_init: null, cell: null, d0: null, d1: null, d2: null, d3: null, degradation_init: null, e0: null, e1: null, e2: null, f0: null, f1: null, f2: null, f3: null, g0: null, g1: null, gamma1: null, gamma2: null, gamma3: null, gamma4: null, gamma5: null, gammag: null, gamman: null, GATA6_Gene_init: null, GATA6_init: null, GCNF_Gene_init: null, GCNF_init: null, h0: null, h1: null, i0: null, i1: null, i2: null, initial_A: null, initial_CDX2: null, initial_CDX2_Gene: null, initial_degradation: null, initial_GATA6: null, initial_GATA6_Gene: null, initial_GCNF: null, initial_GCNF_Gene: null, initial_NANOG: null, initial_NANOG_Gene: null, initial_OCT4: null, initial_OCT4_Gene: null, initial_OCT4_SOX2: null, initial_p53: null, initial_Protein: null, initial_SOX2: null, initial_SOX2_Gene: null, initial_targetGene: null, j0: null, j1: null, NANOG_Gene_init: null, NANOG_init: null, OCT4_Gene_init: null, OCT4_init: null, OCT4_SOX2_init: null, p0: null, p1: null, p2: null, p53_init: null, Protein_init: null, q0: null, q1: null, q2: null, SOX2_Gene_init: null, SOX2_init: null, targetGene_init: null};
    this.metadata.variableOrder = {OCT4_Gene: null, NANOG_Gene: null, SOX2_Gene: null, GATA6_Gene: null, CDX2_Gene: null, GCNF_Gene: null, targetGene: null, degradation: null, p53: null, A: null, OCT4: null, SOX2: null, NANOG: null, GATA6: null, CDX2: null, GCNF: null, OCT4_SOX2: null, Protein: null};
