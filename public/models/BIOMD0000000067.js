export class model {
  ...
  initial(t) {
    ...
    state[7] = internal.initial_HOAc_E;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["AcCoA_init", "AcP_init", "Acs_init", "alpha0", "alpha1", "alpha2", "alpha3", "C", "H", "HOAc_E_init", "HOAc_init", "k1", "k2", "k3", "kAck_f", "kAck_r", "kd", "Keq", "Kg1", "Kg2", "Kg3", "KM1", "KM2", "kTCA", "LacI_init", "n", "OAc_init", "Pta_init", "S0"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "HOAc_E_init", internal, 0, -Infinity, Infinity, false);
    ...
    internal.initial_HOAc_E = internal.HOAc_E_init;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0 - 1 * internal.compartment * internal.k3 * (HOAc - HOAc_E) + 1 * internal.compartment * internal.C * (OAc * internal.H - internal.Keq * HOAc);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "AcCoA", "AcP", "OAc", "HOAc", "LacI", "Acs", "Pta", "HOAc_E"];
    this.metadata.internalOrder = {AcCoA_init: null, AcP_init: null, Acs_init: null, alpha0: null, alpha1: null, alpha2: null, alpha3: null, C: null, compartment: null, H: null, HOAc_E_init: null, HOAc_init: null, initial_AcCoA: null, initial_AcP: null, initial_Acs: null, initial_HOAc: null, initial_HOAc_E: null, initial_LacI: null, initial_OAc: null, initial_Pta: null, k1: null, k2: null, k3: null, kAck_f: null, kAck_r: null, kd: null, Keq: null, Kg1: null, Kg2: null, Kg3: null, KM1: null, KM2: null, kTCA: null, LacI_init: null, n: null, OAc_init: null, Pta_init: null, S0: null};
    this.metadata.variableOrder = {AcCoA: null, AcP: null, OAc: null, HOAc: null, LacI: null, Acs: null, Pta: null, HOAc_E: null};
