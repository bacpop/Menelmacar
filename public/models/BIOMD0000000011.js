export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a1", "a10", "a2", "a3", "a4", "a5", "a6", "a7", "a8", "a9", "d1", "d10", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9", "k1", "k10", "k2", "k3", "k4", "k5", "k6", "k7", "k8", "k9", "MAPK_init", "MAPKMEKpp_init", "MAPKp_init", "MAPKPH_init", "MAPKpMAPKPH_init", "MAPKpMEKpp_init", "MAPKpp_init", "MAPKppMAPKPH_init", "MEK_init", "MEKp_init", "MEKPH_init", "MEKpMEKPH_init", "MEKpp_init", "MEKppMEKPH_init", "MEKpRAFp_init", "MEKRAFp_init", "RAF_init", "RAFK_init", "RAFp_init", "RAFPH_init", "RAFpRAFPH_init", "RAFRAFK_init"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "a1", internal, 1, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a10", internal, 5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a2", internal, 0.5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a3", internal, 3.2999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a4", internal, 10, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a5", internal, 3.2999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a6", internal, 10, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a7", internal, 20, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a8", internal, 5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "a9", internal, 20, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d1", internal, 0.40000000000000002, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d10", internal, 0.40000000000000002, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d2", internal, 0.5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d3", internal, 0.41999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d4", internal, 0.80000000000000004, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d5", internal, 0.40000000000000002, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d6", internal, 0.80000000000000004, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d7", internal, 0.59999999999999998, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "d8", internal, 0.40000000000000002, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 - 1 * internal.a7 * MAPK * MEKpp + 1 * internal.d7 * MAPKMEKpp + 1 * internal.k8 * MAPKpMAPKPH;
    dstatedt[1] = 0 + 1 * internal.a7 * MAPK * MEKpp - 1 * internal.d7 * MAPKMEKpp - 1 * internal.k7 * MAPKMEKpp;
    dstatedt[2] = 0 + 1 * internal.k7 * MAPKMEKpp - 1 * internal.a8 * MAPKp * MAPKPH + 1 * internal.d8 * MAPKpMAPKPH - 1 * internal.a9 * MAPKp * MEKpp + 1 * internal.d9 * MAPKpMEKpp + 1 * internal.k10 * MAPKppMAPKPH;
    dstatedt[3] = 0 - 1 * internal.a8 * MAPKp * MAPKPH + 1 * internal.d8 * MAPKpMAPKPH + 1 * internal.k8 * MAPKpMAPKPH - 1 * internal.a10 * MAPKPH * MAPKpp + 1 * internal.d10 * MAPKppMAPKPH + 1 * internal.k10 * MAPKppMAPKPH;
    dstatedt[4] = 0 + 1 * internal.a8 * MAPKp * MAPKPH - 1 * internal.d8 * MAPKpMAPKPH - 1 * internal.k8 * MAPKpMAPKPH;
    dstatedt[5] = 0 + 1 * internal.a9 * MAPKp * MEKpp - 1 * internal.d9 * MAPKpMEKpp - 1 * internal.k9 * MAPKpMEKpp;
    dstatedt[6] = 0 + 1 * internal.k9 * MAPKpMEKpp - 1 * internal.a10 * MAPKPH * MAPKpp + 1 * internal.d10 * MAPKppMAPKPH;
    dstatedt[7] = 0 + 1 * internal.a10 * MAPKPH * MAPKpp - 1 * internal.d10 * MAPKppMAPKPH - 1 * internal.k10 * MAPKppMAPKPH;
    dstatedt[8] = 0 - 1 * internal.a3 * MEK * RAFp + 1 * internal.d3 * MEKRAFp + 1 * internal.k4 * MEKpMEKPH;
    dstatedt[9] = 0 + 1 * internal.k3 * MEKRAFp - 1 * internal.a4 * MEKp * MEKPH + 1 * internal.d4 * MEKpMEKPH - 1 * internal.a5 * MEKp * RAFp + 1 * internal.d5 * MEKpRAFp + 1 * internal.k6 * MEKppMEKPH;
    dstatedt[10] = 0 - 1 * internal.a4 * MEKp * MEKPH + 1 * internal.d4 * MEKpMEKPH + 1 * internal.k4 * MEKpMEKPH - 1 * internal.a6 * MEKPH * MEKpp + 1 * internal.d6 * MEKppMEKPH + 1 * internal.k6 * MEKppMEKPH;
    dstatedt[11] = 0 + 1 * internal.a4 * MEKp * MEKPH - 1 * internal.d4 * MEKpMEKPH - 1 * internal.k4 * MEKpMEKPH;
    dstatedt[12] = 0 + 1 * internal.k5 * MEKpRAFp - 1 * internal.a6 * MEKPH * MEKpp + 1 * internal.d6 * MEKppMEKPH - 1 * internal.a7 * MAPK * MEKpp + 1 * internal.d7 * MAPKMEKpp + 1 * internal.k7 * MAPKMEKpp - 1 * internal.a9 * MAPKp * MEKpp + 1 * internal.d9 * MAPKpMEKpp + 1 * internal.k9 * MAPKpMEKpp;
    dstatedt[13] = 0 + 1 * internal.a6 * MEKPH * MEKpp - 1 * internal.d6 * MEKppMEKPH - 1 * internal.k6 * MEKppMEKPH;
    dstatedt[14] = 0 + 1 * internal.a5 * MEKp * RAFp - 1 * internal.d5 * MEKpRAFp - 1 * internal.k5 * MEKpRAFp;
    dstatedt[15] = 0 + 1 * internal.a3 * MEK * RAFp - 1 * internal.d3 * MEKRAFp - 1 * internal.k3 * MEKRAFp;
    dstatedt[16] = 0 - 1 * internal.a1 * RAF * RAFK + 1 * internal.d1 * RAFRAFK + 1 * internal.k2 * RAFpRAFPH;
    dstatedt[17] = 0 - 1 * internal.a1 * RAF * RAFK + 1 * internal.d1 * RAFRAFK + 1 * internal.k1 * RAFRAFK;
    dstatedt[18] = 0 + 1 * internal.k1 * RAFRAFK - 1 * internal.a2 * RAFp * RAFPH + 1 * internal.d2 * RAFpRAFPH - 1 * internal.a3 * MEK * RAFp + 1 * internal.d3 * MEKRAFp + 1 * internal.k3 * MEKRAFp - 1 * internal.a5 * MEKp * RAFp + 1 * internal.d5 * MEKpRAFp + 1 * internal.k5 * MEKpRAFp;
    dstatedt[19] = 0 - 1 * internal.a2 * RAFp * RAFPH + 1 * internal.d2 * RAFpRAFPH + 1 * internal.k2 * RAFpRAFPH;
    dstatedt[20] = 0 + 1 * internal.a2 * RAFp * RAFPH - 1 * internal.d2 * RAFpRAFPH - 1 * internal.k2 * RAFpRAFPH;
    dstatedt[21] = 0 + 1 * internal.a1 * RAF * RAFK - 1 * internal.d1 * RAFRAFK - 1 * internal.k1 * RAFRAFK;
  }
  names() {
