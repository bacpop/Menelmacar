export class model {
  ...
  initial(t) {
    var internal = this.internal;
    var Cyc_total_init = internal.initial_Xic_PCdk2_CycE + internal.initial_Xic_Cdk2_CycE + internal.initial_Xic_PCdk2_CycErem + internal.initial_Xic_Cdk2_CycErem + internal.initial_PCdk2_CycErem + internal.initial_Cdk2_CycErem + internal.initial_Cdk2_CycE + internal.initial_PCdk2_CycE;
    var Xic_total_init = (internal.initial_Xic + internal.initial_Xic_PCdk2_CycE + internal.initial_Xic_Cdk2_CycE + internal.initial_Xic_PCdk2_CycErem + internal.initial_Xic_Cdk2_CycErem + internal.initial_Xicrem) / 3;
    internal.initial_Cyc_total = Cyc_total_init;
    internal.initial_Xic_total = Xic_total_init;
    ...
    state[3] = internal.initial_Wee1_total;
    state[4] = internal.initial_Cdk2_CycErem;
    state[5] = internal.initial_PCdk2_CycErem;
    state[6] = internal.initial_Deg_a;
    state[7] = internal.initial_Xic;
    state[8] = internal.initial_Xic_Cdk2_CycE;
    state[9] = internal.initial_Xic_PCdk2_CycE;
    state[10] = internal.initial_Xic_Cdk2_CycErem;
    state[11] = internal.initial_Xic_PCdk2_CycErem;
    state[12] = internal.initial_Xicrem;
    state[13] = internal.initial_Cyc_total;
    state[14] = internal.initial_Xic_total;
    state[15] = internal.initial_Kin_a;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Cdk2_CycE_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Kin_a_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "PCdk2_CycE_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Wee1_a_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Xic_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    const Wee1_total = state[3];
    const Cdk2_CycErem = state[4];
    const PCdk2_CycErem = state[5];
    const Deg_a = state[6];
    const Xic = state[7];
    const Xic_Cdk2_CycE = state[8];
    const Xic_PCdk2_CycE = state[9];
    const Xic_Cdk2_CycErem = state[10];
    const Xic_PCdk2_CycErem = state[11];
    const Xicrem = state[12];
    const Kin_a = state[15];
    dstatedt[13] = 0 + 0;
    dstatedt[3] = 0;
    dstatedt[14] = 0 + 0;
    dstatedt[15] = 0 + 1 * internal.compartment * (internal.kiact * (1 - Kin_a) / (internal.Jiact + 1 - Kin_a) - internal.kiinact * Cdk2_CycE * Kin_a / (internal.Jiinact + Kin_a));
    ...
    dstatedt[7] = 0 - 1 * internal.compartment * internal.kassoc * Xic * Cdk2_CycE - 1 * internal.compartment * internal.kassoc * Xic * Cdk2_CycErem + 1 * internal.compartment * internal.kdissoc * Xic_Cdk2_CycE + 1 * internal.compartment * internal.kdissoc * Xic_Cdk2_CycErem - 1 * internal.compartment * internal.kassoc * Xic * PCdk2_CycE - 1 * internal.compartment * internal.kassoc * Xic * PCdk2_CycErem + 1 * internal.compartment * internal.kdissoc * Xic_PCdk2_CycE + 1 * internal.compartment * internal.kdissoc * Xic_PCdk2_CycErem;
    dstatedt[12] = 0 + 1 * internal.compartment * (internal.kedeg * Xic_PCdk2_CycErem * Deg_a) + 1 * internal.compartment * (internal.kedeg * Xic_Cdk2_CycErem * Deg_a) - 1 * internal.compartment * internal.kxdeg * Xicrem;
    ...
    dstatedt[4] = 0 - 1 * internal.compartment * internal.kassoc * Xic * Cdk2_CycErem + 1 * internal.compartment * internal.kdissoc * Xic_Cdk2_CycErem - 1 * internal.compartment * internal.koff * Cdk2_CycErem + 1 * internal.compartment * (internal.kon * phi * Cdk2_CycE) + 1 * internal.compartment * internal.kxdeg * Xic_Cdk2_CycErem - 1 * internal.compartment * (internal.kedeg * Cdk2_CycErem * Deg_a);
    dstatedt[6] = 0 + 1 * internal.compartment * (internal.kdact * Heav);
    ...
    dstatedt[5] = 0 - 1 * internal.compartment * internal.koff * PCdk2_CycErem + 1 * internal.compartment * (internal.kon * phi * PCdk2_CycE) + 1 * internal.compartment * internal.kxdeg * Xic_PCdk2_CycErem - 1 * internal.compartment * internal.kassoc * Xic * PCdk2_CycErem + 1 * internal.compartment * internal.kdissoc * Xic_PCdk2_CycErem - 1 * internal.compartment * (internal.kedeg * PCdk2_CycErem * Deg_a);
    dstatedt[8] = 0 + 1 * internal.compartment * internal.kassoc * Xic * Cdk2_CycE - 1 * internal.compartment * internal.kdissoc * Xic_Cdk2_CycE + 1 * internal.compartment * internal.k25A * Xic_PCdk2_CycE - 1 * internal.compartment * (internal.kwee * Wee1_a * Xic_Cdk2_CycE) + 1 * internal.compartment * internal.koff * Xic_Cdk2_CycErem - 1 * internal.compartment * (internal.kon * phi * Xic_Cdk2_CycE);
    dstatedt[10] = 0 + 1 * internal.compartment * internal.kassoc * Xic * Cdk2_CycErem - 1 * internal.compartment * internal.kdissoc * Xic_Cdk2_CycErem - 1 * internal.compartment * internal.kxdeg * Xic_Cdk2_CycErem - 1 * internal.compartment * (internal.kedeg * Xic_Cdk2_CycErem * Deg_a) - 1 * internal.compartment * internal.koff * Xic_Cdk2_CycErem + 1 * internal.compartment * (internal.kon * phi * Xic_Cdk2_CycE);
    dstatedt[9] = 0 - 1 * internal.compartment * internal.k25A * Xic_PCdk2_CycE + 1 * internal.compartment * (internal.kwee * Wee1_a * Xic_Cdk2_CycE) + 1 * internal.compartment * internal.kassoc * Xic * PCdk2_CycE - 1 * internal.compartment * internal.kdissoc * Xic_PCdk2_CycE + 1 * internal.compartment * internal.koff * Xic_PCdk2_CycErem - 1 * internal.compartment * (internal.kon * phi * Xic_PCdk2_CycE);
    dstatedt[11] = 0 - 1 * internal.compartment * internal.kxdeg * Xic_PCdk2_CycErem - 1 * internal.compartment * (internal.kedeg * Xic_PCdk2_CycErem * Deg_a) + 1 * internal.compartment * internal.kassoc * Xic * PCdk2_CycErem - 1 * internal.compartment * internal.kdissoc * Xic_PCdk2_CycErem - 1 * internal.compartment * internal.koff * Xic_PCdk2_CycErem + 1 * internal.compartment * (internal.kon * phi * Xic_PCdk2_CycE);
  }
  names() {
