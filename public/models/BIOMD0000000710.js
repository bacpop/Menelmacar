export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["a_I", "delta_H", "delta_I", "delta_IFN", "delta_K", "delta_R", "delta_V", "IFN_init", "k_E", "k_I", "K_init", "k_R", "p_V", "phi_K", "q_K", "U_E_init", "U_H_init", "U_I_init", "U_R_init", "V_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    var Metabolite_0_0 = U_H;
    var Metabolite_6_0 = K;
    var S_H = Metabolite_0_0 * internal.delta_H;
    var S_K = Metabolite_6_0 * internal.delta_K;
    dstatedt[6] = 0 + 1 * internal.compartment * (S_K) + 1 * internal.compartment * (internal.phi_K * U_I) - 1 * internal.compartment * internal.delta_K * K;
    dstatedt[0] = 0 + 1 * internal.compartment * (S_H) - 1 * internal.compartment * (internal.k_I * U_H * V) - 1 * internal.compartment * (internal.k_R * U_H * IFN) - 1 * internal.compartment * internal.delta_H * U_H;
  }
  names() {
