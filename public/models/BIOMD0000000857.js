export class model {
  ...
  initial(t) {
    ...
    state[8] = internal.initial_ECO2;
    state[9] = internal.initial_Estarch;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ECO2_init", "Enitrate_init", "Ephe_init", "Estarch_init", "EtrioseP_init", "g", "k1", "k10", "k11", "k12", "k13", "k14", "k15", "k2", "k26", "k27", "k28", "k29", "k3", "k30", "k31", "k32", "k33", "k34", "k35", "k36", "k37", "k38", "k39", "k4", "k5", "k6", "k7", "k8", "k9", "N_init", "Next_init", "starch_init", "sucr_init", "trioseP_init"], unusedUserAction);
    var internal = this.internal;
    this.base.user.setUserScalar(user, "ECO2_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Enitrate_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ephe_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Estarch_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "EtrioseP_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Next_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "starch_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "sucr_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "trioseP_init", internal, 0, -Infinity, Infinity, false);
    internal.initial_ECO2 = internal.ECO2_init;
  ...
  rhs(t, state, dstatedt) {
    ...
    const ECO2 = state[8];
    const Estarch = state[9];
    dstatedt[8] = 0;
    dstatedt[6] = 0 + 1 * internal.compartment * (internal.k26) - 1 * internal.compartment * (internal.k27 * N * Enitrate / (internal.k28 + Enitrate));
    dstatedt[9] = 0 + 1 * internal.compartment * (internal.k34) - 1 * internal.compartment * (internal.k35 * sucr * Estarch / (internal.k36 + Estarch));
    ...
    dstatedt[7] = 0 - 1 * internal.compartment * (internal.k4 * EtrioseP * trioseP) - 1 * internal.compartment * internal.k10 * trioseP + 1 * internal.compartment * (internal.k29 * f_act_trioseP * ECO2);
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "sucr", "EtrioseP", "Ephe", "N", "starch", "Next", "Enitrate", "trioseP", "ECO2", "Estarch"];
    this.metadata.internalOrder = {compartment: null, ECO2_init: null, Enitrate_init: null, Ephe_init: null, Estarch_init: null, EtrioseP_init: null, g: null, initial_ECO2: null, initial_Enitrate: null, initial_Ephe: null, initial_Estarch: null, initial_EtrioseP: null, initial_N: null, initial_Next: null, initial_starch: null, initial_sucr: null, initial_trioseP: null, k1: null, k10: null, k11: null, k12: null, k13: null, k14: null, k15: null, k2: null, k26: null, k27: null, k28: null, k29: null, k3: null, k30: null, k31: null, k32: null, k33: null, k34: null, k35: null, k36: null, k37: null, k38: null, k39: null, k4: null, k5: null, k6: null, k7: null, k8: null, k9: null, N_init: null, Next_init: null, starch_init: null, sucr_init: null, trioseP_init: null};
    this.metadata.variableOrder = {sucr: null, EtrioseP: null, Ephe: null, N: null, starch: null, Next: null, Enitrate: null, trioseP: null, ECO2: null, Estarch: null};
