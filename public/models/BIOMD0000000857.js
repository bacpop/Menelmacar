export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "ECO2_init", internal, 1, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "sucr", "EtrioseP", "Ephe", "N", "starch", "Next", "Enitrate", "trioseP", "Estarch", "ECO2"];
    ...
    this.metadata.variableOrder = {sucr: null, EtrioseP: null, Ephe: null, N: null, starch: null, Next: null, Enitrate: null, trioseP: null, Estarch: null, ECO2: null};
