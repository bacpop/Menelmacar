export class model {
  ...
  initial(t) {
    ...
    state[7] = internal.initial_Vmaxodc;
    state[8] = internal.initial_Vmaxssat;
    state[9] = internal.initial_Vmaxsamdc;
    state[10] = internal.initial_Antz;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "aD_init", "aS_init", "C", "D_init", "Kadefflux", "Kapsamdc", "KaSpds", "Kaspms", "Kdantz", "Kdodc", "Kdsamdc", "Kdspms", "Kdssat", "Keq", "Kiasamdc", "Kiaspds", "Kiaspms", "Kidspds", "Kimetmat", "Kipodc", "Kissamdc", "Kisspms", "Kmaccoassat", "Kmadpao", "Kmaspao", "Kmcoassat", "Kmdpao", "Kmdssat", "Kmmat", "Kmodc", "Kmsamdc", "Kmspao", "Kmsssat", "Kpefflux", "Kpspds", "Ksantz", "Ksodc", "Kssamdc", "Ksssat", "P_init", "R", "S_init", "SAM_init", "Vmmat", "Vmpao", "Vmspds", "Vmspms"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    const aS = state[5];
    const aD = state[6];
    const Vmaxodc = state[7];
    const Vmaxssat = state[8];
    const Vmaxsamdc = state[9];
    const Antz = state[10];
    ...
    dstatedt[6] = 0 + 1 * internal.cytosol * (Vmaxssat * D * internal.AcCoA / (internal.Kmdssat * (1 + S / internal.Kmsssat) * internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) + internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) * D + internal.Kmdssat * (1 + S / internal.Kmsssat) * internal.AcCoA + D * internal.AcCoA)) - 1 * internal.cytosol * (internal.Vmpao * aD / (internal.Kmadpao * (1 + aD / internal.Kmadpao + aS / internal.Kmaspao + D / internal.Kmdpao + S / internal.Kmspao))) - 1 * internal.cytosol * internal.Kadefflux * aD;
    dstatedt[10] = internal.Ksantz * (1 - 1 / (1 + internal.Keq * 0.01 * (D + S))) - internal.Kdantz * Antz;
    dstatedt[5] = 0 + 1 * internal.cytosol * (1 / internal.C * Vmaxssat * S * internal.AcCoA / (internal.Kmsssat * (1 + D / internal.Kmdssat) * internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) + internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) * S + internal.Kmsssat * (1 + D / internal.Kmdssat) * internal.AcCoA + S * internal.AcCoA)) - 1 * internal.cytosol * (internal.Vmpao * aS / (internal.Kmaspao * (1 + aD / internal.Kmadpao + aS / internal.Kmaspao + D / internal.Kmdpao + S / internal.Kmspao)));
    dstatedt[4] = 0 - 1 * internal.cytosol * (Vmaxssat * D * internal.AcCoA / (internal.Kmdssat * (1 + S / internal.Kmsssat) * internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) + internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) * D + internal.Kmdssat * (1 + S / internal.Kmsssat) * internal.AcCoA + D * internal.AcCoA)) + 1 * internal.cytosol * (internal.Vmpao * aS / (internal.Kmaspao * (1 + aD / internal.Kmadpao + aS / internal.Kmaspao + D / internal.Kmdpao + S / internal.Kmspao))) + 1 * internal.cytosol * (internal.Vmspds * A * P / (internal.Kiaspds * internal.Kpspds * (1 + D / internal.Kidspds) + internal.Kpspds * A + internal.KaSpds * (1 + D / internal.Kidspds) * P + A * P)) - 1 * internal.cytosol * (internal.Vmspms * A * D / (internal.Kiaspms * internal.Kdspms * (1 + S / internal.Kisspms) + internal.Kdspms * A + internal.Kaspms * (1 + S / internal.Kisspms) * D + A * D));
    dstatedt[2] = 0 + 1 * internal.cytosol * (Vmaxodc * internal.ORN / (internal.Kmodc * (1 + P / internal.Kipodc) + internal.ORN)) + 1 * internal.cytosol * (internal.Vmpao * aD / (internal.Kmadpao * (1 + aD / internal.Kmadpao + aS / internal.Kmaspao + D / internal.Kmdpao + S / internal.Kmspao))) - 1 * internal.cytosol * (internal.Vmspds * A * P / (internal.Kiaspds * internal.Kpspds * (1 + D / internal.Kidspds) + internal.Kpspds * A + internal.KaSpds * (1 + D / internal.Kidspds) * P + A * P)) - 1 * internal.cytosol * internal.Kpefflux * P;
    dstatedt[3] = 0 - 1 * internal.cytosol * (1 / internal.C * Vmaxssat * S * internal.AcCoA / (internal.Kmsssat * (1 + D / internal.Kmdssat) * internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) + internal.Kmaccoassat * (1 + internal.CoA / internal.Kmcoassat) * S + internal.Kmsssat * (1 + D / internal.Kmdssat) * internal.AcCoA + S * internal.AcCoA)) + 1 * internal.cytosol * (internal.Vmspms * A * D / (internal.Kiaspms * internal.Kdspms * (1 + S / internal.Kisspms) + internal.Kdspms * A + internal.Kaspms * (1 + S / internal.Kisspms) * D + A * D));
    dstatedt[0] = 0 - 1 * internal.cytosol * (Vmaxsamdc / (1 + S / internal.Kissamdc) * SAM / (internal.Kmsamdc * (1 + internal.Kapsamdc / P + A / internal.Kiasamdc) + SAM)) + 1 * internal.cytosol * (internal.Vmmat / (1 + internal.Kmmat / internal.Met * (1 + SAM / internal.Kimetmat)));
    dstatedt[7] = internal.Ksodc / (1 + internal.Keq * (D + S)) - internal.Kdodc * Antz * Vmaxodc;
    dstatedt[9] = internal.Kssamdc * (1 / (1 + internal.Keq * (D + S))) - internal.Kdsamdc * Vmaxsamdc;
    dstatedt[8] = internal.Ksssat * (1 - 1 / (1 + internal.Keq * (D + S))) - internal.Kdssat * (1 / (1 + internal.Keq * (D + S))) * Vmaxssat;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "SAM", "A", "P", "S", "D", "aS", "aD", "Vmaxodc", "Vmaxssat", "Vmaxsamdc", "Antz"];
    this.metadata.internalOrder = {A_init: null, AcCoA: null, aD_init: null, aS_init: null, C: null, CoA: null, cytosol: null, D_init: null, initial_A: null, initial_aD: null, initial_Antz: null, initial_aS: null, initial_D: null, initial_P: null, initial_S: null, initial_SAM: null, initial_Vmaxodc: null, initial_Vmaxsamdc: null, initial_Vmaxssat: null, Kaccoa: null, Kadefflux: null, Kapsamdc: null, KaSpds: null, Kaspms: null, Kcoa: null, Kdantz: null, Kdodc: null, Kdsamdc: null, Kdspms: null, Kdssat: null, Keq: null, Kiasamdc: null, Kiaspds: null, Kiaspms: null, Kidspds: null, Kimetmat: null, Kipodc: null, Kissamdc: null, Kisspms: null, Kmaccoassat: null, Kmadpao: null, Kmaspao: null, Kmcoassat: null, Kmdpao: null, Kmdssat: null, Kmmat: null, Kmodc: null, Kmsamdc: null, Kmspao: null, Kmsssat: null, Kpefflux: null, Kpspds: null, Ksantz: null, Ksodc: null, Kssamdc: null, Ksssat: null, Met: null, ORN: null, P_init: null, R: null, S_init: null, SAM_init: null, Vmmat: null, Vmpao: null, Vmspds: null, Vmspms: null};
    this.metadata.variableOrder = {SAM: null, A: null, P: null, S: null, D: null, aS: null, aD: null, Vmaxodc: null, Vmaxssat: null, Vmaxsamdc: null, Antz: null};
