export class model {
  constructor(base, user, unusedUserAction) {
    ...
    internal.Kadefflux = 0.01;
    internal.Kapsamdc = 0.5;
    internal.KaSpds = 0.29999999999999999;
    internal.Kaspms = 0.10000000000000001;
    internal.Kdspms = 60;
    internal.Kiasamdc = 2.5;
    internal.Kiaspds = 0.80000000000000004;
    internal.Kiaspms = 0.059999999999999998;
    internal.Kidspds = 100;
    internal.Kimetmat = 50;
    internal.Kipodc = 1300;
    internal.Kissamdc = 500;
    internal.Kisspms = 25;
    internal.Kmaccoassat = 1.5;
    internal.Kmadpao = 14;
    internal.Kmaspao = 0.59999999999999998;
    internal.Kmcoassat = 40;
    internal.Kmdpao = 50;
    internal.Kmdssat = 130;
    internal.Kmmat = 41;
    internal.Kmodc = 60;
    internal.Kmsamdc = 50;
    internal.Kmspao = 15;
    internal.Kmsssat = 35;
    internal.Kpefflux = 0.01;
    internal.Kpspds = 40;
    internal.Vmmat = 0.45000000000000001;
    internal.Vmpao = 10.35;
    internal.Vmspds = 10.949999999999999;
    internal.Vmspms = 3.23;
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["A_init", "AcCoA_init", "aD_init", "aS_init", "C", "CoA_init", "D_init", "Kdantz", "Kdodc", "Kdsamdc", "Kdssat", "Keq", "Ksantz", "Ksodc", "Kssamdc", "Ksssat", "Met_init", "ORN_init", "P_init", "R", "S_init", "SAM_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "aS_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "SAM_init", internal, 0, -Infinity, Infinity, false);
