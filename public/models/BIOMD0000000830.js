export class model {
  ...
  initial(t) {
    ...
    state[6] = internal.initial_s6;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["k1", "k2", "k3", "k4", "k6", "k7", "k8", "release_init", "s1_init", "s2_init", "s3_init", "s4_init", "s6_init", "shedding_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "s6_init", internal, 0.050000000000000003, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.default1 * (s6 * internal.default1 * internal.k3 / internal.default1) - 1 * internal.default1 * (s1 * internal.default1 * internal.k1 / internal.default1) + 1 * internal.default1 * (s2 * internal.default1 * internal.k2 / internal.default1) - 1 * internal.default1 * (s1 * internal.default1 * internal.k4 / internal.default1);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "s1", "s2", "s3", "s4", "release", "shedding", "s6"];
    this.metadata.internalOrder = {default1: null, initial_release: null, initial_s1: null, initial_s2: null, initial_s3: null, initial_s4: null, initial_s6: null, initial_shedding: null, k1: null, k2: null, k3: null, k4: null, k6: null, k7: null, k8: null, release_init: null, s1_init: null, s2_init: null, s3_init: null, s4_init: null, s6_init: null, shedding_init: null};
    this.metadata.variableOrder = {s1: null, s2: null, s3: null, s4: null, release: null, shedding: null, s6: null};
