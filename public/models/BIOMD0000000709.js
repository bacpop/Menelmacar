export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "beta_a", internal, 1.7999999999999999e-08, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "I_a_init", internal, 1000, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "S_a_init", internal, 100000, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "S_h_init", internal, 1000000, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[0] = 0 + 1 * internal.Avian_population * (internal.r_a * S_a * (1 - S_a / internal.M_a) * (S_a / internal.m_a - 1)) - 1 * internal.Avian_population * (internal.beta_a * S_a * I_a);
