export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Antigen_presenting_tumour_cells_init", internal, 94.859999999999999, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "b", internal, 0.52500000000000002, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "CAR_T_cells_init", internal, 0.35999999999999999, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Normal_T_cells_init", internal, 6, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    var Total_lymphocyte_count = Normal_T_cells + CAR_T_cells;
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Normal_T_cells", "CAR_T_cells", "Antigen_presenting_tumour_cells"];
    this.metadata.internalOrder = {a: null, Antigen_presenting_tumour_cells_init: null, b: null, CAR_T_cells_init: null, compartment: null, gamma_B: null, initial_Antigen_presenting_tumour_cells: null, initial_CAR_T_cells: null, initial_Normal_T_cells: null, k_B: null, K_C: null, K_N: null, Normal_T_cells_init: null, r_B: null, r_N: null, rho_C: null};
    this.metadata.variableOrder = {Normal_T_cells: null, CAR_T_cells: null, Antigen_presenting_tumour_cells: null};
