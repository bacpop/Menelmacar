export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "Tplas_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "Ttum_init", internal, 0, -Infinity, Infinity, false);
