export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["alpha_e", "alpha_n", "Cmax", "CML_init", "dc", "de", "dn", "eta", "gamma_c", "gamma_e", "kn", "rc", "sn", "T_cell_effector_init", "T_cell_naive_init"], unusedUserAction);
    var internal = this.internal;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[1] = 0 + 1 * internal.COMpartment * internal.sn * internal.Source - 1 * internal.COMpartment * internal.dn * T_cell_naive - 1 * internal.COMpartment * (internal.kn * T_cell_naive * (CML / (CML + internal.eta)));
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "CML", "T_cell_naive", "T_cell_effector"];
    this.metadata.internalOrder = {alpha_e: null, alpha_n: null, Cmax: null, CML_init: null, COMpartment: null, dc: null, de: null, dn: null, eta: null, gamma_c: null, gamma_e: null, initial_CML: null, initial_T_cell_effector: null, initial_T_cell_naive: null, kn: null, rc: null, Sink: null, sn: null, Source: null, T_cell_effector_init: null, T_cell_naive_init: null};
    this.metadata.variableOrder = {CML: null, T_cell_naive: null, T_cell_effector: null};
