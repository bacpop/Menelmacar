export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "T_cell_effector_init", internal, 0, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "T_cell_naive_init", internal, 0, -Infinity, Infinity, false);
