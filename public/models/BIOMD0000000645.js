export class model {
  ...
  initial(t) {
    ...
    var kmpp2a = (internal.ModelValue_5 + internal.ModelValue_6) * (1 + internal.v * internal.initial_A88 / internal.ModelValue_0) / internal.ModelValue_4;
    var BB_init = internal.initial_A46 + internal.ModelValue_1 + kmpp2a;
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[2] = 0 + internal.ModelValue_33 * (internal.ModelValue_2 - M) - internal.ModelValue_17 * A88 * M - internal.kpka * PKA * M;
