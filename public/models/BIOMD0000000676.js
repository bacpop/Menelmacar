export class model {
  ...
  initial(t) {
    ...
    state[0] = internal.initial_Arg;
    state[1] = internal.initial_Fe3__enos;
    state[2] = internal.initial_Fe3__Arg;
    state[3] = internal.initial_Fe2;
    state[4] = internal.initial_Fe2__Arg;
    state[5] = internal.initial_Fe3__NO;
    state[6] = internal.initial_NO;
    state[7] = internal.initial_Fe2__NO;
    state[8] = internal.initial_Fe3__NOHA;
    state[9] = internal.initial_NOHA;
    state[10] = internal.initial_Fe2__NOHA;
    state[11] = internal.initial_O2;
    state[12] = internal.initial_Fe3__O2__Arg;
    state[13] = internal.initial_Fe3__O2__NOHA;
    state[14] = internal.initial_Citrulline;
    return state;
  }
  setUser(user, unusedUserAction) {
    ...
    var internal = this.internal;
    this.base.user.setUserScalar(user, "Arg_init", internal, 0, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Fe3__enos_init", internal, 0, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    var internal = this.internal;
    const Arg = state[0];
    const Fe3__enos = state[1];
    const Fe3__Arg = state[2];
    const Fe2 = state[3];
    const Fe2__Arg = state[4];
    const Fe3__NO = state[5];
    const Fe2__NO = state[7];
    const Fe3__NOHA = state[8];
    const NOHA = state[9];
    const Fe2__NOHA = state[10];
    const O2 = state[11];
    const Fe3__O2__Arg = state[12];
    const Fe3__O2__NOHA = state[13];
    dstatedt[0] = 0;
    dstatedt[11] = 0;
    dstatedt[14] = 0 + 1 * internal.Endothelium * internal.k11 * Fe3__O2__NOHA;
    dstatedt[3] = 0 - 1 * internal.Endothelium * (internal.k4 * Arg * Fe2 - internal.k4_prime * Fe2__Arg) + 1 * internal.Endothelium * internal.k2 * Fe3__enos + 1 * internal.Endothelium * (internal.k9 * Fe2__NOHA - internal.k9_prime * Fe2 * NOHA);
    dstatedt[4] = 0 + 1 * internal.Endothelium * (internal.k4 * Arg * Fe2 - internal.k4_prime * Fe2__Arg) + 1 * internal.Endothelium * internal.k3 * Fe3__Arg - 1 * internal.Endothelium * (internal.k5 * O2 * Fe2__Arg) + 1 * internal.Endothelium * internal.k5_prime * Fe3__O2__Arg;
    dstatedt[7] = 0 - 1 * internal.Endothelium * (internal.k13 * O2 * Fe2__NO) + 1 * internal.Endothelium * internal.k12 * Fe3__NO;
    dstatedt[10] = 0 - 1 * internal.Endothelium * (internal.k9 * Fe2__NOHA - internal.k9_prime * Fe2 * NOHA) + 1 * internal.Endothelium * internal.k7 * Fe3__NOHA - 1 * internal.Endothelium * (internal.k10 * O2 * Fe2__NOHA) + 1 * internal.Endothelium * internal.k10_prime * Fe3__O2__NOHA;
    dstatedt[2] = 0 + 1 * internal.Endothelium * (internal.k1 * Arg * Fe3__enos - internal.k1_prime * Fe3__Arg) - 1 * internal.Endothelium * internal.k3 * Fe3__Arg;
    dstatedt[1] = 0 - 1 * internal.Endothelium * (internal.k1 * Arg * Fe3__enos - internal.k1_prime * Fe3__Arg) - 1 * internal.Endothelium * internal.k2 * Fe3__enos + 1 * internal.Endothelium * internal.k14 * Fe3__NO + 1 * internal.Endothelium * (internal.k13 * O2 * Fe2__NO) + 1 * internal.Endothelium * (internal.k8 * Fe3__NOHA - internal.k8_prime * Fe3__enos * NOHA);
    dstatedt[5] = 0 - 1 * internal.Endothelium * internal.k14 * Fe3__NO + 1 * internal.Endothelium * internal.k11 * Fe3__O2__NOHA - 1 * internal.Endothelium * internal.k12 * Fe3__NO;
    dstatedt[8] = 0 - 1 * internal.Endothelium * (internal.k8 * Fe3__NOHA - internal.k8_prime * Fe3__enos * NOHA) + 1 * internal.Endothelium * internal.k6 * Fe3__O2__Arg - 1 * internal.Endothelium * internal.k7 * Fe3__NOHA;
    dstatedt[12] = 0 + 1 * internal.Endothelium * (internal.k5 * O2 * Fe2__Arg) - 1 * internal.Endothelium * internal.k5_prime * Fe3__O2__Arg - 1 * internal.Endothelium * internal.k6 * Fe3__O2__Arg;
    dstatedt[13] = 0 + 1 * internal.Endothelium * (internal.k10 * O2 * Fe2__NOHA) - 1 * internal.Endothelium * internal.k11 * Fe3__O2__NOHA - 1 * internal.Endothelium * internal.k10_prime * Fe3__O2__NOHA;
    dstatedt[6] = 0 + 1 * internal.Endothelium * internal.k14 * Fe3__NO;
    dstatedt[9] = 0 + 1 * internal.Endothelium * (internal.k8 * Fe3__NOHA - internal.k8_prime * Fe3__enos * NOHA) + 1 * internal.Endothelium * (internal.k9 * Fe2__NOHA - internal.k9_prime * Fe2 * NOHA);
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "Arg", "Fe3__enos", "Fe3__Arg", "Fe2", "Fe2__Arg", "Fe3__NO", "NO", "Fe2__NO", "Fe3__NOHA", "NOHA", "Fe2__NOHA", "O2", "Fe3__O2__Arg", "Fe3__O2__NOHA", "Citrulline"];
    ...
    this.metadata.variableOrder = {Arg: null, Fe3__enos: null, Fe3__Arg: null, Fe2: null, Fe2__Arg: null, Fe3__NO: null, NO: null, Fe2__NO: null, Fe3__NOHA: null, NOHA: null, Fe2__NOHA: null, O2: null, Fe3__O2__Arg: null, Fe3__O2__NOHA: null, Citrulline: null};
