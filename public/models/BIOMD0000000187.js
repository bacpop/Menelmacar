export class model {
  ...
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["APC_Cdc20_init", "APC_init", "Bub3_BubR1_Cdc20_init", "Bub3_BubR1_init", "Cdc20_CMad2_init", "Cdc20_init", "const_val_0", "const_val_1", "k1f", "k1r", "k2f", "k3f", "k4f", "k4r", "k5f", "k5r", "k7bf", "k7f", "k8f", "k8r", "kf6", "Mad1_CMad2_init", "Mad1_CMad2_OMad2_init", "MCC_APC_init", "MCC_init", "OMad2_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "k7bf", internal, 0.080000000000000002, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[8] = 0 - 1 * u * internal.k7f * MCC * APC * internal.Cytoplasm - 1 * internal.Cytoplasm * (internal.k8f * APC * Cdc20 - internal.k8r * APC_Cdc20);
    dstatedt[10] = 0 + 1 * u_prime * internal.k7bf * MCC_APC * internal.Cytoplasm + 1 * internal.Cytoplasm * (internal.k8f * APC * Cdc20 - internal.k8r * APC_Cdc20);
    dstatedt[5] = 0 - 1 * internal.Cytoplasm * (u * internal.k4f * Cdc20_CMad2 * Bub3_BubR1 - internal.k4r * MCC) - 1 * internal.Cytoplasm * (u * internal.k5f * Bub3_BubR1 * Cdc20 - internal.k5r * Bub3_BubR1_Cdc20) + 1 * u_prime * internal.k7bf * MCC_APC * internal.Cytoplasm;
    dstatedt[7] = 0 + 1 * internal.Cytoplasm * (u * internal.k5f * Bub3_BubR1 * Cdc20 - internal.k5r * Bub3_BubR1_Cdc20);
    dstatedt[3] = 0 - 1 * u * internal.k2f * Mad1_CMad2_OMad2 * Cdc20 * internal.Cytoplasm + 1 * internal.k3f * Cdc20_CMad2 * internal.Cytoplasm - 1 * internal.Cytoplasm * (u * internal.k5f * Bub3_BubR1 * Cdc20 - internal.k5r * Bub3_BubR1_Cdc20) - 1 * internal.kf6 * OMad2 * Cdc20 * internal.Cytoplasm - 1 * internal.Cytoplasm * (internal.k8f * APC * Cdc20 - internal.k8r * APC_Cdc20);
    dstatedt[4] = 0 + 1 * u * internal.k2f * Mad1_CMad2_OMad2 * Cdc20 * internal.Cytoplasm - 1 * internal.k3f * Cdc20_CMad2 * internal.Cytoplasm - 1 * internal.Cytoplasm * (u * internal.k4f * Cdc20_CMad2 * Bub3_BubR1 - internal.k4r * MCC) + 1 * internal.kf6 * OMad2 * Cdc20 * internal.Cytoplasm;
    dstatedt[0] = 0 - 1 * internal.Cytoplasm * (u * internal.k1f * Mad1_CMad2 * OMad2 - internal.k1r * Mad1_CMad2_OMad2) + 1 * u * internal.k2f * Mad1_CMad2_OMad2 * Cdc20 * internal.Cytoplasm;
    dstatedt[2] = 0 + 1 * internal.Cytoplasm * (u * internal.k1f * Mad1_CMad2 * OMad2 - internal.k1r * Mad1_CMad2_OMad2) - 1 * u * internal.k2f * Mad1_CMad2_OMad2 * Cdc20 * internal.Cytoplasm;
    dstatedt[6] = 0 + 1 * internal.Cytoplasm * (u * internal.k4f * Cdc20_CMad2 * Bub3_BubR1 - internal.k4r * MCC) - 1 * u * internal.k7f * MCC * APC * internal.Cytoplasm;
    dstatedt[9] = 0 + 1 * u * internal.k7f * MCC * APC * internal.Cytoplasm - 1 * u_prime * internal.k7bf * MCC_APC * internal.Cytoplasm;
    dstatedt[1] = 0 - 1 * internal.Cytoplasm * (u * internal.k1f * Mad1_CMad2 * OMad2 - internal.k1r * Mad1_CMad2_OMad2) + 1 * internal.k3f * Cdc20_CMad2 * internal.Cytoplasm - 1 * internal.kf6 * OMad2 * Cdc20 * internal.Cytoplasm + 1 * u_prime * internal.k7bf * MCC_APC * internal.Cytoplasm;
  }
  names() {
