export class model {
  ...
  initial(t) {
    ...
    state[17] = internal.initial_NADP;
    state[18] = internal.initial_H;
    state[19] = internal.initial_Pext;
    return state;
  }
  setUser(user, unusedUserAction) {
    this.base.user.checkUser(user, ["ATP_init", "DHAP_init", "DPGA_init", "E4P_init", "F6P_init", "FBP_init", "G1P_init", "G6P_init", "GAP_init", "H_init", "K", "k1", "K1", "k2", "K2", "KA", "KA1", "KA2", "KA3", "KR1", "KR2", "KR3", "KR4", "KR41", "KR42", "KR5", "NADP_init", "NADPH_init", "Pext_init", "PGA_init", "R5P_init", "Ru5P_init", "RuBP_init", "S7P_init", "SBP_init", "Vm", "X5P_init"], unusedUserAction);
    var internal = this.internal;
    ...
    this.base.user.setUserScalar(user, "H_init", internal, 1.25892541179417e-05, -Infinity, Infinity, false);
    ...
    this.base.user.setUserScalar(user, "Pext_init", internal, 0.5, -Infinity, Infinity, false);
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "RuBP", "PGA", "DPGA", "GAP", "DHAP", "FBP", "F6P", "E4P", "SBP", "S7P", "X5P", "R5P", "Ru5P", "G6P", "G1P", "ATP", "NADPH", "NADP", "H", "Pext"];
    this.metadata.internalOrder = {ATP_init: null, chloroplast: null, cytosol: null, DHAP_init: null, DPGA_init: null, E4P_init: null, F6P_init: null, FBP_init: null, G1P_init: null, G6P_init: null, GAP_init: null, H_init: null, initial_ATP: null, initial_DHAP: null, initial_DPGA: null, initial_E4P: null, initial_F6P: null, initial_FBP: null, initial_G1P: null, initial_G6P: null, initial_GAP: null, initial_H: null, initial_NADP: null, initial_NADPH: null, initial_Pext: null, initial_PGA: null, initial_R5P: null, initial_Ru5P: null, initial_RuBP: null, initial_S7P: null, initial_SBP: null, initial_X5P: null, K: null, k1: null, K1: null, k2: null, K2: null, KA: null, KA1: null, KA2: null, KA3: null, KR1: null, KR2: null, KR3: null, KR4: null, KR41: null, KR42: null, KR5: null, NADP_init: null, NADPH_init: null, Pext_init: null, PGA_init: null, R5P_init: null, Ru5P_init: null, RuBP_init: null, S7P_init: null, SBP_init: null, Vm: null, X5P_init: null};
    this.metadata.variableOrder = {RuBP: null, PGA: null, DPGA: null, GAP: null, DHAP: null, FBP: null, F6P: null, E4P: null, SBP: null, S7P: null, X5P: null, R5P: null, Ru5P: null, G6P: null, G1P: null, ATP: null, NADPH: null, NADP: null, H: null, Pext: null};
