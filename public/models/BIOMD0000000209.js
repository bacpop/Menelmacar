export class model {
  ...
  initial(t) {
    ...
    state[10] = internal.initial_SG;
    state[11] = internal.initial_SN;
    state[12] = internal.initial_OCT4;
    state[13] = internal.initial_SOX2;
    state[14] = internal.initial_NANOG;
    state[15] = internal.initial_GATA6;
    state[16] = internal.initial_CDX2;
    state[17] = internal.initial_GCNF;
    state[18] = internal.initial_OCT4_SOX2;
    state[19] = internal.initial_Protein;
    return state;
  }
  ...
  rhs(t, state, dstatedt) {
    ...
    const OCT4 = state[12];
    const SOX2 = state[13];
    const NANOG = state[14];
    const GATA6 = state[15];
    const CDX2 = state[16];
    const GCNF = state[17];
    dstatedt[9] = 0;
    dstatedt[4] = 0;
    ...
    dstatedt[2] = 0;
    dstatedt[6] = 0;
    dstatedt[16] = 0 + 1 * (internal.g0 + internal.g1 * CDX2) / (1 + internal.h0 * CDX2 + internal.h1 * CDX2 * OCT4) - 1 * internal.gamma4 * CDX2;
    dstatedt[15] = 0 + 1 * (internal.p0 + internal.p1 * OCT4 + internal.p2 * GATA6) / (1 + internal.q0 * OCT4 + internal.q1 * GATA6 + internal.q2 * NANOG + internal.q3 * SG) - 1 * internal.gammag * GATA6;
    dstatedt[17] = 0 + 1 * (internal.i0 + internal.i1 * CDX2 + internal.i2 * GATA6) / (1 + internal.j0 * CDX2 + internal.j1 * GATA6) - 1 * internal.gamma5 * GCNF;
    dstatedt[14] = 0 + 1 * (internal.e0 + internal.e1 * OCT4 * SOX2 + internal.e2 * OCT4 * SOX2 * NANOG + internal.e3 * SN) / (1 + internal.f0 * OCT4 + internal.f1 * OCT4 * SOX2 + internal.f2 * OCT4 * SOX2 * NANOG + internal.f3 * OCT4 * GATA6 + internal.f4 * SN) - 1 * internal.gamma3 * NANOG;
    dstatedt[12] = 0 + 1 * (internal.a0 + internal.a1 * A + internal.a2 * OCT4 * SOX2 + internal.a3 * OCT4 * SOX2 * NANOG) / (1 + internal.b0 * A + internal.b1 * OCT4 + internal.b2 * OCT4 * SOX2 + internal.b3 * OCT4 * SOX2 * NANOG + internal.b4 * CDX2 * OCT4 + internal.b5 * GCNF) - 1 * internal.gamma1 * OCT4;
    dstatedt[13] = 0 + 1 * (internal.c0 + internal.c1 * OCT4 * SOX2 + internal.c2 * OCT4 * SOX2 * NANOG) / (1 + internal.d0 * OCT4 + internal.d1 * OCT4 * SOX2 + internal.d2 * OCT4 * SOX2 * NANOG) - 1 * internal.gamma2 * SOX2;
  }
  names() {
  ...
  updateMetadata() {
    this.metadata = {};
    var internal = this.internal;
    this.metadata.ynames = ["t", "OCT4_Gene", "NANOG_Gene", "SOX2_Gene", "GATA6_Gene", "CDX2_Gene", "GCNF_Gene", "targetGene", "degradation", "p53", "A", "SG", "SN", "OCT4", "SOX2", "NANOG", "GATA6", "CDX2", "GCNF", "OCT4_SOX2", "Protein"];
    ...
    this.metadata.variableOrder = {OCT4_Gene: null, NANOG_Gene: null, SOX2_Gene: null, GATA6_Gene: null, CDX2_Gene: null, GCNF_Gene: null, targetGene: null, degradation: null, p53: null, A: null, SG: null, SN: null, OCT4: null, SOX2: null, NANOG: null, GATA6: null, CDX2: null, GCNF: null, OCT4_SOX2: null, Protein: null};
