export class model {
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[3] = 0 + 1 * (internal.p0 + internal.p1 * OCT4 + internal.p2 * GATA6) / (1 + internal.q0 * OCT4 + internal.q1 * GATA6 + internal.q2 * NANOG + internal.q3 * internal.SG) - 1 * internal.gammag * GATA6;
    ...
    dstatedt[2] = 0 + 1 * (internal.e0 + internal.e1 * OCT4 * SOX2 + internal.e2 * OCT4 * SOX2 * NANOG + internal.e3 * internal.SN) / (1 + internal.f0 * OCT4 + internal.f1 * OCT4 * SOX2 + internal.f2 * OCT4 * SOX2 * NANOG + internal.f3 * OCT4 * GATA6 + internal.f4 * internal.SN) - 1 * internal.gamma3 * NANOG;
  ...
  updateMetadata() {
    ...
    this.metadata.internalOrder = {A: null, a0: null, a1: null, a2: null, a3: null, b0: null, b1: null, b2: null, b3: null, b4: null, b5: null, c0: null, c1: null, c2: null, CDX2_Gene: null, CDX2_init: null, cell: null, d0: null, d1: null, d2: null, d3: null, degradation: null, e0: null, e1: null, e2: null, e3: null, f0: null, f1: null, f2: null, f3: null, f4: null, g0: null, g1: null, gamma1: null, gamma2: null, gamma3: null, gamma4: null, gamma5: null, gammag: null, gamman: null, GATA6_Gene: null, GATA6_init: null, GCNF_Gene: null, GCNF_init: null, h0: null, h1: null, i0: null, i1: null, i2: null, initial_CDX2: null, initial_GATA6: null, initial_GCNF: null, initial_NANOG: null, initial_OCT4: null, initial_OCT4_SOX2: null, initial_Protein: null, initial_SOX2: null, j0: null, j1: null, NANOG_Gene: null, NANOG_init: null, OCT4_Gene: null, OCT4_init: null, OCT4_SOX2_init: null, p0: null, p1: null, p2: null, p53: null, Protein_init: null, q0: null, q1: null, q2: null, q3: null, SG: null, SN: null, SOX2_Gene: null, SOX2_init: null, targetGene: null};
