export class model {
  ...
  setUser(user, unusedUserAction) {
    ...
    this.base.user.setUserScalar(user, "C_glu__Basolateral___HepG2__init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_glu_Apical_init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_glu_Caco_2_init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_para__Basolateral___HepG2__init", internal, 5, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_para_Apical_init", internal, 2500, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_para_Caco_2_init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_sulf__Basolateral___HepG2__init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_sulf_Apical_init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
    this.base.user.setUserScalar(user, "C_sulf_Caco_2_init", internal, 1.0000000000000001e-15, -Infinity, Infinity, false);
  ...
  rhs(t, state, dstatedt) {
    ...
    dstatedt[8] = (internal.P_glu * internal.Ai * (C_glu_Caco_2 - C_glu__Basolateral___HepG2_) + internal.Mp_g_HepG2 * C_para__Basolateral___HepG2_ * V_basol) / V_basol;
    dstatedt[6] = - 1 * internal.P_glu * internal.Ai * (C_glu_Apical - C_glu_Caco_2) / V_api;
    dstatedt[7] = (internal.P_glu * internal.Ai * (C_glu_Apical - C_glu_Caco_2) - internal.P_glu * internal.Ai * (C_glu_Caco_2 - C_glu__Basolateral___HepG2_) + internal.Mp_g_caco * C_para_Caco_2 * V_caco) / V_caco;
    dstatedt[2] = (internal.P_para * internal.Ai * (C_para_Caco_2 - C_para__Basolateral___HepG2_) - internal.Mp_s_HepG2 * C_para__Basolateral___HepG2_ * V_basol - internal.Mp_g_HepG2 * C_para__Basolateral___HepG2_ * V_basol) / V_basol;
    dstatedt[0] = - 1 * internal.P_para * internal.Ai * (C_para_Apical - C_para_Caco_2) / V_api;
    dstatedt[1] = (internal.P_para * internal.Ai * (C_para_Apical - C_para_Caco_2) - internal.P_para * internal.Ai * (C_para_Caco_2 - C_para__Basolateral___HepG2_) - internal.Mp_s_caco * C_para_Caco_2 * V_caco - internal.Mp_g_caco * C_para_Caco_2 * V_caco) / V_caco;
    dstatedt[5] = (internal.P_sulf * internal.Ai * (C_sulf_Caco_2 - C_sulf__Basolateral___HepG2_) + internal.Mp_s_HepG2 * C_para__Basolateral___HepG2_ * V_basol) / V_basol;
    dstatedt[3] = - 1 * internal.P_sulf * internal.Ai * (C_sulf_Apical - C_sulf_Caco_2) / V_api;
    dstatedt[4] = (internal.P_sulf * internal.Ai * (C_sulf_Apical - C_sulf_Caco_2) - internal.P_sulf * internal.Ai * (C_sulf_Caco_2 - C_sulf__Basolateral___HepG2_) + internal.Mp_s_caco * C_para_Caco_2 * V_caco) / V_caco;
  }
  names() {
